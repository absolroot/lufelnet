...
window.characterSkillsData["루우나"] = {
  ...
  "skill1": {
    ...
    "sp": 22,
    "cool": 0,
    "description": "모든 적에게 공격력 73.2%/80.7%/77.7%/85.2%의 화염 속성 대미지를 준다. 목표의 방어력이 감소하고(자신의 효과 명중의 15.4%만큼, 상한 26.4%/29.1%/28.0%/30.7%), 화염·빙결·질풍·전격 속성 스킬을 받을 시 방어력이 추가로 26.4%/26.4%/28.0%/28.0% 감소하며 2턴 동안 지속된다. 또한 50%의 기본 확률로 목표를 화상 상태에 빠뜨린다. 자신이 『열렬한 환영』을 획득한다(방어력 감소 효과와 『악당에 대한 경고』는 중첩 불가)."
  },
  "skill2": {
    "name": "악당에 대한 경고",
    "element": "화염",
  ...
  "skill3": {
    ...
    "sp": 26,
    "cool": 0,
    "description": "자신이 『열렬한 환영』 또는 『집요한 추격』을 보유하고 있는지에 따라 해당 스킬은 각각 다른 효과가 발동되며, 동시에 하나의 효과만 발동할 수 있다. 해당 스킬 대미지는 추가 효과 대미지로 간주한다.\n『열렬한 환영』: 모든 적에게 공격력 109.8%/109.8%/116.6%/116.6%의 화염 속성 대미지를 주고, 2턴 동안 목표가 받는 대미지가 증가하며(자신의 효과 명중의 24%만큼, 상한 41.0%/45.2%/43.5%/47.7%), 받는 화염·빙결·질풍·전격 속성 대미지가 20.5%/22.6%/21.8%/23.9% 증가한다.\n『집요한 추격』: 1명의 적에게 공격력 219.6%/219.6%/233.1%/233.1%의 화염 속성 대미지를 주고, 2턴 동안 목표가 받는 대미지가 증가하며(자신의 효과 명중의 34.3%만큼, 상한 58.6%/64.6%/62.2%/68.2%), 받는 추가 효과 대미지가 39.0%/43.0%/41.4%/45.4% 증가한다."
  },
  "skill_highlight": {
    "element": "화염광역",
    "type": "디버프",
    "description": "모든 적에게 공격력 214.7%/236.7%/227.9%/249.9%의 화염 속성 대미지를 주고, 적 진영이 『대악당』 2중첩을 획득한다.\n『대악당』: 적 진영의 임의의 목표가 추격 스킬 또는 화염·빙결·질풍·전격 속성 스킬을 받으면 1중첩이 소모되며, 받는 대미지가 증가한다(자신의 효과 명중의 22.9%만큼, 상한 53.7%/59.2%/57.0%/62.5%). 해당 효과는 영구 지속되며 최대 2중첩까지 가능하다. 『대악당』 상태가 존재할 때 자신이 주는 대미지는 버프 효과를 받지만 중첩 수는 소모하지 않는다.",
    "cool": 4
  },
  "passive1": {
    "name": "충실",
  ...
  "passive2": {
    "name": "열정",
    "element": "패시브",
    "description": "스킬을 사용해 적에게 디버프 효과를 추가한 후 자신의 공격력이 33.0% 증가한다. 동료가 화염·빙결·질풍·전격 속성 대미지 또는 추가 효과 대미지를 줄 때 동일한 공격력 증가 효과를 획득하며 1턴 동안 지속된다.",
    "cool": 0
  }
};
