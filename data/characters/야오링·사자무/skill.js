...
window.characterSkillsData["야오링·사자무"] = {
  ...
  "skill1": {
    ...
    "sp": 20,
    "cool": 0,
    "description": "모든 적에게 공격력 120.4%/132.8%/127.8%/140.2%의 화염 속성 대미지를 주고, 2턴 동안 자신의 크리티컬 확률이 10% 증가한다.\n『불꽃놀이 유성』이 강화되어, 1턴 동안 추가로 공격력 72.8%/80.3%/77.3%/84.7%의 화염 속성 대미지를 준다."
  },
  "skill2": {
    "name": "폭죽의 노래",
    "element": "화염광역",
    ...
    "sp": 20,
    "cool": 0,
    "description": "모든 적에게 공격력 73.8%/81.3%/78.3%/85.9%의 화염 속성 대미지를 주고, 2턴 동안 75%의 기본 확률로 목표를 화상과 『세월의 불꽃』 상태에 빠뜨린다.\n『불꽃놀이 유성』이 강화되어, 75%의 기본 확률로 1턴 동안 목표를 『세월의 불꽃』 상태에 빠뜨린다.\n『세월의 불꽃』: 매턴마다 리 야오링·사자무 공격력 63.4%/69.9%/67.3%/73.8%의 화염 속성 대미지를 받으며 2턴 동안 지속된다(4회 중첩 가능)."
  },
  "skill3": {
    "name": "유성의 불꽃",
    "element": "버프",
