      ...
      function setupWonderConfig() {
        ...
        const createWeaponDropdownItems = (filter = "") => {
          ...
          filteredWeapons.forEach(weapon => {
            ...
            iconImg.src = `{{ site.baseurl }}/assets/img/wonder-weapon/${weapon}.webp`;
            iconImg.alt = "";
            ...
            const createDropdownItems = (filter = "") => {
                ...
                filteredSkills.forEach(skill => {
                    ...
                    if (skill.icon) {
                        ...
                        iconImg.src = `{{ site.baseurl }}/assets/img/skill-element/${skill.icon}.png`;
                        iconImg.alt = "";
                        iconImg.onerror = function() {
                            // 이미지 로드 실패 시 아이콘 제거
                            this.style.display = 'none';
        ...
        inputs.forEach((input, idx) => {
            ...
            const createDropdownItems = (filter = "") => {
                ...
                filteredPersonas.forEach(persona => {
                    ...
                    iconImg.src = `{{ site.baseurl }}/assets/img/persona/${persona}.webp`;
                    iconImg.alt = "";
                    iconImg.onerror = function() {
                        // 이미지 로드 실패 시 아이콘 제거
                        this.style.display = 'none';
