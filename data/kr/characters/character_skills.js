const characterSkillsData = {
    ...
    "마유미": {
        ...
        "skill1": {
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 일정 비율의 물리 속성 피해를 가하며, 모든 아군 괴도의 피해량을 2턴 동안 상승시킨다 (마유미의 『시속』 스택에 비레하며, 상한선이 존재).\n※추가 턴 발동시 스킬 피해량이 증가하고 메인 목표에게 반드시 크리티컬 피해를 입힌다."
        },
        "skill2": {
            "name": "오버부스트",
            "element": "버프광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 아군 괴도의 공격력과 방어력을 2턴 동안 증가시킨다 (마유미의 『시속』 스택에 비레하며, 상한선이 존재).\n※추가 턴 발동시 모든 아군에게 일정 피해를 흡수하는 실드를 1회 부여한다 (2턴 지속)."
        },
        "skill3": {
            "name": "엔진 풀스로틀",
            "element": "버프광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 아군 괴도의 관통과 공격력을 2턴 동안 증가시킨다 (마유미의 『시속』 스택에 비레하며, 상한선이 존재).\n※추가 턴 발동시 메인 목표의 관통이 증가한다 (1턴 지속)."
        },
        "skill_highlight": {
            "element": "버프광역",
            "type": "버프",
            "description": "모든 아군 괴도의 공격력과 방어력을 2턴 동안 증가시킨다 (마유미의 『시속』 스택에 비레하며, 상한선이 존재). 메인 목표가 다음 공격을 가할 때, 적 메인 목표의 다운 수치를 하나 추가로 감소시킨다."
        },
        "passive1": {
            "name": "선두주자",
            "element": "패시브",
            "description": "마유미가 전장에 있을 시, 모든 아군이 추가 턴에서 주는 대미지가 증가한다."
        },
        "passive2": {
            "name": "오버드라이브",
            "element": "패시브",
            "description": "마유미가 전장에 있을 시, 모든 아군이 다운된 적에게 주는 대미지가 증가한다. 또한 마유미가 적을 다운 시킬 경우, 해당 대상에게 추가적으로 물리 속성 대미지를 준다."
        }
    },
    "아케치": {
        "name": "아케치 고로",
