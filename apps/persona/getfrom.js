...
(function () {
  ...
  const Acquisition = {
    async renderInto(infoSectionEl, personaKrName) {
      ...
      // Simplified placement: Just append to infoSectionEl.
      // The calling code (index.html) now controls the order by calling renderInto at the correct time.
      infoSectionEl.appendChild(wrap);
