const characterSkillsData = {
    ...
    "미나미·여름":{
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "모든 적에게 최대 생명력의 64.4%/71.0%/68.4%/75.0%의 축복 속성 피해를 주고, ‘설탕절임’ 상태로 만든다: 공격받을 때, 그 피해의 공격력이 9.8%/10.8%/10.4%/11.4% 증가한다. (미야시타 미나미·여름의 최대 생명력이 1200마다 해당 피해의 공격력이 추가로 4% 증가하며, 최대 11712/12912/12432/13632의 생명력까지 반영됨) 지속 시간: 3턴"
        },
        "skill2": {
            "name": "한여름 꽃밭",
            "element": "버프",
            ...
            "sp": 22,
            "cool": 0,
            "description": "모든 아군의 피해량을 7.8%/8.6%/8.3%/9.1% 증가시킨다. (미야시타 미나미·여름의 최대 생명력이 1200마다 피해량이 추가로 3.2% 증가하며, 최대 11712/12912/12432/13632의 생명력까지 반영됨) 지속 시간: 3턴 또한, 모든 아군에게 1중첩의 축복 효과를 부여하고, 디버프 1개를 해제한다."
        },
        "skill3": {
            "name": "저 너머의 꽃에 바치는 헌화",
            "element": "버프",
            "type": "버프",
            "sp": 25,
            "cool": 2,
            "description": "자신을 제외한 아군 1명의 크리티컬 확률을 15.6%/17.2%/16.6%/18.2% 증가시키고, 크리티컬 효과를 상승시킨다. (증가치는 미야시타 미나미·여름의 크리티컬 효과가 100%를 초과한 부분의 33.33%에 해당하며, 최대 213.4%/229.9%/229.9%/246.4%의 크리티컬 효과까지 반영됨) 지속 시간: 3턴\n해당 지속 시간 동안, 미야시타 미나미·여름이 해당 아군에게 약품을 사용할 경우, 그 대상의 크리티컬 효과를 추가로 상승시킨다. (증가치는 미야시타 미나미·여름의 크리티컬 효과가 100%를 초과한 부분의 16.66%에 해당하며, 최대 213.4%/229.9%/229.9%/246.4%의 크리티컬 효과까지 반영됨) 지속 시간: 1턴"
        },
        "skill_highlight": {
            "element": "버프",
            "type": "버프",
            "sp": 0,
            "cool": 0,
            "description": "자신을 제외한 아군 1명의 피해량을 24.4%/26.9%/25.9%/28.4% 증가시키고, 크리티컬 효과를 상승시킨다. (증가치는 미야시타 미나미·여름의 크리티컬 효과가 100%를 초과한 부분의 16.66%에 해당하며, 최대 213.4%/229.9%/229.9%/246.4%의 크리티컬 효과까지 반영됨) 지속 시간: 2턴 또한, 자신의 다음 약품 사용 시 효과가 9.8%/10.8%/10.4%/11.4% 증가한다."
        },
        "passive1": {
            "name": "기원",
            "element": "패시브",
            "description": "아군을 대상으로 페르소나 스킬을 사용할 때마다 해당 아군에게 1중첩의 축복 효과를 부여한다. 미야시타 미나미·여름이 전투에 있을 경우, 아군이 보유한 축복 효과 1중첩당 피해량이 6.0% 증가하며, 최대 36.0%까지 상승한다."
        },
        "passive2": {
            "name": "보살핌",
            "element": "패시브",
            "description": "미야시타 미나미·여름이 전투에 있을 경우, 아군의 공격력이 12.0% 상승하고, 강화 약품 효과가 1종류 추가될 때마다 공격력이 15.0% 추가 상승한다."
        }
    },
    "이치고": {
        "name": "시카노 이치고",
