const characterSkillsData = {
    ...
    "마나카": {
        ...
        "skill1": {
            ...
            "type": "버프",
            "cool": 4,
            "description": "일정 턴 동안 모든 동료의 주는 대미지가 7.0%/7.5%/8.0%/8.5%+(나가오 마나카의 공격력 164포인트마다 추가 1.0% 증가, 최대 28.0%/31.0%/31.2%/34.2%포인트 공격력 계산)만큼 증가하고, 자신은 『성가』를 4중첩 획득한다."
        },
        "skill2": {
            "name": "치유 빛의 노래",
            "element": "치료광역",
            "type": "치료",
            "cool": 8,
            "description": "모든 동료의 체력을 나가오 마나카의 공격력 ///11.2%+///1124만큼 회복시키고, 디버프 1종을 제거한다. 『성가』 보유 시, 『성가』 1중첩을 소모하여 해당 스킬 사용 후의 준비 시간을 1회 감소한다(최대 4회 감소), 해당 스킬 사용 시, 회복량이 50% 증가한다.\n패시브: 나가오 마나카가 전투 중 『성가』를 12중첩 획득할 때마다 자동으로 치유 효과가 발동된다."
        },
        "skill3": {
            "name": "시공의 윤회",
            "element": "버프광역",
            "type": "버프",
            "cool": 4,
            "description": "모든 동료의 공격력이 나가오 마나카의 공격력 11%+128/138/146/156만큼 증가한다. 모든 『성가』를 소모하며, 소모한 『성가』1 중첩마다 2턴 동안 추가로 모든 동료의 공격력(나가오 마나카의 공격력 460포인트마다 0.1% 증가, 최대 4600/5060/5980/6440포인트 공격력 계산) 및 관통(나가오 마나카의 공격력 460포인트마다 0.1% 증가, 최대 4600/5060/5980/6440포인트 공격력 계산)이 증가한다."
        },
        "skill_highlight": {
            "name": "속성 증가",
            "element": "패시브",
