...
window.characterSkillsData["카요"] = {
  ...
  "passive2": {
    "name": "정열",
    "element": "패시브",
    "description": "임의의 동료가 스킬을 시전하여 원소 이상을 부여할 경우 해당 동료는 2턴 동안 15%의 대미지 보너스를 획득하고, 21%의 고정 확률로 자신이 『리듬』 1개를 획득한다.",
    "cool": 0
  }
};
...
window.jpCharacterSkillsData["카요"] = {
  ...
  "passive2": {
    "name": "これってもう死語？",
    "element": "패시브",
    "description": "味方が敵を属性異常にした時、２ターンの間、その味方の与ダメージ上昇効果が15%上昇する。さらに、21%の確率で『ビートＢＯＸ』を１つ獲得する。",
    "cool": 0
  }
};
