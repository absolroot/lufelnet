...
window.cnCharacterSkillsData["레오"] = {
  "name": "神山岭央",
  "skill1": {
    "name": "核热幻想",
    "element": "핵열",
    "sp": 20,
    "cool": 0,
    "description": "对1名敌人造成170.8%/188.3%/177.8%/195.3%攻击力的核热属性伤害。释放该技能时，所有同伴身上每有1层『激活』，则技能伤害提升10%。"
  },
  "skill2": {
    "name": "生命提炼",
    "sp": 20,
    "cool": 0,
    "description": "将1名同伴当前生命值的30%按照80%的比例置换为护盾，并额外附加相当于神山岭央31.6%/31.6%/32.9%/32.9%+900/1095/1035/1230攻击力的护盾，护盾持续2回合。并使其获得1层『激活』。",
    "element": "버프"
  },
  "skill3": {
    "name": "英勇转化",
    "sp": 24,
    "cool": 0,
    "description": "使1名同伴的攻击力提升19.5%/19.5%/20.3%/20.3%，效果持续2回合。效果持续时间，目标身上每有1层『激活』，则基于神山岭央攻击力的20%获得攻击力提升，通过这种方式获得的攻击力上限为1516.7/1672.1/1578.9/1734.3。",
    "element": "버프"
  },
  "passive1": {
    "name": "抗争",
    "element": "패시브",
    "cool": 0,
    "description": "『生命提炼』技能持续时间结束后，根据护盾的剩余值的100.0%恢复生命值。"
  },
  "passive2": {
    "name": "陪伴",
    "element": "패시브",
    "cool": 0,
    "description": "若有同伴身上具有两层『激活』效果，则额外提升其45.0%暴击效果。"
  },
  "skill_highlight": {
    "element": "버프",
    "cool": 4,
    "description": "使1名同伴获得满层『激活』，效果持续2回合，若目标生命值低于60%，则使其生命值恢复至60%，恢复的生命值上限为神山岭央攻击力的200%。并基于神山岭央攻击力的15%提升其攻击力，上限585.6/645.6/609.6/669.6点，效果持续2回合。"
  }
};
