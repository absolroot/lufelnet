...
window.characterSkillsData["카스미"] = {
  ...
  "skill1": {
    ...
    "sp": 23,
    "cool": 0,
    "description": "액티브로 해당 스킬 사용 시 1명의 적에게 공격력 186.9%/206.1%/198.4%/217.5%의 축복 속성 대미지를 주고, 자신은 춤사위 『브레이브 스텝』을 획득한다(3회 중첩 가능). 댄스 파트너가 해당 스킬 사용 시 스킬 효과는 1명의 적에게 공격력 121.6%/134.1%/129.1%/141.5%의 축복 속성 대미지를 주고, 자신은 춤사위 『브레이브 스텝』을 획득한다(3회 중첩 가능)."
  },
  "skill2": {
    "name": "함께 추는 춤",
    "element": "버프",
    ...
    "sp": 22,
    "cool": 0,
    "description": "1턴 동안 1명의 동료를 선택해 『댄스 파트너』로 삼는다. 자신과 『댄스 파트너』의 공격력이 3턴 동안 32.4%/35.7%/34.4%/37.7% 증가한다. 자신이 춤사위 『스위프트 스텝』을 획득한다(1회 중첩 가능). 『댄스 파트너』가 페르소나 스킬을 사용하면 자신이 즉시 임의 적 목표에게 『어둠 속 빛』을 1회 시전한다(『댄스 파트너』의 스킬 목표가 적일 경우, 스킬 메인 목표를 향해 『어둠 속 빛』을 1회 시전함). 『댄스 파트너』는 동시에 1명만 존재할 수 있다."
  },
  "skill3": {
    "name": "피어나는 마음",
    "element": "축복",
    ...
    "sp": 27,
    "cool": 0,
    "description": "1명의 적에게 공격력 249.1%/274.6%/264.4%/289.9%의 축복 속성 대미지를 준다. 해당 스킬을 사용할 때 자신이 『가면무도회』 상태일 경우 스킬 대미지가 30% 증가하고 자신의 크리티컬 효과가 29.3%/29.3%/31.1%/31.1% 증가한다."
  },
  "skill_highlight": {
    "element": "축복",
    "type": "단일 피해",
    "description": "발동 조건: 자신이 『가면무도회』 상태일 것\n1명의 적에게 공격력 273.1%/301.0%/289.8%/317.8%의 축복 속성 대미지를 준다. 자신이 춤사위 보유 시 해당 버프 효과를 획득한다. 『용기의 발걸음』: 중첩마다 HIGHLIGHT 스킬 대미지가 15% 증가한다. 『민첩한 발걸음』: HIGHLIGHT의 크리티컬 확률이 10% 증가하고, 크리티컬 효과가 20% 증가한다.",
    "cool": 0
  },
  "passive1": {
    "name": "믿음",
    "element": "패시브",
    "description": "자신의 춤사위 1중첩마다 축복 속성 대미지가 15% 증가하고, 최대 45.0% 증가한다.",
    "cool": 0
  },
  "passive2": {
    "name": "결의",
    "element": "패시브",
    "description": "아군 동료가 HIGHLIGHT/테우르기아 효과를 발동하면 요시자와 카스미의 공격력이 2턴 동안 45.0% 증가한다(2회 중첩 가능).",
    "cool": 0
  }
};
