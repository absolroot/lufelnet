const enCharacterRitualData = {
    ...
    "토모코·여름": {
        ...
        "r0_detail": "Seaside Tomoko can inflict [Sparks] on foes.\nAfter an ally acts, if foes have 3 [Sparks] stacks, activate Seaside Tomoko's [Resonance]: For every 3 [Sparks] stacks on all foes, deal 19% of ATK as Psy DMG to all foes and decrease their DMG Dealt by 30% for 1 turn. Restore HP to all allies by 9% of Seaside Tomoko's ATK + 300/600/900 (based on Lv. 1/50/70+). This can activate up to 5 damage and healing effects within the same [Resonance], based on how many [Sparks] stacks are spent (this damage does not inflict additional [Sparks]).\nChange [Resonance] DMG based on the number of foes: 150%/120%/100% when facing 1/2/3+ foes respectively. This [Resonance] cannot reduce Down Gauge. When a foe is defeated, transfer its [Sparks] stacks randomly to other foes.",
        "r1": "Flash of Summer",
        ...
        "r2": "Gentle Sunbeams",
        "r2_detail": "Every 2 times a [Summer Reminiscence] effect is activated, inflict 1 [Sparks] stack on 1 random foe. Each time [Sparks] is inflicted, permanently increase the party's ATK by 2%, stacking up to 15 times.",
        "r3": "Sentimental Seabreeze",
        "r3_detail": "[Have a Cold Drink] Lv. +3, up to a maximum of Lv. 15.\n[Hale Summer Days] Lv. +3, up to a maximum of Lv. 15.",
        "r4": "Sparkling Summer Night",
        "r4_detail": "[HIGHLIGHT] Enhanced: Deals 2 extra hits of damage, each hit inflicts 1 [Sparks].",
        "r5": "Lingering Glow",
        "r5_detail": "[Sparkling Memories] Lv. +3, up to a maximum of Lv. 15.\n[Thief Tactics] Lv. +3, up to a maximum of Lv. 15.",
        "r6": "Heartfelt Days",
        "r6_detail": "[Summer Reminiscence] gains the following effects:\nWhen dealing damage with [Summer Reminiscence], increase CRIT Rate by 35%. Each time a foe takes a [Summer Reminiscence] effect, permanently increase their DMG Taken by 5%, stacking up to 3 times. At max stacks, additionally increase CRIT DMG Taken by 20%."
    },
    "하루": {
        "name": "Haru Okumura",
        "r0": "Frenzy Teatime",
