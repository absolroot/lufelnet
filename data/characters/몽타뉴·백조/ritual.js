...
window.ritualData["몽타뉴·백조"] = {
  ...
  "r4": "꿈결처럼 가벼운 턴",
  "r4_detail": "『봄 형태』: HIGHLIGHT 시전 시 코토네 몽타뉴·백조가 『봄의 결계』 안에 있으면, 수량 제한을 돌파할 수 있는 『아침 이슬 결정』 1개를 추가로 획득한다. 그렇지 않을 경우 HIGHLIGHT 스킬 대미지가 25% 증가한다.\n『겨울밤 형태』: HIGHLIGHT 시전 시, 코토네 몽타뉴·백조가 『겨울밤의 결계』 내에 있으면, 수량 제한을 돌파할 수 있는 『겨울 서리 결정』 1개를 추가로 획득한다. 그렇지 않을 경우 HIGHLIGHT 스킬 대미지가 25% 증가한다.",
  "r5": "삶의 끝을 넘어",
