...
window.ritualData["미나미·여름"] = {
  "name": "미야시타 미나미·여름",
  "r0": "당신을 위해 붙잡은 시간",
  "r0_detail": "미야시타 미나미·여름이 무한 사용 가능한 전용 버프류 약품 3종을 지닌다. 동료에게 약품을 사용할 때 메인 목표의 생명을 미야시타 미나미·여름 최대 생명의 8%만큼 회복시킨다. 『너를 위한 꽃』 시전 시 『꿈의 꽃』을 1송이 획득하며, 최대 1개까지 보유할 수 있다. 자신의 턴에 『꿈의 꽃』 1송이를 소모하여 『추억의 처방』을 획득할 수 있다. 『추억의 처방』: 약품 사용 시 턴이 소모되지 않고, 사용한 버프류 약품의 효과 지속 시간이 1턴 연장된다. 약품은 1회 사용 후 효력을 상실한다.",
  "r1": "당시의 추억",
  "r1_detail": "『너를 위한 꽃』 시전 시 『꿈의 꽃』 1송이를 추가로 획득하며, 『꿈의 꽃』 보유 상한이 2송이로 증가한다. 자신의 약품 효과가 20% 증가한다.",
  "r2": "바람에 흔들리는 꽃",
  "r2_detail": "『여름 바구니』 시전 시 목표가 『꽃의 온기』를 추가로 획득한다. 『꽃의 온기』: 3턴 동안 방어력이 30% 감소하고, 받는 크리티컬 효과가 30% 증가한다.",
  "r3": "따스한 햇살 아래 뜨겁게",
...
window.cnCharacterRitualData["미나미·여름"] = {
  "name": "宫下美波·夏日",
  "r0": "为你停驻的时光",
  "r0_detail": "宫下美波·夏日会随身携带可无限使用的3种专属增益类药品。释放『献给彼方的花朵』时获得1朵『梦回之花』，最多可持有1朵。自己回合时，可消耗1朵『梦回之花』获得『回忆的处方』。『回忆的处方』：使用药品不占用回合，使用的增益类药品效果持续时间延长1回合，使用1次药品后失效。",
  "r1": "彼时的回忆",
  "r1_detail": "释放『献给彼方的花朵』时额外获得1朵『梦回之花』，『梦回之花』的持有上限提升至2朵。自身药品效果提升20%。",
  "r2": "被风吹拂的花",
  "r2_detail": "释放『夏日礼篮』额外使目标获得『花之煦』。『花之煦』：防御力降低25%、受到暴击效果提升30%，持续3回合。",
  "r3": "在煦日下热烈盛开",
  "r3_detail": "『夏日礼篮』、『献给彼方的花朵』的技能等级提升3级，至多提升至15级。",
  "r4": "此时的人",
  "r4_detail": "HIGHLIGHT提供的所有增益效果延长至3回合，同时使下一次使用药品时，药品效果额外提升5%。",
  "r5": "一如往昔的温柔",
  "r5_detail": "『盛夏花野』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "藏着未说完的秘密",
