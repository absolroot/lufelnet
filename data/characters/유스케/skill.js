...
window.characterSkillsData["유스케"] = {
  ...
  "skill2": {
    ...
    "sp": 20,
    "cool": 0,
    "description": "임의의 적에게 방어력 92.9%/102.4%/98.6%/108.1%의 빙결 속성 대미지를 5회 주고, 해당 스킬 공격을 받지 않는 적을 우선 공격한다. 자신이 실드 상태인 경우, 추가로 30%의 스킬 대미지를 준다. 동일 목표에게 여러 번 명중 시 대미지가 60% 감소하고, 최소 20%의 대미지를 줄 수 있다."
  },
  "skill3": {
    "name": "은화의 잔심",
    "element": "버프",
