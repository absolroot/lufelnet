...
window.ritualData["쇼키·암야"] = {
  "name": "이케나미 쇼키·암야",
  "r0": "어두운 밤의 별빛",
  "r0_detail": "이케나미 쇼키·암야는 전투 중 자신의 생명을 소모해 『암야의 계약』을 획득할 수 있으며, 『너에게 새기는 이름』의 스킬 대미지를 증가시킬 수 있다.\n이케나미 쇼키·암야가 축복 효과 획득 시, 이를 특수한 『암야의 축복』으로 전환한다. 『암야의 축복』: 축복 효과로 간주되며, 턴 종료 시마다 2턴 동안 최대 생명의 2%에 해당하는 실드를 획득한다(10회 중첩 가능). 이 방법으로 획득한 실드 효과는 2턴 동안 지속된다.",
  "r1": "유성의 인도",
  "r1_detail": "이케나미 쇼키·암야는 전투 시작 시 『불멸의 별빛』을 획득한다. 『불멸의 별빛』: 자신이 처음 빈사 상태가 되면 『불멸의 별빛』을 소모하여 자신의 최대 생명 63%에 해당하는 생명을 회복하고(최소 생명 1포인트까지 회복), 1턴 동안 공격력 보너스 30%를 획득한다.\n『불멸의 별빛』을 보유하고 있다면, 『굳건한 맹세』를 시전하여 생명을 0 이하로 감소시켜 스스로 빈사 상태가 될 수 있습니다. 이 방식으로 『불멸의 별빛』을 소모하면 해당 턴에 획득하는 『암야의 계약』 2중첩은 상한을 돌파할 수 있습니다.\n『암야의 계약』 획득 시 2턴 동안 크리티컬 확률이 추가로 5% 증가한다(3회 중첩 가능).",
  "r2": "피와 살의 조합",
  "r2_detail": "『굳건한 맹세』 시전 시 스킬 소모가 25% 감소한다. 『암야의 계약』의 중첩 상한이 3중첩 증가한다.",
  "r3": "운명을 향한 항쟁",
  "r3_detail": "『굳건한 맹세』, 『너에게 새기는 이름』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r4": "성실한 각성",
  "r4_detail": "HIGHLIGHT 효과 증가: 4턴 동안 자신의 공격력이 추가로 35% 증가한다.",
  "r5": "GIUSTIZIA",
  "r5_detail": "『여명의 검』, 『전투 기술』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r6": "어둠을 밝히는 생명의 의지",
...
window.cnCharacterRitualData["쇼키·암야"] = {
  "name": "池波星辉·永夜",
  "r0": "黑夜中的星芒",
  "r0_detail": "池波星辉·永夜可以在战斗中主动消耗自身生命值获得『暗夜契约』，提升『以吾之名刻于汝身』的技能伤害。\n池波星辉·永夜获得祝福效果时，会将其转化为特殊的『暗夜祝福』：视为祝福效果，每回合结束获得相当于最大生命值2%的护盾，上限10层，持续2回合，通过这种方式获得的护盾效果持续2回合。",
  "r1": "流星的指引",
  "r1_detail": "池波星辉·永夜在战斗开始时获得『不灭星辉』：自身首次陷入濒死状态时，消耗『不灭星辉』恢复自身相当于最大生命值63%的生命值（至少恢复至1点生命值），并获得30%攻击力加成，持续1回合。\n拥有『不灭星辉』时，释放『坚守的誓言』可将生命值减少至0以下主动陷入濒死状态，通过这种方式消耗『不灭星辉』后，当回合获得的后续2层『暗夜契约』可突破上限。\n获得『暗夜契约』时，额外使暴击率提高5%，持续2回合，可叠加3层。",
  "r2": "拼上血肉之躯",
  "r2_detail": "释放『坚守的誓言』时，技能消耗降低25%，『暗夜契约』的可叠加上限提升3层。",
  "r3": "向命运抗争",
  "r3_detail": "『坚守的誓言』、『以吾之名刻于汝身』的技能等级提升3级，至多提升至15级。",
  "r4": "诚实的觉悟",
  "r4_detail": "HIGHLIGHT效果提升：额外使自身攻击力提升35%，持续4回合。",
  "r5": "GIUSTIZIA",
  "r5_detail": "『破晓之剑』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "照亮黑夜的生命欲",
