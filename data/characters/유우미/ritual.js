...
window.ritualData["유우미"] = {
  ...
  "r6": "클래식 마티니",
  "r6_detail": "『칵테일』의 상한이 4잔으로 증가한다. 전투 시작 시, 시이나 유우미가 『믹스・DELUXE』를 1잔 획득한다. 시이나 유우미가 『칵테일』을 3잔 제조하면 『믹스・DELUXE』를 1잔 추가로 획득한다.  『믹스·DELUXE/믹스/러프』가 발동하는 모든 스킬 효과를 120%/100%/50%에서 135%/120%/75%로 증가시킨다(『매혹적인 향기』, 『향기로운 와인』, 『음주가무』 포함)."
};
