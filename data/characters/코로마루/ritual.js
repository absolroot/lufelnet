...
window.ritualData["코로마루"] = {
  "name": "코로마루",
  "r0": "도시의 인기 스타",
  "r0_detail": "전투 시작 시 코로마루가 동료 1명을 『주인』으로 지정하고, 『특정 규칙』에 따라 『주인』과 『사냥개 협공』을 진행할 수 있다. 『주인』 선택 완료 후 코로마루는 자동으로 지원 스킬을 시전한다. 코로마루의 테우르기아는 목표에게 『영혼 추격』을 추가할 수 있으며, 자신의 다른 페르소나 스킬을 사용해 『영혼 추격』을 보유한 유닛 공격 시 목표를 화염/전격/빙결 속성 『적합성 저하』 상태에 빠뜨린다. 또한 아군 전체에 『충견의 포효』를 시전한다. 『충견의 포효』: 2턴 동안 공격력이 15% 증가하고, 대미지가 15% 증가하며, 테우르기아 대미지 증폭이 20% 증가한다.",
  "r1": "멍!",
