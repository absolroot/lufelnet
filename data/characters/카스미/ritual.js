...
window.ritualData["카스미"] = {
  "name": "요시자와 카스미",
  "r0": "12시의 종소리",
  "r0_detail": "요시자와 카스미의 HIGHLIGHT가 HIGHLIGHT 에너지를 소모하지 않으며 크리티컬이 발생한다. 아군의 괴도 턴에 요시자와 카스미의 춤사위 중첩 횟수가 2회 이상이면 변신하여 『가면무도회』 상태에 진입해 HIGHLIGHT를 1회 사용할 수 있다(변신 쿨타임은 3턴). 해당 효과는 요시자와 카스미가 『가면무도회』 상태로 두 번째 턴을 시작할 때까지 지속된다. 『가면무도회』 상태에서 춤사위 1중첩마다 요시자와 카스미의 공격력이 10%, 크리티컬 확률이 4% 증가한다. 『가면무도회』 상태 종료 시 자신의 모든 춤사위가 제거된다(『가면무도회』 상태 종료 전까지 HIGHLIGHT를 시전하지 않으면 랜덤 목표에게 HIGHLIGHT를 자동 시전함).",
  "r1": "찢어진 치마와 그녀의 그림자",
  "r1_detail": "『댄스 파트너』의 지속 시간이 1턴 연장된다. 『함께 추는 춤』 사용 후 자신 및 『댄스 파트너』의 크리티컬 확률이 3턴 동안 추가로 15% 증가한다.",
  "r2": "무도회를 향한 동경",
  "r2_detail": "자신의 춤사위가 2중첩에 도달하면 공격력이 33% 증가하고, 영구 지속된다.\n춤사위가 3중첩에 도달하면 영구적으로 크리티컬 효과가 33% 증가한다.",
  "r3": "그녀의 노랫소리",
  "r3_detail": "『전투 기술』, 『어둠 속 빛』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r4": "왕자의 눈빛",
  "r4_detail": "HIGHLIGHT 발동 시 『여명의 베일』을 1중첩 획득한다. 『여명의 베일』: 대미지를 받을 시 1중첩 소모하며, 해당 대미지 효과를 회피한다. 일부 스킬에는 효과가 적용되지 않는다. 자신의 춤사위가 4중첩에 도달하면 HIGHLIGHT 대미지가 50% 증가한다.",
  "r5": "잊혀진 유리구두",
  "r5_detail": "『함께 추는 춤』, 『피어나는 마음』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r6": "모든 틈과 모든 문",
  "r6_detail": "자신이 HIGHLIGHT를 시전한 후 『가면무도회』 상태 종료 전까지 HIGHLIGHT를 1회 추가로 시전할 수 있다. 대미지는 고유 HIGHLIGHT의 80%다. 해당 효과는 『가면무도회』 상태 지속 시간 이내에 1회만 발동할 수 있다."
};
...
window.jpCharacterRitualData["카스미"] = {
  "name": "芳澤 かすみ",
  "r0": "仮面の舞踏会",
  "r0_detail": "かすみのハイライトはハイライトゲージを消費せず、クリティカルを発生できる。\n味方の行動時、『ステップ』を２つ以上獲得している場合、『灰かぶりの魔法』を使用して『マスカレード』状態になることができ、ハイライトを１回発動できる（『灰かぶりの魔法』のクールタイムは３ターン）。この効果は『マスカレード』状態になってから２回目の自身のターン開始まで（自身のターンに『灰かぶりの魔法』を使用した場合は次ターン開始まで）持続する。\nさらに『マスカレード』状態では『ステップ』１つごとに攻撃力が１０%上昇し、クリティカル率が４%上昇する。\n『マスカレード』状態が終了した時、すべての『ステップ』が消失する。ハイライトを発動せずに『マスカレード』状態が終了した場合、ランダムな敵単体に自動でハイライトが発動する。",
  "r1": "心奪う誘い",
  "r1_detail": "『ダンスパートナー』の持続ターンが１ターン延長される。\n『インヴィテーション』を使用した時、３ターンの間、自身と『ダンスパートナー』のクリティカル率が１５%上昇する。",
  "r2": "フロア舞う花",
  "r2_detail": "『ステップ』を２つ獲得した時、攻撃力が３３%上昇する。３つ獲得した時、クリティカルダメージが３３%上昇する。これらの効果は永続する。",
  "r3": "一夜の輝き",
  "r3_detail": "『シンデレラ・グロー』／『怪盗戦技』のスキルレベルが３上昇する。",
  "r4": "時告げる鐘の音",
  "r4_detail": "ハイライトを発動した時、『十二時の鐘』を１つ獲得する。『十二時の鐘』はダメージを受ける時に１つ消費して、そのダメージを回避する（一部のスキルには発動しない）。\nさらに『ステップ』を４つ獲得した時、ハイライトダメージが５０%上昇する。",
  "r5": "覚めやらぬ夢",
  "r5_detail": "『インヴィテーション』／『ミッドナイトマジック』のスキルレベルが３上昇する。",
  "r6": "素顔の舞踏会",
  "r6_detail": "自身がハイライトを発動した後、『マスカレード』状態中に、追加でハイライトを１回発動できるようになる。このハイライトは通常の８０%分のダメージで『マスカレード』状態になるごとに一度だけ発動でき、『マスカレード』終了時に自動発動はしない。"
};
...
window.cnCharacterRitualData["카스미"] = {
  ...
  "r4": "王子的目光",
  "r4_detail": "发动HIGHLIGHT时，获得1层『黎明的面纱』：受到伤害时消耗1层，闪避本次伤害效果，对部分技能无效。自身舞姿达到4层时，HIGHLIGHT伤害提升50%。",
  "r5": "被遗忘的水晶鞋",
