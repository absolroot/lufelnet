...
各キャラクターは基本攻撃力を持っており、その成長率はレベルと覚醒によって決定されます。
...
代表的な例として、ディオニュソスはリベリオンで15.7%のクリティカル確率と、パッシブを通じて30%のクリティカル効果を上げることができるペルソナです。
...
クリティカル確率を10%上げた場合、クリティカル効果は2倍の20%を上げる形が最も効率が良いです。
