...
window.enCharacterRitualData["슌"] = {
  ...
  "r3": "Man of Integrity",
  "r3_detail": "Increase the skill levels of Icicle Hatchet and Smash Hit by 2.",
  "r4": "A Man's Back",
  "r4_detail": "Highlight Enhanced: Decrease party's damage taken by 16% for 2 turns.",
  "r5": "Masterful Cutting Skills",
  "r5_detail": "Increase the skill levels of Icy Defense and Thief Tactics by 2.",
...
window.cnCharacterRitualData["슌"] = {
  "name": "加纳骏",
  "r0": "勇敢者的游戏",
  "r0_detail": "加纳骏受到敌方攻击的概率提高，受到攻击后会获得『荒野救星』。\n加纳骏的回合结束时，会消耗『荒野救星』并恢复自身已损生命值的30%。",
  "r1": "下战书",
  "r1_detail": "加纳骏处于『荒野救星』状态时，受到伤害降低8%。",
  "r2": "危险对峙",
  "r2_detail": "『冰山撼动』、『先锋突击』的技能等级提升2级，至多提升至15级。",
  "r3": "热血的硝烟",
  "r3_detail": "加纳骏的生命值低于50%时，受到的治疗效果提升25%。",
  "r4": "一决胜负",
  "r4_detail": "『零度治愈』、『战斗技巧』的技能等级提升2级，至多提升至15级。",
  "r5": "暴力处决",
  "r5_detail": "HIGHLIGHT效果提升：使所有同伴受到伤害降低16%，效果持续2回合。",
  "r6": "胜利者荣光",
