const characterSkillsData = {
    ...
    "마유미": {
        ...
        "skill1": {
            ...
            "hp": 8,
            "cool": 0,
            "description": "모든 적에게 공격력 134.2%의 물리 속성 대미지를 주고, 2턴 동안 모든 동료의 대미지가 8.8%(속도 10포인트마다 대미지가 추가로 2% 증가하며, 최대 대미지 추가 증가량은 35.1%) 증가한다.\n추가 턴 시전: 스킬 대미지가 50% 증가하고, 메인 목표에게 반드시 크리티컬을 준다."
        },
        "skill2": {
            "name": "과부하 가속",
            "element": "버프광역",
            ...
            "sp": 22,
            "cool": 0,
            "description": "2턴 동안 모든 동료의 공격력이 8.8%(속도 10포인트마다 공격력이 추가로 2% 증가하고, 최대 공격력 추가 증가량은 35.1%) 증가하고, 방어력이 9.8%(속도 10포인트마다 방어력이 추가로 2.22% 증가하고, 최대 방어력 추가 증가량은 39.0%) 증가한다.\n추가 턴 시전: 2턴 동안 모든 동료가 1964포인트 대미지를 막을 수 있는 실드를 1중첩 획득한다."
        },
        "skill3": {
            "name": "엔진 굉음",
            "element": "버프광역",
            ...
            "sp": 25,
            "cool": 0,
            "description": "2턴 동안 모든 동료의 관통이 1.0%(속도 10포인트마다 관통이 추가로 0.22% 증가하고, 최대 관통 추가 증가량은 3.9%) 증가하고, 공격력이 12.7%(속도 10포인트마다 공격력이 추가로 2.89% 증가하고, 최대 공격력 추가 증가량은 50.8%) 증가한다.\n추가 턴 시전: 1턴 동안 메인 목표 관통이 2.0%(속도 10포인트마다 관통이 추가로 0.44% 증가하고, 최대 관통 추가 증가량은 7.8%) 증가한다."
        },
        "skill_highlight": {
            "element": "버프광역",
            "type": "버프",
            "description": "2턴 동안 모든 동료의 공격력이 5.9%(속도 10포인트마다 공격력이 추가로 1.33% 증가하고, 최대 공격력 추가 증가량은 23.4%) 증가하고, 대미지가 5.9%(속도 10포인트마다 대미지가 추가로 1.33% 증가하고, 최대 대미지 추가 증가량은 23.4%) 증가한다. 또한 메인 목표가 다음에 적에게 대미지를 줄 시, 적 메인 목표의 다운 수치가 추가로 1포인트 감소한다."
        },
        "passive1": {
            "name": "선두",
            "element": "패시브",
