...
window.characterList = window.characterList || {
    mainParty: [
        ...
        "리코·매화", "마사키", "마유미", "마코토", "미나미", "미나미·여름", "미유·여름", "모르가나", "모르가나·댄싱 스타",
        "모토하", "모토하·여름", "모토하·청광", "아란", "몽타뉴", "몽타뉴·백조", "미오", "미츠루", "사나다", "쇼키", "쇼키·암야", "슌", "슌·프론티어",
        "세이지", "안", "안·댄싱 스타", "아야카", "아야카·여름", "아이기스", "아케치", "야오링", "야오링·사자무",
        "원더", "유스케", "YUI", "YUI·스텔라", "유카리", "유키미", "유키 마코토", "이치고", "이치고·여름",
        "준페이", "코로마루",
...
Object.assign(window.characterData, {
    "류지·댄싱 스타": {
        ...
        "release_order": 56,
        "p5d": true,
        "codename": "SKULL·Starlight",
        "persona": "제천대성",
        "persona_en": "Seiten Taisei",
        "persona_jp": "セイテンタイセイ",
        "persona_cn": "齐天大圣",
        "name": "사카모토 류지·댄싱 스타",
    ...
    "모르가나·댄싱 스타": {
        ...
        "tag_en": "Wind Exhaustion, Attack, Critical Effect, Downed Damage Taken, Buff Dispel, Healing, DMG Bonus",
        "tag_jp": "風竭、攻撃力、クリティカル効果、ダウン脆弱、バフ解除、回復、ダメージボーナス",
        "color": "#3daf00",
        "element": "질풍",
        "rarity": 5,
        "position": "굴복",
    ...
    "렌·댄싱 스타": {
        "limit": true,
        "tag": "총공격, 크리티컬 효과, 크리티컬 확률, 공격력, 방어력 감소, 다운 허약",
    ...
    "후카": {
        ...
        "role_jp": "アリー・スワップ 解明",
        "tag": "아군 교체, 크리티컬 효과, 크리티컬 확률, 공격력, 디버프 제거",
    ...
    "미유·여름": {
        ...
        "persona_jp": "ネメルテス",
        "name": "사하라 미유·여름",
        "name_en": "Wavecatcher Miyu",
        "name_jp": "海夕・サマーウェーブ",
        "name_cn": "佐原海夕·夏日",
        "name_tw": "佐原海夕·夏日",
        "codename": "PUPPET·Wavecatcher",
        "skill_item": 5,
        "persona_cn": "涅墨耳忒斯"
    },
    "미나미·여름": {
        ...
        "persona_jp": "タレイア",
        "name": "미야시타 미나미·여름",
        "name_en": "Beachflower Minami",
        "name_jp": "美波・ビーチフラワー",
        "name_cn": "宫下美波·夏日",
        "codename": "MARIAN·Beachflower",
        "skill_item": 5,
        "persona_cn": "塔利亚"
    },
    "이치고": {
    ...
    "유카리": {
        ...
        "tag": "테우르기아 충전, 디버프 제거, 공격력, 대미지 보너스, 관통, 풍습",
        "color": "#ed85ed",
        "element": "질풍",
        "rarity": 5,
        "position": "구원",
    ...
    "마나카": {
        ...
        "role_jp": "ターンリバート 解明",
        "tag": "추가 턴, 디버프 제거, 관통, 크리티컬 확률, 대미지 보너스, 공격력",
        "color": "#e9e6fe",
        "element": "버프",
        "rarity": 5,
        "position": "해명",
    ...
    "마사키": {
        "limit": false,
        "tag": "실드, 방어력, 크리티컬 확률, 대미지보너스, 공격받을 확률 증가, 효과 저항, 동결, 관통",
        "color": "#3cf2ff",
        "element": "빙결",
        "rarity": 5,
        "position": "방위",
