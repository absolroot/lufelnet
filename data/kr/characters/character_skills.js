const characterSkillsData = {
    ...
    "유카리": {
        ...
        "skill1": {
            ...
            "sp": 23,
            "cool": 0,
            "description": "단일 적에게 유카리의 공격력의 200.1%/220.6%/212.4%/232.9%만큼 질풍 속성 피해를 입히고, 100%의 기본 확률로 풍습 상태 및『바람의 흔적』상태에 빠뜨립니다 (2턴 지속).\n『바람의 흔적』은 전장에 1개만 존재할 수 있습니다.\n\n패시브 효과 : 아군이 스킬을 사용할 때, 대상이 『바람의 흔적』 상태일 경우 해당 스킬의 공격력이 8.8%/9.7%/9.3%/10.2% + 유카리의 공격력의 100당 0.72%만큼 증가합니다. (최대 29.3%/32.3%/31.1%/34.1%)"
        },
        "skill2": {
            "name": "바람의 추적자",
            "element": "버프광역",
            ...
            "sp": 25,
            "cool": 0,
            "description": "3턴 동안 모든 아군이 받는 피해를 29.3%/32.3%/31.1%/34.1%만큼 감소시키고, 메인 대상의 공격력이 7.8%/8.6%/8.3%/9.1% + 유카리의 공격력의 100당 0.78%만큼 증가합니다 (최대 31.2%/34.4%/33.2%/36.4%).\n 또한 스킬 피해량을 2턴 동안 유카리의 공격력 100당 0.24%만큼 증가시킵니다 (최대 9.8%/10.8%/10.4%/11.4%)."
        },
        "skill3": {
            "name": "리바이브 애로",
            "element": "치료광역",
            ...
            "sp": 27,
            "cool": 0,
            "description": "모든 아군의 체력을 유카리의 공격력의 39.1%/43.1%/41.5%/45.6% + 2507/3158/3081/3773만큼 회복시킵니다.\n사용시 보유 중인 『바람의 언어』을 모두 소모하며, 소모한 『바람의 언어』 1중첩당 메인 대상에게 테우르기아 게이지를 17.5포인트 회복시킵니다. 해당 대상의 다음 테우르기아 사용 시 공격력이 29.3%/32.3%/31.1%/34.1% 증가하며, 2턴 동안 지속됩니다 (최대 2스택까지 중첩 가능).\n\n※ 회복된 테우르기아 에너지가 최대치를 초과할 경우, 초과된 에너지는 임시로 저장되며, 대상이 테우르기아를 사용한 후 반환됩니다. 단, 최대 저장량은 대상의 테우르기아 최대치에 해당하는 만큼입니다.\n\n※ 메인 대상이 S.E.E.S. 멤버가 아닐 경우, 바람의 언어 1중첩당 다음 하이라이트 스킬 사용시 총 피해량이 9.8%/10.8%/10.4%/11.4%만큼 증가합니다."
        },
        "skill_highlight": {
            "name": "테우르기아 - 사이클론",
            "element": "질풍",
            "type": "",
            "description": "발동 조건: 테우르기아 에너지 70포인트\n단일 적에게 유카리의 공격력의 416.0%/457.6%/465.9%/507.5%만큼 질풍 속성 피해를 입히고, 아군 전체의 스킬 피해량을 유카리의 공격력 100당 0.48%만큼 증가시킵니다 (최대 20.0%/22.0%/22.4%/24.4%).\n또한 대상에게 걸린 버프 2개를 해제하며 100%의 기본 확률로 적을 『풍습』 상태로 만들고, 『바람의 흔적』을 2턴간 부여합니다."
        },
        "skill_support": {
            "name": "지원 기술",
            "element": "패시브",
        ...
        "passive1": {
            "name": "교감",
            "element": "패시브",
            "description": "유카리가 전투에 참여 중일 때, 모든 아군의 HIGHLIGHT 및 테우르기아 스킬 피해량이 45% 증가합니다."
        },
        "passive2": {
            "name": "승부욕",
            "element": "패시브",
            "description": "전투 중, 유카리의 공격력의 100당 최대 체력이 60 증가합니다 (최대 2700)."
        }
    },
