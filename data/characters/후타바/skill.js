...
window.characterSkillsData["후타바"] = {
  ...
  "skill3": {
    ...
    "description": "해제 조건: 아군 캐릭터가 『해킹 완료』 상태일 때\n2턴 동안 동료 1명의 공격력을 270/297/302/329+(사쿠라 후타바의 공격력 100점마다 추가로 21.7의 공격력 증가, 최대 공격력 4600/5060/5980/6440점까지 계산) 증가시킨다. 1턴 동안 모든 적에게 해당 괴도의 적합성 『교란 바이러스』를 추가한다. 『교란 바이러스』: 목표에 대응하는 속성의 『적합성 저하』: 무효, 반사, 흡수일 경우 내성으로, 내성일 경우 일반으로, 일반일 경우 약점으로 변경된다. 약점일 경우, 약점 대미지를 25% 증가시킨다."
  },
  "skill_highlight": {
    "name": "속성 증가",
    "element": "패시브",
