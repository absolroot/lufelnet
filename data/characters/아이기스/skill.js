...
window.characterSkillsData["아이기스"] = {
  ...
  "skill_highlight": {
    ...
    "sp": 0,
    "cool": 0,
    "description": "발동 조건: 테우르기아 에너지 70포인트\n모든 적에게 공격력 248.4%/273.8%/263.7%/289.1%의 총격 속성 대미지를 주며, 해당 대미지는 크리티컬이 발생할 수 있다. 자신이 『오르기아 모드』에 진입하고, 효과는 자신의 다음 턴 종료 시까지 지속된다.\n『오르기아 모드』: 아이기스는 조작할 수 없으며, 동료 2명의 추가 턴이 아닌 턴이 종료될 때마다 『기관총·난사』와 『섬광 사격』을 번갈아 발동한다. 『오르기아 모드』에서 발동하는 모든 스킬은 테우르기아 스킬로 간주되며, 크리티컬이 발생할 수 있다.\n자신의 턴 종료 시 『제압 사격』이 사용 가능하면 『제압 사격』을 발동하고 『오르기아 모드』를 종료한다. 그렇지 않으면 『기관총·난사』를 발동하고 『오르기아 모드』를 종료한다. 『오르기아 모드』 종료 시 『제압 사격』은 『기어 강화』로 되돌아간다."
  },
  "skill_support": {
    "name": "지원 스킬",
    "element": "버프",
...
window.enCharacterSkillsData["아이기스"] = {
  ...
  "skill_highlight": {
    ...
    "sp": 0,
    "cool": 0,
    "description": "Use condition: 70 Theurgy Energy\nDeal Gun damage to all foes equal to 248.4%/273.8%/263.7%/289.1% of Attack. This damage can crit. Enter [Orgia Mode] until the end of Aigis's next turn.\n[Orgia Mode]: Aigis cannot be controlled. After every 2 non-extra ally turns, Aigis alternates between using [Machine Gun Barrage] and [Flash Strike]. All skills used in [Orgia Mode] are treated as Theurgy skills and can crit.\nAt the end of Aigis's turn, if [Suppressive Smash] is available, use [Suppressive Smash] then exit [Orgia Mode]. Otherwise, use [Machine Gun Barrage] then exit [Orgia Mode]. When exiting [Orgia Mode], [Suppressive Smash] reverts to [Gear Enhancement]."
  },
  "skill_support": {
    "name": "Assist Skill",
    "element": "버프",
...
window.jpCharacterSkillsData["아이기스"] = {
  ...
  "skill_highlight": {
    ...
    "sp": 0,
    "cool": 0,
    "description": "発動条件：神通法エネルギー70\n敵全体に攻撃力248.4%/273.8%/263.7%/289.1%の射撃属性ダメージを与え、このダメージはクリティカルが発生する。自身が『オルギアモード』に入り、自身の次のターン終了時まで持続する。\n『オルギアモード』：アイギスは操作できなくなり、味方2人の追加ターンではないターンが終了するたびに『機銃・乱撃』と『閃光撃』を交互に発動する。『オルギアモード』中に発動する全てのスキルは神通法スキルとみなされ、クリティカルが発生する。\n自身のターン終了時、『制圧強打』が使用可能な場合は『制圧強打』を発動して『オルギアモード』を終了し、そうでない場合は『機銃・乱撃』を発動して『オルギアモード』を終了する。『オルギアモード』終了時、『制圧強打』は『ギア強化』に戻る。"
  },
  "skill_support": {
    "name": "サポートスキル",
    "element": "버프",
...
window.cnCharacterSkillsData["아이기스"] = {
  ...
  "skill_highlight": {
    ...
    "sp": 0,
    "cool": 0,
    "description": "释放条件：70点神通法能量\n对所有敌人造成248.4%/273.8%/263.7%/289.1%攻击力的射击属性伤害，该伤害可以暴击。自身进入『狂宴模式』，持续至自身下一回合结束。\n『狂宴模式』：埃癸斯无法操控，每经过2个同伴的非额外回合会交替发动『机铳·乱击』和『闪光击』。『狂宴模式』下释放的所有技能都视为神通法技能，且可以发生暴击。\n自身回合结束时，若『压制猛击』处于可用状态，则释放『压制猛击』并退出『狂宴模式』，否则释放『机铳·乱击』并退出『狂宴模式』。退出『狂宴模式』时，『压制猛击』还原为『齿轮强化』。"
  },
  "skill_support": {
    "name": "援助技能",
    "element": "버프",
