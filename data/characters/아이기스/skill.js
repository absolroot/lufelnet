...
window.characterSkillsData["아이기스"] = {
  ...
  "skill1": {
    ...
    "hp": 5,
    "cool": 0,
    "description": "적 전체에 공격력 41.7%/45.9%/44.2%/48.5%의 총격 속성 대미지를 주고, 2턴 동안 자신의 다음 『섬광 사격』의 스킬 대미지가 10% 증가하며, 자신이 『위력 탄약』을 1발 장전한다(3회 중첩 가능)."
  },
  "skill2": {
    "name": "섬광 사격",
    "element": "총격광역",
    ...
    "hp": 5,
    "cool": 0,
    "description": "적 전체에 공격력 41.7%/45.9%/44.2%/48.5%의 총격 속성 대미지를 주고, 2턴 동안 자신의 다음 『기관총·난사』의 스킬 대미지가 10% 증가하며, 자신이 『위력 탄약』을 1발 장전한다(3회 중첩 가능)."
  },
  "skill3": {
    "name": "기어 강화",
    "element": "버프",
