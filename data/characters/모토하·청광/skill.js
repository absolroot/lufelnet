...
window.characterSkillsData["모토하·청광"] = {
  ...
  "skill1": {
    ...
    "sp": 20,
    "cool": 0,
    "description": "2턴 동안 적 전체에 공격력 282.8%/311.8%/300.2%/329.2%의 전격 속성 대미지를 준다. 이 대미지는 적 전체가 균등하게 분담하며, 목표를 감전과 『플래시 오버』 상태에 빠트린다. 자신은 『빛』을 획득한다.\n『플래시 오버』: 받는 대미지가 39.0%/43.0%/41.4%/45.4% 증가한다."
  },
  "skill2": {
    "name": "지지 않는 태양",
    "element": "버프",
    ...
    "sp": 22,
    "cool": 0,
    "description": "아군 전체가 다운 수치 1포인트와 1561/1721/1657/1817의 실드를 획득하고, 적 전체를 조롱한다. 자신이 받는 대미지가 39.0%/43.0%/41.4%/45.4% 감소한다. 효과는 자신의 다음 턴 시작 시까지 지속된다.\n다음 턴 시작 시, 자동으로 적 전체에 『순뢰의 창격』의 대미지 효과를 주며, 그동안 적의 스킬 대미지를 1회 받을 때마다 해당 『순뢰의 창격』의 스킬 대미지가 5% 증가한다. 자신은 『그림자』를 획득한다."
  },
  "skill3": {
    "name": "능공의 뇌광",
    "element": "전격광역",
    ...
    "sp": 24,
    "cool": 0,
    "description": "즉시 2턴 동안 『결의의 소녀』 상태에 진입한다. 적 목표 2명(동일 목표 중복 선택 가능)에게 공격력 162.9%/179.6%/172.9%/189.6%의 전격 속성 대미지를 준다. 스킬 목표가 『플래시 오버』 상태라면 스킬 대미지가 기존의 120%로 증가한다.\n『결의의 소녀』: HIGHLIGHT 시전 시, 스킬 배율이 55.8%/61.5%/59.3%/65.0% 증가한다."
  },
  "skill_highlight": {
    "name": "황혼의 잔영",
    "element": "전격광역",
    "type": "단일피해",
    "description": "『황혼의 잔영』\n발동 조건: 최소 3중첩의 『빛』/『그림자』를 보유해야 한다.\n적 목표 2명(동일 목표 중복 선택 가능)을 선택하여 각각 『빛의 창』과 『그림자의 창』을 시전한다.\n『빛의 창』: 공격력 223.3%/246.2%/237.0%/259.9%의 전격 속성 대미지를 준다.\n『그림자의 창』: 『빛의 창』 대미지 100%에 해당하는 고정 대미지를 주고, 적합성을 무시하고 목표의 다운 수치 1포인트를 차감한다.\n『빛의 창』과 『그림자의 창』이 동시에 2명의 적에 명중하면 스킬 대미지가 기존의 115%만큼 증가한다. 같은 적에게 명중 시 해당 스킬 시전 시 크리티컬 효과가 30% 증가한다.\n총 3중첩의 『빛』/『그림자』를 소모한다(『빛』 우선 소모). 『빛』 1중첩을 소모할 때마다 『빛의 창』 시전 시 공격력이 29.3%/32.3%/31.1%/34.1% 증가한다. 『그림자』 1중첩을 소모할 때마다 아군 전체가 2턴 동안 488/538/518/568 실드를 획득한다.",
    "cool": 0
  },
  "passive1": {
    "name": "골드",
    "element": "패시브",
    "description": "전투 시작 시, 아라이 모토하·청광은 2턴 동안 『결의의 소녀』 상태에 진입한다. 『결의의 소녀』 상태일 때, 관통이 15.0% 증가한다.",
    "cool": 0
  },
  "passive2": {
    "name": "불굴",
    "element": "패시브",
    "description": "『플래시 오버』 상태인 적에게 대미지를 줄 때 공격력이 42.0% 증가한다.",
    "cool": 0
  }
};
