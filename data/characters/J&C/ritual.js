...
window.cnCharacterRitualData["J&C"] = {
  "name": "芮丝汀娜&卡萝莉娜",
  "r0": "双子看守",
  "r0_detail": "获得芮丝汀娜&卡萝莉娜后，WONDER的人格面具技能和战斗技巧等级提升1级。（无论芮丝汀娜&卡萝莉娜是否在场）\n芮丝汀娜&卡萝莉娜拥有4组特殊的人格面具，战斗开始前可以选择两组人格面具作为自身的一技能和二技能进入战斗。\n芮丝汀娜&卡萝莉娜在携带不同的人格面具组合时，在战斗中可以获得对应的职业加成效果。\n顽皮与天真的面具+奉献与警示的面具：救援\n顽皮与天真的面具+荒谬与悖理的面具：优越\n顽皮与天真的面具+福果与祸因的面具：支配\n奉献与警示的面具+荒谬与悖理的面具：防护\n奉献与警示的面具+福果与祸因的面具：屈从\n荒谬与悖理的面具+福果与祸因的面具：反抗\n芮丝汀娜&卡萝莉娜的技能效果受自身『面具强度』影响，战斗开始时获得25点『面具强度』。",
  "r1": "狭隘的宽容",
  "r1_detail": "战斗开始时，获得当前携带的人格面具所对应的两种『相貌』。\n自身回合开始或结束时，若拥有两种『相貌』，自动对随机目标释放1次『二元合一的面具』，优先选择上一次技能攻击的目标。",
  "r2": "冷酷的温情",
  "r2_detail": "自身获得『相貌』时，触发对应的强化效果。\n『稚气』：使所有同伴攻击力提升30%，持续2回合。\n『教诲』：使所有同伴受到伤害降低20%，持续2回合。\n『无序』：使自身和攻击力最高的其他同伴（优先选择支配/反抗同伴）暴击效果提升20%，持续2回合。\n『因果』：使自身人格面具技能的技能伤害提升10%，持续2回合。",
  "r3": "惩罚性宽恕",
  "r3_detail": "携带的一技能、『二元合一的面具』技能等级提升3级，至多提升至15级。",
  "r4": "渴望更生的处刑",
  "r4_detail": "自身释放HIGHLIGHT后，使自身攻击力提升40%、伤害提升20%，所有同伴获得50%增益，持续2回合。",
  "r5": "慈悲深沉的监牢",
  "r5_detail": "携带的二技能、『战斗技巧』技能等级提升3级，至多提升至15级。",
  "r6": "抵抗毁灭的力量",
