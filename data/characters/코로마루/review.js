...
`,
    review_cn: `P3的原创角色，是一名**能够强化火焰、电击、冰冻属性弱点**的减益手。

他沿用了和双叶相同的机制，可以把敌人的属性适应性从**耐性（0.5倍）变成普通（1.0倍），普通变成弱点（1.2倍），弱点进一步强化为弱点强化（1.45倍）**。

只要敌人没有死亡并换新目标上场，这个弱点强化效果就几乎可以**在循环中长期覆盖**。同时他在第1回合能削减2点DOWN值，第2回合能削减4点DOWN值，因此基本能做到每2回合稳定打倒地。

<br>

他还拥有一套很特殊的机制。选定1名『饲主』之后，就会跟随该『饲主』的回合一起行动，不再拥有独立回合。

虎狼丸在选定『饲主』后，虽然不再有自己的独立出手机会，但仍会在『饲主』回合开始与结束时，照常触发自身的回合开始/结束效果。
『饲主』是S.E.E.S.成员时：『饲主』可以通过援助技能指挥虎狼丸使用人格面具技能，之后仍能继续按原本规则使用其他援助技能。
『饲主』是非S.E.E.S.成员时：在『饲主』回合开始时，虎狼丸会根据『饲主』的属性自动释放对应的人格面具技能。

他的3个技能除了分别强化火焰、电击、冰冻伤害之外没有本质区别，因此实战里通常就是根据队友属性，重复使用对应的那一个技能。

<br>

他还有一个会随效果命中提高而提升全队攻击力的被动，而且没有上限，因此**效果命中尽量堆高会更好**。

若以风花的『后备角色』身份参战，这个被动以及所有标注为“战斗中”生效的启示套装效果都不会启动，因此实际上需要准备至少两套以上的启示搭配。
因此在风花后备位用法下，更建议优先准备能够稳定补足效果命中的启示组合，并根据队伍需求灵活切换。`,
    pros: [
