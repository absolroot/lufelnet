...
또한 적의 수가 적을수록 대미지가 증가한다.

『협력 대미지』

발동자를 제외한 팀 내 동료들의 최고 공격력, 최고 대미지 보너스, 최고 크리티컬 확률, 최고 크리티컬 효과를 기준으로 계산된다.
...
Damage also increases as the number of foes decreases.

[Co-op Damage]

Calculated using the highest Attack, highest damage bonus, highest critical rate, and highest critical damage among allies other than the user.
...
また、敵の数が少ないほどダメージが上昇する。

『協力ダメージ』

発動者を除くチーム内の味方の最高攻撃力、最高与ダメージボーナス、最高CRT発生率、最高CRT倍率を基準に計算される。
...
以团队中除发动者外其他同伴的最高攻击力、最高伤害加成、最高暴击率和最高暴击效果为基准进行计算。

『幻影形态』

免疫精神异常、控制效果和倒地值伤害。
但当只有雨宫莲·星舞处于可行动状态时，『幻影形态』会被解除。`,
        pros: [],
        pros_en: [],
        pros_jp: [],
        pros_cn: [],
