const characterSkillsData = {
    ...
    "유키 마코토": {
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "1명의 적에게 여러 회의 화염 속성 대미지를 입히고 일정 턴 동안 자신은 『월상』 2중첩을 획득한다(상한 있음). 『홍련 맹화의 탐식』을 사용해서 『월상』을 소모하여 대미지를 입힐 경우 일정 턴 동안 스킬 배율이 증가한다."
        },
        "skill2": {
            "name": "월하의 전투곡",
            "element": "버프광역",
            ...
            "sp": 20,
            "cool": 0,
            "description": "일정 턴 동안 모든 동료의 크리티컬 효과가 증가하고, 자신의 공격력이 증가한다. 자신이 『월상』 2중첩을 획득하며 일정 턴 동안 지속된다 (최대 4중첩)."
        },
        "skill3": {
            "name": "홍련·맹화의 탐식",
            "element": "화염",
            ...
            "sp": 24,
            "cool": 0,
            "description": "발동 조건: 자신이 최소 『월상』 2중첩 보유\n\n자신의 모든 『월상』을 소모하고, 『월상』 1중첩 소모할 때마다 1명의 적에게 화염 속성 대미지를 준다. 이후 자신의 모든 『특수 월상』을 소모하며, 『특수 월상』 1중첩 소모할 때마다 1명의 적에게 추가 화염 속성 대미지를 준다. 『월상』이 4중첩 이상일 시 스킬 관통 및 대미지가 추가로 증가한다."
        },
        "skill_highlight": {
            "name": "테우르기아 - 아르다",
            "element": "화염",
            "type": "",
            "description": "사용 조건: 테우르기아 에너지 100 포인트 1명의 적에게 여러 회의 화염 속성 대미지를 입힌다.\n자신은 일정 턴 동안 『특수 월상』 1중첩을 획득한다(상한 있음)."
        },
        "skill_highlight2": {
            "name": "테우르기아 - 카덴차",
            "element": "버프",
            "type": "버프",
            "description": "사용 조건: 테우르기아 에너지 100 포인트\n모든 동료가 일정 턴 동안 공격력 및 대미지가 증가한다. 자신은 일정 턴 동안 『특수 월상』 1중첩을 획득한다(상한 있음)."
        },
        "skill_support": {
            "name": "지원 기술",
            "element": "패시브",
            "type": "버프",
            "description": "1턴 동안 동료의 공격력이 상승한다."
        },
        "passive1": {
            "name": "리드",
            "element": "패시브",
            "description": "테우르기아 사용 후, 모든 동료의 공격력이 2턴 동안 40% 증가하며,S.E.E.S 동료의 공격력은 20% 추가 증가한다."
        },
        "passive2": {
            "name": "신뢰",
            "element": "패시브",
            "description": "동료의 버프/치료/실드 스킬 효과를 받을 시 2턴 동안 크리티컬 효과가 7.2% 증가한다(최대 3중첩)."
        }
    },
