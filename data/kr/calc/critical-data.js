...
const criticalBuffData = {
  ...
  const criticalSelfData = {
    ...
    "나루미": [
      { id: "narumi1", type: "스킬1", target: "자신", target_en: "Self", target_jp: "自分", skillIcon: "/assets/img/character-detail/ritual0.png", skillName: "당도 100%❤", skillName_en: "S1", skillName_jp: "スキル1", options: ["LV10", "LV10+심상5", "LV13", "LV13+심상5"], values: {"LV10": 14.6, "LV10+심상5": 16.1, "LV13": 15.5, "LV13+심상5": 17.1}, defaultOption:"LV13+심상5", value: 17.1, duration: "2턴", note: "", note_en: "", note_jp: "" },
