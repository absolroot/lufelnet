...
window.cnCharacterSkillsData["키라"] = {
  "name": "北里基良",
  "skill1": {
    "name": "切割技法/罪恶游戏",
    "element": "물리",
    "sp": 21,
    "cool": 0,
    "description": "『寻猎者』状态：对1名敌人造成4次47.3%/52.2%/50.2%/55.1%攻击力的物理属性伤害，并为其添加1层『流血』。\n『行刑官』状态：对1名敌人造成251.7%/277.5%/267.2%/292.9%攻击力的物理属性伤害，技能结束后清除其2层『流血』。（可触发『撕裂』效果）"
  },
  "skill2": {
    "name": "致命快感/谢幕致礼",
    "element": "물리",
    "sp": 21,
    "cool": 0,
    "description": "『寻猎者』状态：对1名敌人造成2次84.2%/92.9%/89.4%/98.0%攻击力的物理属性伤害，立即结算一次『流血』伤害并刷新其『流血』状态的持续时间。\n『行刑官』状态：对1名敌人造成251.7%/277.5%/267.2%/292.9%攻击力的物理属性伤害，目标每有1层『流血』，使该技能伤害及其触发的『撕裂』伤害提升2%，技能结束后清除其所有『流血』状态。（可触发『撕裂』效果）"
  },
  "skill3": {
    "name": "夜幕已至",
    "sp": 15,
    "cool": 0,
    "description": "任意敌人的『流血』层数≥7时该技能解锁。\n转变至『行刑官』状态，改变技能模式，并获得效果：使用技能时，目标每有3层『流血』，北里基良额外对其造成1次『撕裂』：66.7%/73.5%/70.8%/77.6%攻击力的物理属性伤害。\n使用该技能后本回合仍可使用其他技能，回合结束时自动转变至『寻猎者』状态。",
    "element": "버프"
  },
  "passive1": {
    "name": "感染",
    "element": "패시브",
    "cool": 0,
    "description": "北里基良每30%的效果命中，使『流血』的物理属性伤害提升相当于北里基良攻击力的4%，最多计入90%的效果命中。"
  },
  "passive2": {
    "name": "溃烂",
    "element": "패시브",
    "cool": 0,
    "description": "处于『寻猎者』状态时，效果命中提升36%；\n处于『行刑官』状态时，穿透提升21%。"
  },
  "skill_highlight": {
    "element": "물리",
    "cool": 4,
    "description": "转变至『寻猎者』状态，立刻为1名敌人添加5层『流血』；随即转变至『行刑官』状态，对其造成492.8%/543.3%/523.1%/573.6%攻击力的物理属性伤害。（可触发『撕裂』效果）"
  }
};
