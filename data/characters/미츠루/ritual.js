...
window.ritualData["미츠루"] = {
  "name": "키리조 미츠루",
  "r0": "부장의 직책",
  "r0_detail": "키리조 미츠루가 페르소나 스킬 또는 테우르기아를 시전해 대미지를 줄 때 목표에게 『서리 결정』을 1중첩 추가한다. 『서리 결정』은 2턴 지속되며, 최대 5회 중첩된다. 키리조 미츠루가 『서리 결정』을 보유한 목표를 공격하면 7%*『서리 결정』 중첩 수에 해당하는 공격력이 증가한다. 『서리 결정』이 『혹한 결정』으로 강화 시, 아군 유닛이 페르소나 스킬로 해당 상태의 적을 공격하면 키리조 미츠루의 『냉혈의 칼날』이 발동된다.",
  "r1": "Brilliant！",
  "r1_detail": "전투 진입 시 적 전체에 중첩 상한을 돌파하는 『혹한 결정』을 2중첩 추가한다(최대 2중첩, 해당 전투 동안 영구적으로 지속). 『혹한 결정』 상태인 적이 받는 크리티컬 확률이 10% 증가한다.",
  "r2": "검무의 얼음여왕",
  "r2_detail": "『여왕의 응시』 상태인 적이 받는 크리티컬 효과가 40% 증가한다. 『여왕의 응시』 전이 시, 모든 상태 이상도 동시에 전이된다.",
  "r3": "처형한다!",
  "r3_detail": "『혹한의 폭풍』, 『전투 기술』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r4": "거짓말의 이면",
  "r4_detail": "테우르기아로 주는 스킬 대미지가 20% 증가하고, 2턴 동안 테우르기아로 대상이 받는 대미지가 추가로 20% 증가한다.",
  "r5": "엉뚱한 면모",
  "r5_detail": "『찬란한 얼음꽃』, 『프로스트 피어스』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r6": "불타오르는 투지",
...
window.cnCharacterRitualData["미츠루"] = {
  "name": "桐条美鹤",
  "r0": "部长的职责",
  "r0_detail": "桐条美鹤释放人格面具技能或神通法造成伤害时，为目标添加1层『霜结』。『霜结』持续2回合，最多可叠加5层，桐条美鹤攻击拥有『霜结』的目标时可获得7%*『霜结』层数的攻击力提升。『霜结』被强化为『寒霜结』后，友方单位可通过人格面具技能攻击此状态下的敌人触发桐条美鹤的『冷血之刃』。",
  "r1": "Brilliant！",
  "r1_detail": "进入战斗时，为所有敌人添加2层可突破叠加上限的『寒霜结』，上限2层，本场战斗永久生效。处于『寒霜结』状态下的敌人受到暴击率提升10%。",
  "r2": "剑舞的冰之女王",
  "r2_detail": "处于『女王凝视』状态下的敌人受到暴击效果提升40%。『女王凝视』转移时，会同时转移所有异常状态。",
  "r3": "处刑！",
  "r3_detail": "『极寒风暴』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r4": "谎言的背面",
  "r4_detail": "神通法造成的技能伤害提升20%，神通法额外使目标受到伤害提升20%，持续2回合。",
  "r5": "不谙世事的一面",
  "r5_detail": "『绚烂冰华』、『冰之舞刺击』的技能等级提升3级，至多提升至15级。",
  "r6": "斗志熊熊燃烧",
