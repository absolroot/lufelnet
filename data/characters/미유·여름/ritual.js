...
window.ritualData["미유·여름"] = {
  "name": "사하라 미유·여름",
  "r0": "파도의 부름",
  "r0_detail": "사하라 미유·여름은 전투 중 서핑보드에 타고 『바다의 영역』을 전개하고, SP를 소모해 적에게 끝없는 파도 공격을 가할 수 있다. 사하라 미유·여름의 SP 한도가 200포인트로 증가하며, 전투 시작 시 초기 SP는 0포인트이다. 자신 이외의 동료의 턴 시작 시 사하라 미유·여름이 SP 15포인트를 회복한다(해당 효과는 SP 회복 속성의 영향 받음).\n전투 중 누적 회복 SP에 따라(한도 초과 부분도 포함) 사하라 미유·여름이 다음 보너스를 획득한다.\n100포인트 도달: 공격력 25% 증가\n200포인트 도달: 주는 대미지 25% 증가\n300포인트 도달: 크리티컬 확률 12% 증가\n400포인트 도달: 크리티컬 효과 24% 증가",
  "r1": "심해에서 온 소녀",
...
window.cnCharacterRitualData["미유·여름"] = {
  "name": "佐原海夕·夏日",
  "r0": "潮声的召唤",
  "r0_detail": "佐原海夕·夏日在战斗中可以踏上冲浪板，展开『海之领域』，消耗精力值对敌人发起源源不绝的海浪攻势。佐原海夕·夏日的精力值上限提升至200点，战斗开始时初始精力值为0点。除自身以外的同伴回合开始时，佐原海夕·夏日恢复15点精力值（该效果受精力回复属性影响）。\n根据战斗中累计恢复的精力值（超出上限部分也计入），佐原海夕·夏日获得如下加成：\n达到100点：攻击力提升10%；\n达到200点：造成伤害提升10%；\n达到300点：暴击率提升12%；\n达到400点：暴击效果提升24%。",
  "r1": "来自深海的少女",
  "r1_detail": "『潮涌云倾』消耗精力值降低40%，『千叠浪』的可叠加上限提升2层。\n展开『海之领域』时，立刻使自身的所有状态持续时间延长1回合。",
  "r2": "在夕阳下仰望",
  "r2_detail": "处于『海之领域』中，佐原海夕·夏日的暴击效果提升20%。\n每释放4次『潮涌云倾』，佐原海夕·夏日额外释放1次特殊的『潮涌云倾』，释放该『潮涌云倾』不消耗精力值且自身不获得『千叠浪』。",
  "r3": "为了靠近那束光",
  "r3_detail": "『踏光跃上晴波』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r4": "静默的守候",
  "r4_detail": "HIGHLIGHT效果提升：额外使自身追加效果伤害提升30%，效果持续2回合。",
  "r5": "归于潮汐之中",
  "r5_detail": "『海月沉梦』、『蔚蓝协奏』的技能等级提升3级，至多提升至15级。",
  "r6": "那片蔚蓝的梦",
