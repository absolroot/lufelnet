...
window.characterSkillsData["후타바"] = {
  ...
  "skill2": {
    ...
    "type": "디버프",
    "cool": 4,
    "description": "1명의 적이 받는 대미지가 6%+(사쿠라 후타바의 공격력 100포인트마다 목표가 받는 대미지 0.38% 추가 증가, 최대 4600/5060/5980/6440포인트 공격력 계산) 증가하며 3턴 동안 지속된다. 기간 동안 아군 동료가 페르소나 스킬/추가 효과/HIGHLIGHT를 발동해 목표에게 대미지를 주면, 사쿠라 후타바가 분석 진도를 15% 획득한다. 자신의 분석 진도가 100%에 도달하면 아군 전체에게 『해킹 완료』 상태를 추가하며 2턴 동안 지속된다."
  },
  "skill3": {
    "name": "불사조의 이름으로",
    "element": "버프",
