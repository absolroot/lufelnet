...
const I18N = {
    kr: {
        ...
        timezone: '시간대',
        tooltipTimezone: '날짜 표기/계산에 사용할 시간대를 선택합니다. 기본값은 로컬 시간대입니다.',
    ...
    en: {
        ...
        timezone: 'Timezone',
        tooltipTimezone: 'Select the timezone used for date display/calculation. Default is your local timezone.',
    ...
    jp: {
        ...
        timezone: 'タイムゾーン',
        tooltipTimezone: '日付の表示/計算に使用するタイムゾーンを選択します。デフォルトはローカルです。',
