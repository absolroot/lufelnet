const characterSkillsData = {
    ...
    "후카": {
        ...
        "skill1": {
            ...
            "sp": 0,
            "cool": 4,
            "description": "모든 아군의 공격력이 10.0%/11.0%/11.2%/12.2% 증가하고, 야마기시 후카의 공격력 100포인트마다 1.143% 추가 증가(최대 40.0%/44.0%/44.8%/48.8%). 피해량이 8.0%/8.8%/9.0%/9.8% 증가하고, 공격력 100포인트마다 0.914% 추가 증가(최대 32.0%/35.2%/35.8%/39.0%). 효과는 2턴 동안 지속되며, 자신은 『소원의 경청』 1중첩을 획득한다."
            },
        "skill2": {
            "name": "성스러운 기도",
            "element": "버프광역",
            ...
            "sp": 0,
            "cool": 16,
            "description": "초기 준비 시간: 16회 행동\n모든 아군의 공격력이 6.0%/6.6%/6.7%/7.3% 증가하고, 야마기시 후카의 공격력 100포인트마다 0.686% 추가 증가(최대 24.0%/26.4%/26.9%/29.3%). 효과는 3턴 동안 지속된다.\n스킬 대상이 S.E.E.S. 멤버일 경우, 해당 대상의 테우르기아 에너지를 35포인트 회복시키고, 테우르기아 피해량이 동일한 수치만큼 증가한다.\n스킬 대상이 비-S.E.E.S. 멤버일 경우, 해당 대상의 HIGHLIGHT 게이지를 35포인트 회복시키고, HIGHLIGHT 피해량이 동일한 수치만큼 증가한다.\n이 스킬의 준비 시간은 독립적으로 계산되며, 다른 해명 스킬의 준비 시간에 영향을 주지 않는다."
        },
        "skill3": {
            "name": "마음의 파동",
            "element": "버프광역",
            ...
            "sp": 0,
            "cool": 4,
            "description": "모든 아군의 크리티컬 효과가 10.0%/11.0%/11.2%/12.2% 증가하고, 야마기시 후카의 크리티컬 효과 1%마다 0.625% 추가 증가(최대 40.0%/44.0%/44.8%/48.8%). 효과는 2턴 동안 지속되며, 자신은 『소원의 경청』 1중첩을 획득한다.\n스킬 사용 시 다음 조건 중 하나를 만족하는 아군이 있을 경우, 우선순위에 따라 아래 효과 중 하나를 발동한다. 조건이 없을 경우 무작위로 발동된다.\n1. 정신 이상 상태의 아군이 있을 경우: 해당 아군의 상태이상 1개 해제\n2. HP가 25% 미만인 아군이 있을 경우: HP 비율이 가장 낮은 아군의 HP를 15% 회복\n3. SP가 30 미만인 아군이 있을 경우: SP가 가장 낮은 아군의 SP를 30 회복"
        },
        "skill_highlight": {
            "name": "속성 증가",
            "element": "패시브",
        ...
        "passive1": {
            "name": "자비",
            "element": "패시브",
            "description": "아군이 테우르기아 또는 HIGHLIGHT를 사용하면, 모든 아군의 크리티컬 효과가 24.0% 증가한다. 효과는 2턴 동안 지속된다."
        },
        "passive2": {
            "name": "깊은 정",
            "element": "패시브",
            "description": "전투 시작 시, 야마기시 후카가 지정한 『후보 캐릭터』의 각 능력치의 4.5%를 현재 전장에 있는 모든 아군의 능력치에 반영한다."
        }
    },

    "미츠루": {
        "name": "키리조 미츠루",
        "skill1": {"name":"찬란한 얼음꽃","element":"빙결","type":"단일피해","sp":20,"cool":0,"description":"1명의 적에게 공격력 211.2%/232.8%/224.2%/245.8%의 빙결 속성 대미지를 주고, 추가로 『서리 결정』을 3중첩 추가한다. 동시에 2턴 동안 해당 적의 방어력을 감소시킨다(키리조 미츠루의 공격력 300포인트마다 방어력 1.2%*『서리 결정』 중첩 수만큼 감소하며, 최대 2928/3228/3108/3408포인트 공격력까지 계산)."},
        "skill2": {"name":"혹한의 폭풍","element":"디버프","type":"버프","sp":0,"cool":0,"description":"1명의 적을 『여왕의 응시』 상태에 빠뜨리며, 방어력이 7.8%/8.6%/8.3%/9.1% 감소하고(키리조 미츠루의 공격력 300포인트마다 방어력이 추가로 3.2% 감소하며, 최대 2928/3228/3108/3408포인트 공격력까지 계산), 받는 대미지가 증가하며(키리조 미츠루의 공격력 300포인트마다 받는 대미지가 2% 증가하며, 최대 2928/3228/3108/3408포인트 공격력까지 계산), 해당 전투 동안 영구적으로 지속된다. 『여왕의 응시』는 필드에 단 하나만 존재하며, 새로운 목표를 선택하여 시전하면 『여왕의 응시』가 새로운 목표로 전이된다. 『여왕의 응시』 상태인 적이 사망하면 『여왕의 응시』가 자동으로 현재 필드에서 생명이 가장 높은 적에게로 전이된다. 『여왕의 응시』 전이 시, 키리조 미츠루가 추가한 모든 상태 이상도 동시에 전이된다. 이 스킬 사용 후 해당 턴에서 다른 스킬을 사용할 수 있으며, 해당 스킬은 페르소나 스킬로 간주하지 않는다."},
        "skill3": {"name":"프로스트 피어스","element":"빙결","type":"단일피해","sp":24,"cool":0,"description":"해명 괴도 각 속성의 3%만큼 출전 중인 아군 전체의 상응하는 속성 수치가 증가하며 2턴 동안 지속된다. 이후 적 1명에게 공격력의 345.1%/380.5%/366.3%/401.7%에 해당하는 빙결 속성 대미지를 주며, 목표가 보유한 『서리 결정』 1중첩마다 스킬 대미지가 10% 증가하고, 목표의 『서리 결정』이 5중첩에 도달하면 스킬의 크리티컬 확률이 15% 추가로 증가한다."},
        "skill_highlight": {"name":"블리자드 에지","element":"빙결","cool":0,"description":"시전 조건: 테우르기아 에너지 70포인트\n1명의 적에게 공격력 371.2%/408.3%/415.7%/452.9%의 빙결 속성 대미지를 주고, 2턴 내에 목표의 『서리 결정』을 『혹한 결정』으로 강화한다. 아군이 페르소나 스킬로 『혹한 결정』 상태의 적 공격 시, 키리조 미츠루의 『냉혈의 칼날』이 발동되어 목표에게 공격력 20.0%/22.0%/22.4%/24.4%*『서리 결정』 중첩 수에 해당하는 추가 대미지를 1회 준다."},
        "skill_support": {"name":"지원 스킬","element":"버프","cool":0,"description":"1명의 적에게 2턴 동안 지속되는 『에너지 표식』을 추가한다. S.E.E.S. 멤버가 해당 적을 처음 공격할 때 자신의 테우르기아 에너지를 35포인트 회복한다. S.E.E.S.가 아닌 멤버는 해당 적을 처음 공격할 때 HIGHLIGHT 에너지를 15%를 회복한다."},
        "passive1": {"name":"책임","element":"패시브","cool":0,"description":"해명 괴도의 초기 준비 시간이 4회 행동만큼 감소한다."},
        "passive2": {"name":"질서","element":"패시브","cool":0,"description":"키리조 미츠루가 필드에 있으면 모든 반항 또는 지배 캐릭터가 『서리 결정』을 보유한 적 공격 시 『서리 결정』 중첩 수*4.8%의 대미지 증가를 획득한다."}
    ...
    "토모코·여름": {
        ...
        "skill2": {
            ...
            "sp": 27,
            "cool": 0,
            "description": "동료 1명이 공격력 22.4%/22.4%/23.8%/23.8%+1438/1749/1767/2078의 생명을 회복하고, 공격력이 14.6%/14.6%/15.5%/15.5% 증가하며, 효과 명중이 58.6%/58.6%/62.2%/62.2% 증가하고, 대미지가 30% 증가한다. 해당 동료가 적에게 스킬 대미지를 줄 때마다 『불꽃』 1중첩을 추가하며 2턴 동안 지속된다. 기간 동안 『불꽃』 효과를 최대 5회 추가할 수 있다."
        },
        "skill3": {
            "name": "한밤의 두근거림",
            "element": "염동광역",
