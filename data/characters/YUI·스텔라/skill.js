...
window.characterSkillsData["YUI·스텔라"] = {
  ...
  "skill2": {
    ...
    "sp": 0,
    "cool": 1,
    "description": "2턴 동안 자신의 공격력이 19.5%/21.5%/20.7%/22.7% 증가하고, 크리티컬 확률이 11.7%/12.9%/12.4%/13.6% 증가한다. 또한 특정 순서에 따라 베지나이츠를 1개 소환한다. 해당 스킬 사용 후 다른 스킬을 사용할 수 있고, 해당 스킬은 페르소나 스킬로 간주하지 않는다.\n패시브: 자신의 턴 시작 시, 특정 순서에 따라 자동으로 베지나이츠를 1개 소환한다.\n가지 나이트, 버섯 나이트, 아스파라거스 나이트는 최대 1개, 감자 나이트는 최대 4개까지 보유할 수 있다."
  },
  "skill3": {
    "name": "베지나이츠·총동원 ",
    "element": "핵열",
