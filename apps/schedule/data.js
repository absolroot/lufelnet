...
window.ReleaseScheduleData = {
    ...
    manualReleases: [
        ...
        { version: "1.0", date: "2025-06-25", characters: ["렌"], "main-story": "1&2", persona: ["킹 프로스트", "비사문천", "멜키세덱"] },
        ...
        { version: "2.3", date: "2025-10-23", characters: ["키라"], "main-story": "3-2", persona: ["쿠 훌린"] },
        { version: "2.4", date: "2025-11-06", characters: ["후타바"] },
        { version: "2.5", date: "2025-11-25", characters: ["마사키"], persona: ["비슈누", "시바", "산달폰"] },
        { version: "2.6", date: "2025-12-06", characters: ["하루"] },
        { version: "2.7", date: "2025-12-25", characters: ["J&C"], note: "Worldwide Simultaneous Release", goldTicketUnlocks: ["MARIAN"] },
        // ===== 2026년 =====
        { version: "3.0", date: "2026-01-08", characters: ["몽타뉴·백조"], "main-story": "4-1", persona: ["사악한 프로스트"] },
    ],
    ...
    autoGenerateCharacters: [
        ...
        { version: "4.1.1", characters: ["유키 마코토"], persona: ["자오우곤겐"]},
        { version: "4.1.2", characters: ["유카리"] },
        { version: "4.1.3", characters: ["사나다"] },
        { version: "4.2", characters: ["이치고"], "main-story": "5-2", persona: ["트럼페터", "바스키"] },
        { version: "4.3.1", characters: ["미나미·여름"], "summer": true },
        { version: "4.3.2", characters: ["미유·여름"], "summer": true, persona: ["사히모치노카미"] },
        ...
        { version: "4.7.1", characters: ["쇼키·암야"], "main-story": "5-4", persona: ["마카브르"], note: "MINDSCAPE CORE - MARIAN / YUI / PHOEBE" },
