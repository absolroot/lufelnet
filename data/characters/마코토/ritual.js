...
window.cnCharacterRitualData["마코토"] = {
  "name": "新岛真",
  "r0": "合气·修身",
  "r0_detail": "释放人格面具技能攻击敌人后，获得1层『坚韧』效果。不处于『铁血意志』状态下回合结束时敌人每拥有一种元素异常，额外获得1层『坚韧』效果（该回合若击败敌人，且敌人拥有元素异常也计入总数）。回合开始，若自身拥有5层坚韧效果，可以变身进入『铁血意志』状态，获得40%攻击力、20%防御力提升，并且『核热爆伤』进化为『超载聚变』，持续2回合。『铁血意志』状态结束时清除全部『坚韧』效果。",
  "r1": "受身·御伤",
  "r1_detail": "战斗开始时获得5层『坚韧』效果，自己第一回合开始时可以变身进入『铁血意志』状态。『铁血意志』状态期间攻击力额外提升50%、伤害提升35%。",
  "r2": "投技·束敌",
  "r2_detail": "『脉冲连击』、『核热爆伤』的技能等级提升3级，至多提升至15级。",
  "r3": "后发·先制",
  "r3_detail": "进入『铁血意志』状态时立刻为1个敌人添加1个随机元素异常效果，『铁血意志』状态下场上每拥有一种元素异常效果，自身增加6%穿透。",
  "r4": "礼行·顺守",
  "r4_detail": "『核能共振』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r5": "化柔·破力",
  "r5_detail": "HIGHLIGHT效果提升：获得热质升至4层。消耗热质，最多为敌人添加4个元素异常并且最多提升4次技能伤害。",
  "r6": "呼吸·调和",
