const characterSkillsData = {
    ...
    "YUI·스텔라": {
        ...
        "skill1": {
            ...
            "sp": 22,
            "cool": 0,
            "description": "적 1명에게 공격력의 100.7%/111.0%/106.9%/117.2%의 핵열 속성 피해를 주고, 자신에게 『원동력』 3점을 부여하며 2턴 동안 『대난투』 상태에 진입한다.\n\n『대난투』: 자신의 턴 종료 시 추가 효과 『야채 기사·출격』을 발동하여, 모든 야채 기사가 무작위 적 1명에게 공격력의 93.5%/103.1%/99.2%/108.8%의 핵열 속성 피해를 준다.\n현재 색상 상태에 따라 다음 효과 중 하나를 추가로 발동한다:\n- 『<span style='color:rgb(184, 33, 214);'>가지의 보라</span>』: 『원동력』 1점을 추가로 획득한다\n- 『<span style='color:#C7BE5A;'>감자의 노랑</span>』: 『덩이줄기 파워』를 얻어 3턴 동안 총공격 대미지가 14.6%/16.1%/15.5%/17.0% 증가한다.\n- 『<span style='color:rgb(254, 100, 238);'>버섯의 분홍</span>』: 대상에게 『버섯 포자』를 부여하고 2턴 동안 받는 피해가 19.5%/21.5%/20.7%/22.7% 증가한다.\n- 『<span style='color:rgb(11, 190, 11);'>아스파라거스의 초록</span>』: 체력이 가장 낮은 아군 1명을 976/1076/1036/1136 회복한다.\n\n해당 스킬 사용 후, 감자 기사를 보유하고 있다면 턴 종료 시 자동으로 『<span style='color:#C7BE5A;'>감자의 노랑</span>』 상태로 전환된다."
        },
        "skill2": {
            "name": "야채 기사·집합",
            "element": "버프",
            ...
            "sp": 0,
            "cool": 1,
            "description": "자신의 공격력을 19.5%/21.5%/20.7%/22.7%, 크리티컬 확률을 11.7%/12.9%/12.4%/13.6% 증가시키며 2턴 동안 지속된다. 정해진 순서에 따라 야채 기사를 1기 소환한다. 이 스킬 사용 후 다른 스킬을 추가로 사용할 수 있으며, 페르소나 스킬로 간주되지 않는다.\n\n패시브: 턴 시작 시 정해진 순서에 따라 자동으로 야채 기사를 1기 소환한다.\n가지, 버섯, 아스파라거스 기사는 최대 1기 소유 가능, 감자 기사는 최대 4기까지 보유 가능"
        },
        "skill3": {
            "name": "야채 기사·총동원",
            "element": "핵열",
            ...
            "sp": 23,
            "cool": 0,
            "description": "적 1명에게 공격력의 104.3%/115.0%/110.7%/121.4%의 핵열 속성 피해를 주고, 보유 중인 야채 기사 1기당 1회씩 추가로 29.3%/32.3%/31.1%/34.1%의 핵열 피해를 가한다. 감자 기사를 2기 이상 보유 시, 감자 기사를 소모하여 1기당 24.4%/26.9%/25.9%/28.4%의 추가 피해를 가한다. 이 피해는 총공격으로 간주된다. 스킬을 수동으로 사용할 경우 『원동력』을 2점 획득한다.\n\n패시브: 『원동력』이 7점 도달 시, 모든 『원동력』을 소모하여 적 전체에게 『야채 기사·총동원』 피해를 가한다 (피해는 적 전체에게 균등 분배). 이는 페르소나 스킬로 간주되지 않는다.\n\n스킬 사용 후 가지 기사를 보유 중이라면, 턴 종료 시 자동으로 『<span style='color:rgb(184, 33, 214);'>가지의 보라</span>』 상태로 전환된다.\n\n<table border='1' cellspacing='0' cellpadding='5'><thead><tr><th>야채 기사</th><th>1기</th><th>2기</th><th>3기</th><th>4기</th></tr></thead><tbody><tr><td>스킬 계수</td><td>133.6%/147.3%/141.8%/155.5%</td><td>162.9%/179.6%/172.9%/189.6%</td><td>192.2%/211.9%/204.0%/223.7%</td><td>221.5%/244.2%/235.1%/257.8%</td></tr></tbody><thead><tr><th>야채 기사</th><th>5기</th><th>6기</th><th>7기</th><th>8기</th></tr></thead><tbody><tr><td>스킬 계수</td><td>221.5%/244.2%/235.1%/257.8%</td><td>245.9%/271.1%/261.0%/286.2%</td><td>270.3%/298.0%/286.9%/314.6%</td><td>294.7%/324.9%/312.8%/343.0%</td></tr></tbody></table>"
        },
        "skill_highlight": {
            "element": "핵열",
            "type": "단일피해",
            "description": "적 1명에게 공격력의 439.2%/484.2%/466.2%/511.2%의 핵열 속성 피해를 주고, 해당 적에게 즉시 『야채 기사·출격』을 발동한다.\n\n※『야채 기사·출격』: 추가 효과, 모든 야채 기사가 적 1명에게 공격력의 93.5%/103.1%/99.2%/108.8%의 핵열 속성 피해를 준다."
        },
        "passive1": {
            "name": "동반",
            "element": "패시브",
            "description": "야채 기사 1기당 YUI·스텔라의 피해량이 8.1% 증가 (최대 4기까지 적용)."
        },
        "passive2": {
            "name": "찬란",
            "element": "패시브",
            "description": "총공격 피해량이 15% 증가한다. 총공격에 참여 시, 보유한 야채 기사 수에 따라 추가 피해가 적용된다."
        }
    },
    "카타야마":{
        "name": "카타야마 쿠미",
