const tooltip = {
    ...
    //미츠루
    "냉혈의 칼날": "대상에게『서리 결속』 중첩 수 * 공격력의 일정 비율만큼 추가 피해를 줍니다. 이 피해는 공격하는 동료의 모든 전투 특성(공격력, 대미지 보너스, 크리티컬 확률, 크리티컬 효과, 관통)을 완벽하게 복제하며, 동료의 공격 스킬과 속성을 일치하도록 조정됩니다.",
    ...
    "서리 결속": "2턴 동안 지속되며, 최대 5중첩까지 가능하다.",
    "혹한 결속": "2턴 동안 지속되며, 최대 5중첩까지 가능하다. 『서리 결속』과 동일한 효과를 얻는다. 아군이 혹한 결속을 보유 중인 적을 페르소나 스킬로 공격할 때 『냉혈의 칼날』이 발동된다."
}
