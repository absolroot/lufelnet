...
window.personaFiles["트럼페터"] = {
  ...
  "passive_skill": [
    {
      "name": "붕괴의 나팔",
      "name_en": "Trumpet of Destruction",
      "name_jp": "破壊のパフェ",
    ...
    {
      "name": "붕괴의 나팔Ⅰ",
      "name_en": "Trumpet of Destruction I",
      "name_jp": "破壊のパフェⅠ",
    ...
    {
      "name": "붕괴의 나팔Ⅱ",
      "name_en": "Trumpet of Destruction II",
      "name_jp": "破壊のパフェⅡ",
  ...
  "uniqueSkill": {
    ...
    "desc_en": "12.6%/13.3%/13.9% of base chance to put all foes into [Despair] status. [Despair]: Unable to act. SP is deducted every turn and dies after a few turns.",
