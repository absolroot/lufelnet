...
const matchWeapons = {
  "설원의 침묵" :  {
    ...
    name_jp : "氷河永寂",
    where_to_get : "Shop",
    effect : "공격력이 56.0% 증가한다.\n전투 시작 시 아군 1명에게 [혹한의 각인]을 부여한다. 원더가 동료를 목표로 페르소나 스킬을 사용할 경우, 추가로 목표에게 [혹한의 각인]을 부여한다(필드에 1명만 보유 가능). 필드에 [혹한의 각인]을 보유한 아군이 존재할 경우, 원더의 주는 대미지가 35.0% 증가한다.\n[혹한의 각인]: 3턴 동안 주는 대미지가 16.0% 증가하고, 빙결 속성 대미지가 추가로 22.0% 증가한다.",
