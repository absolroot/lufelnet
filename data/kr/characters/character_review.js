...
의식6 반항 괴도 기준 약 1턴에 400~500%의 스킬 계수 대미지를 부여하므로 450%를 기준 삼을 경우 24.4%/34.2%/86.8%의 최종 대미지 증가 효율을 얻는다. 

다만 공격 주체가 미츠루이고 동료의 스탯만 복사하기 때문에 해당 동료의 스킬에 붙은 부가 효과 대미지나 동료가 보유한 독립 버킷 버프는 적용되지 않는다.(미확인)
