const enCharacterRitualData = {
    ...
    "사나다": {
        ...
        "r3": "Self-Restraint",
        "r3_detail": "The skill levels of 『Thunder Crash』 and 『Spark Fist』 increase by 3, up to a maximum of 15.",
        "r4": "Training Results",
    ...
    "유카리": {
        ...
        "r3": "Pink-Hued Maiden",
        "r3_detail": "The skill levels of 『Wind Storm』 and 『Revive Arrow』 increase by 3, up to a maximum of 15.",
        "r4": "Ultimate Healing",
        ...
        "r5": "Pursuit of Truth",
        "r5_detail": "The skill levels of 『Wind Chaser』 and 『Combat Technique』 increase by 3, up to a maximum of 15.",
    ...
    "유키 마코토": {
        ...
        "r3_detail": "The skill levels of 『Crimson Lotus・Devouring Blaze』 and 『Combat Technique』 increase by 3, up to a maximum of 15.",
        "r4": "Thorny Path",
        ...
        "r5_detail": "The skill levels of 『Flame of Melody』 and 『Moonlit Battle Anthem』 increase by 3, up to a maximum of 15.",
        "r6": "Oath of Vows",
    ...
    "이케나미": {
        ...
        "r3_detail": "The skill levels of 『Radiant Monologue』 and 『Unfamiliar Space』 increase by 2, up to a maximum of 15.",
        ...
        "r5_detail": "The skill levels of 『Performance of the Stars』 and 『Combat Technique』 increase by 2, up to a maximum of 15.",
    ...
    "마나카": {
        ...
        "r3_detail": "The skill levels of 『Song of Healing Light』 and 『Reincarnation of Time and Space』 increase by 3, up to a maximum of 15.",
        "r4": "Calm Waves",
        ...
        "r5_detail": "The skill level of 『Song of the Sky』 increases by 3, up to a maximum of 15.",
    ...
    "마유미": {
        ...
        "r3_detail": "The skill levels of 『Engine Roar』 and 『Combat Techniques』 increase by 3, up to a maximum of 15.",
        "r4": "Ignoring Danger",
        ...
        "r5_detail": "The skill levels of 『Vortex Suppression』 and 『Overload Acceleration』 increase by 3, up to a maximum of 15.",
        "r6": "Desire for Speed",
    ...
    "아케치" : {
        ...
        "r3": "Shadow Pursuit",
        "r3_detail": "The skill levels of 『Golden Arrow Rain · Ruin』 and 『Combat Techniques』 increase by 3, up to a maximum of 15.",
        ...
        "r5_detail": "The skill levels of 『Pledge of Justice』 and 『Tilted Hunting Ground』 increase by 3, up to a maximum of 15.",
        "r6": "Conclusion",
    ...
    "미오": {
        ...
        "r3_detail": "The skill levels of 『Flow Burst』 and 『Combat Technique』 increase by 3, up to a maximum of 15.",
        ...
        "r5_detail": "The skill levels of 『Echo of the Waves』 and 『Binding of the Waves』 increase by 3, up to a maximum of 15.",
    ...
    "루우나": {
        ...
        "r3_detail": "The skill levels of 『GOGO Woof!』 and 『Combat Technique』 increase by 3, up to a maximum of 15.",
        "r4": "Unwavering Trust",
    ...
    "리코": {
        "name": "Riko Tanemura",
        "r0": "Firefly",
        "r0_detail": "Every time an ally acts 3 times, the 『Weak Point』 of the enemy with the highest down gauge is exposed.\n『Weak Point』: Damage taken is increased by 6% and it is broken after being attacked once. When broken, Riko gains 2 stacks of 『Intel』. If the target takes Weakness Damage/Normal Damage, its down gauge decreases by an additional 1 point. Each additional 1-point decrease grants Riko 1 more stack of 『Intel』 (up to 8 stacks).",
        "r1": "Shokan (Small Cold)",
        "r1_detail": "At the start of battle, the 『Weak Point』 of the enemy with the highest down gauge is exposed.",
        "r2": "Misetsu (Undisclosed)",
        "r2_detail": "After casting 『Gentle Drizzle』, the 『Weak Point』 of the enemy with the highest down gauge is immediately exposed.",
        "r3": "Seicho (Graceful Blue)",
        "r3_detail": "The skill levels of 『Sunset Shadow Arts』 and 『Plum Blossom Illusion Arts』 increase by 2, up to a maximum of 15.",
        "r4": "Mangetsu (Full Moon)",
        "r4_detail": "After any ally casts HIGHLIGHT/Theurgy, the 『Weak Point』 of the enemy with the highest down gauge is immediately exposed.",
        "r5": "Koyo (Tranquility)",
        "r5_detail": "The skill level of 『Gentle Drizzle』 increases by 2, up to a maximum of 15.",
        "r6": "Usu (Elegant Rain)",
        "r6_detail": "After casting 『Gentle Drizzle』, if Riko Tanemura's Speed is 100 or higher, for every 15 points exceeded, the preparation time of the navigator Phantom Thief is reduced by 1 action, up to a maximum of 4 reductions."
    },
    "리코·매화": {
        ...
        "r1_detail": "The trigger condition for the 『Falling Petals』 state of 『Dancing Plum Blossoms』 changes from 'when taking Wind damage' to 'when taking any elemental damage', and the target's Critical Effect increases by an additional 30%.\n『Plum Beneath the Umbrella』 increases the leader Phantom Thief's Attack by an additional 25%.",
        "r2": "Awakened Night",
        "r2_detail": "Riko Tanemura·Vast's SP cap is further increased by 50 points (the maximum potency of 『Scent of Plum Blossoms』 triggered by SP consumption is also increased *effect max +25%).\nAfter using 『Scent of Plum Blossoms』, she instantly recovers 50 SP.\nPotential 『Full Bloom』 effect enhanced: When 『Bloom』 reaches 5/10 stacks, the increased Critical Effect value is doubled.",
        "r3": "Serene Moonlight",
        "r3_detail": "The skill levels of 『Plum Beneath the Umbrella』 and 『Scent of Plum Blossoms』 increase by 3, up to a maximum of 15.",
        "r4": "Plum Enveloping the Mountains",
        "r4_detail": "HIGHLIGHT Effect Boost: Buff effects now apply to all allies except herself, and the skill main target's Critical Effect increases by an additional 12%. SP recovery for all allies (except herself) increases by up to 32 points.",
        "r5": "Calmness of Heart",
        "r5_detail": "The skill levels of 『Dancing Plum Blossoms』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
        "r6": "Face of Spring",
        "r6_detail": "『Scent of Plum Blossoms』 applies to all allies except herself. After the main skill target uses a Persona skill, she immediately casts 『Dancing Plum Blossoms』 on the enemy target once. This effect can only be triggered once during the duration of 『Scent of Plum Blossoms』. The duration of 『Falling Petals』 from 『Dancing Plum Blossoms』 is extended by 1 turn.\nWhen Riko Tanemura·Vast is on the field, whenever Phantom Thieves deal damage, if their Critical Rate exceeds 100%, every 1% over 100% increases the Critical Effect of that damage by an additional 2%."
    },
    "마사키": {
        "name": "Masaki Ashiya",
        ...
        "r2_detail": "The skill levels of 『Blessing of Compassion』 and 『Prayer of the Soul』 increase by 3, up to a maximum of 15.",
        ...
        "r4_detail": "The skill levels of 『Honor Guard』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
    ...
    "마코토": {
        "name": "Makoto Niijima",
        "r0": "Spirit Synchronization",
        "r0_detail": "After attacking an enemy with a Persona skill, gain 1 stack of 『Fortitude』, plus 1 additional stack for each elemental ailment the enemy has. At the start of the turn, if Makoto has 5 stacks of 『Fortitude』, she transforms and enters 『Iron Will』 state. In this state, Attack increases by 40% and Defense by 20%, and 『Nuclear Critical』 evolves into 『Nuclear Overdrive』, lasting for 2 turns. When 『Iron Will』 state ends, all 『Fortitude』 stacks are removed.",
        "r1": "Exceed Synchronization",
        "r1_detail": "At the start of battle, gain 5 stacks of 『Fortitude』, allowing transformation into 『Iron Will』 at the start of the first turn. While in 『Iron Will』 state, Attack is further increased by 50%.",
        "r2": "Reactive Initiative",
        "r2_detail": "Upon entering 『Iron Will』 state, inflicts 1 random elemental ailment on 1 enemy. While in 『Iron Will』 state, Makoto's Penetration increases by 6% for each elemental ailment present on the field.",
        "r3": "Combat Pulse",
        "r3_detail": "The skill levels of 『Pulse Barrage』 and 『Nuclear Critical』 increase by 3, up to a maximum of 15.",
        "r4": "Heat Conduction",
        "r4_detail": "HIGHLIGHT Effect Boost: Heat Matter stacks can increase up to 4. Consuming Heat Matter applies up to 4 elemental ailments to enemies and increases skill damage up to 4 times.",
        "r5": "Pure Drill",
        "r5_detail": "The skill levels of 『Nuclear Resonance』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
        "r6": "Breath Coordination",
        "r6_detail": "Upon entering 『Iron Will』 state, gain an extra turn (extra turns do not reduce the duration of ongoing effects). SP cost of 『Nuclear Overdrive』 is reduced by 33%."
    },
    "모토하·여름": {
        "name": "Motoha Arai·Summer",
        "r0": "Sunlight and Blue Sea",
        "r0_detail": "When receiving healing, if the healing amount exceeds 15% of her Max HP, her damage increases by 25% for 2 turns, and the cooldown of 『Wave Chaser』 is reduced by 1 turn (up to 1 turn). When consuming HP through skills, she will not be reduced to the KO state.",
        "r1": "Waves at the Toes",
        "r1_detail": "In 『Midsummer』 state, Critical Rate increases by an additional 10% and Critical Damage by 25%. The cooldown of 『Wave Chaser』 is permanently reduced by 1 turn.",
        "r2": "Distant Swaying Sailboat",
        "r2_detail": "When receiving healing, gain 20% Critical Damage Bonus for 2 turns (up to 2 stacks).",
        "r3": "Shining Golden Light",
        "r3_detail": "The skill levels of 『Leisurely Vacation』 and 『Wave Chaser』 increase by 3, up to a maximum of 15.",
        "r4": "Smiling Sun Above the Sky",
        "r4_detail": "HIGHLIGHT Effect Boost: Her next 『Wave Chaser』 deals 80% increased damage.",
        "r5": "Salty Breeze of the Sea",
        "r5_detail": "The skill levels of 『Summer Day Magic』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
        "r6": "Holding Hands on a Summer Walk",
    ...
    "아야카": {
        "name": "Ayaka Sakai",
        "r0": "♩My Light♪",
        "r0_detail": "At the start of battle, 『Finale: Resonance Activation』 has a cooldown of 1 turn. Each time 『Finale: Resonance Activation』 is used, Ayaka Sakai's ATK permanently increases by 20% (up to 2 stacks). Afterward, the additional cooldown of 『Finale: Resonance Activation』 permanently increases by 1 turn, up to a maximum of 3 turns.",
        "r1": "♩Dawn's Greeting♪",
        ...
        "r4_detail": "HIGHLIGHT effect boost: The duration of the damage bonus extends up to 6 Phantom Thief actions. The HIGHLIGHT energy recovery cap increases to 60%, and the cooldown of other Phantom Thieves' HIGHLIGHT decreases by 1 turn.",
        "r5": "♩Dream Outline♪",
    ...
    "야오링·사자무": {
        ...
        "r3_detail": "The skill levels of 『Song of Fireworks』 and 『Meteor of Fire』 increase by 3, up to a maximum of 15.",
        "r4": "Family Laughter",
        "r4_detail": "HIGHLIGHT effect boost: Yaoling Li·Lion Dance's Critical Effect increases by an additional 15%, and all buff effects from HIGHLIGHT have their duration extended by 2 turns.",
        "r5": "Melting Icicles",
        "r5_detail": "The skill levels of 『New Year's Blessing』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
    ...
    "유우미": {
        "name": "Yumi Shiina",
        "r0": "Bartender",
        "r0_detail": "When an ally uses a Persona Skill/Additional Effect/HIGHLIGHT to deal damage, Yumi Shiina gains a 『Flavor』 of the corresponding element. When she collects 3 『Flavors』, Yumi Shiina crafts a cocktail.\n\nDepending on the combination of 『Flavors』, different 『Cocktails』 are crafted. The maximum stock is 3 glasses. (For each ally, Yumi Shiina gains 1 『Flavor』 in the next turn.)\n- 3 identical 『Flavors』: Crafts a 『Mix・DELUXE』.\n- 2 identical 『Flavors』: Crafts a 『Mix』.\n- 3 different 『Flavors』: Crafts a 『Rough』.\n\nWhen Yumi Shiina casts a skill, she consumes a 『Cocktail』 to enhance the skill's effect and restores 6 SP to all allies by consuming a 『Cocktail』.",
        "r1": "Mojito",
        "r1_detail": "When Yumi Shiina crafts a 『Cocktail』, she has a 100% fixed chance to return one random 『Flavor』.",
        "r2": "Tequila Sunrise",
        "r2_detail": "When Yumi Shiina crafts a 『Cocktail』, all allies' damage dealt is increased by 16% for 1 turn.",
        "r3": "Margarita",
        "r3_detail": "The skill levels of 『Colorful Ingredients』 and 『Aromatic Wine』 increase by 3, up to a maximum of 15.",
        "r4": "Screwdriver",
        "r4_detail": "When any ally casts HIGHLIGHT, that ally's Attack increases by 10% for 1 turn, and Yumi Shiina gains 1 『Mix・DELUXE』.",
        "r5": "Bloody Mary",
        "r5_detail": "The skill level of 『Seductive Fragrance』 increases by 3, up to a maximum of 15.",
        "r6": "Classic Martini",
        "r6_detail": "The maximum stock of 『Cocktails』 increases to 4 glasses. At the start of battle, Yumi Shiina gains 1 『Mix・DELUXE』. When Yumi Shiina crafts 3 『Cocktails』, she gains an additional 『Mix・DELUXE』."
    },
    "치즈코": {
        "name": "Chizuko Nagao",
        "r0": "Ha! This Temper",
        "r0_detail": "When inflicting an elemental ailment on an enemy, the enemy gains 『Radiation』 for 2 turns. 『Radiation』 increases damage received by 15% and counts as one type of elemental ailment.",
        "r1": "For Two",
        ...
        "r4": "Veteran Driver",
        "r4_detail": "HIGHLIGHT Effect Boost: Nuclear Heat damage received increases by 35.2% for 2 turns.",
        "r5": "Roaring Engine",
        "r5_detail": "The skill levels of 『Concentrated Ground Bombing』 and 『Combat Skills』 increase by 2, up to a maximum of 15.",
        "r6": "BOOM! BOOM!",
        "r6_detail": "When an ally attacks an enemy with 『Radiation』, up to 3 effects activate depending on the number of elemental ailments on the enemy:\n- 1 or more ailments: ATK +10%,\n- 2 or more ailments: Nuclear Heat damage +10%,\n- 3 or more ailments: Penetration +8%."
    },
    "카스미": {
        ...
        "r3_detail": "The skill levels of 『Combat Skills』 and 『Light in the Darkness』 increase by 3, up to a maximum of 15.",
        "r4": "Prince’s Gaze",
        ...
        "r5_detail": "The skill levels of 『Dance Together』 and 『Blooming Heart』 increase by 3, up to a maximum of 15.",
    ...
    "키라": {
        ...
        "r3_detail": "The skill levels of 『Dissection Technique/Sinful Game』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
        "r4": "Plague",
    ...
    "토모코·여름": {
        ...
        "r3_detail": "The skill levels of 『Summer Drink』 and 『Enjoy Your Meal』 increase by 3, up to a maximum of 15.",
        ...
        "r5_detail": "The skill levels of 『Midnight Thrill』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
    ...
    "하루": {
        ...
        "r3": "Rose of Firearms",
        "r3_detail": "The skill levels of 『Iron Burst』 and 『Combat Skills』 increase by 3, up to a maximum of 15.",
        "r4": "Exploding Cake",
        ...
        "r5": "Vines of Terror",
        "r5_detail": "The skill levels of 『Focused Aim』 and 『Suppressive Fire』 increase by 3, up to a maximum of 15.",
    ...
    "세이지": {
        ...
        "r3": "Improvisation",
        "r3_detail": "Increase the skill levels of Blustering Épée and Graceful Gale by 2, up to a maximum of 15.",
        "r4": "En Garde",
        ...
        "r5_detail": "Increase the skill levels of Saber Surge and Thief Tactics by 2, up to a maximum of 15.",
    ...
    "유키미": {
        ...
        "r3_detail": "Increase the skill levels of Sword of Condemnation and Sacral Glow by 2, up to a maximum of 15.",
        ...
        "r5_detail": "Increase the skill levels of Absolute Judgment and Thief Tactics by 2, up to a maximum of 15.",
    ...
    "키요시": {
        ...
        "r3": "Repent, Sinner",
        "r3_detail": "Increase the skill levels of Ring of Fire and Cleansing Flame by 2, up to a maximum of 15.",
        "r4": "Untold Story",
    ...
    "토모코": {
        ...
        "r3": "Shift Change",
        "r3_detail": "Increase the skill levels of Cheering You On and Psyche Melody by 2, up to a maximum of 15.",
        "r4": "Lingering Lullaby",
        "r4_detail": "Highlight Enhanced: Increase target's next damage taken by an additional 24%.",
        "r5": "Daily Challenge",
        "r5_detail": "Increase the skill levels of Spirit's Lullaby and Thief Tactics by 2, up to a maximum of 15.",
        "r6": "Celebratory Tone",
    ...
    "토시야": {
        ...
        "r3_detail": "Increase the skill levels of Unexpected Tragedy and Absurd Comedy by 2, up to a maximum of 15.",
        ...
        "r5_detail": "Increase the skill levels of Tragicomedy of Love and Thief Tactics by 2, up to a maximum of 15.",
        "r6": "Life Advice",
