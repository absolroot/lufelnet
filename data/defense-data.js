const defenseCalcData = [
    {
        ...
        type: "계시",
        target: "단일",
        skillIcon: "../img/revelation/여정.webp",
        skillName: "주권 + 여정",
        options: [],
        value: 23.0,
        duration: "2턴",
    ...
    },
    {
        ...
        type: "전용무기",
        target: "광역",
        skillIcon: "../img/wonder-weapon/천상의 별.webp",
        skillName: "천상의 별",
        options: [],
        value: 22.0,
        duration: "-",
    ...
    },
    {
        ...
        type: "스킬",
        target: "단일",
        skillIcon: "../img/skill-element/디버프.png",
        skillName: "라쿤다",
        options: [],
        value: 38.8,
        duration: "3턴",
    ...
    },
    {
        ...
        type: "스킬",
        target: "광역",
        skillIcon: "../img/skill-element/디버프광역.png",
        skillName: "음률의 침입",
        options: [],
        value: 32.0,
        duration: "3턴",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "단일/광역",
        skillIcon: "../img/tactic-persona/비슈누.webp",
        skillName: "비슈누",
        options: [],
        value: 48.0,
        duration: "2턴",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "단일/광역",
        skillIcon: "../img/tactic-persona/노른.webp",
        skillName: "노른",
        options: [],
        value: 31.5,
        duration: "2턴",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "단일",
        skillIcon: "../img/tactic-persona/체르노보그.webp",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "광역",
        skillIcon: "../img/tactic-persona/년수.webp",
        skillName: "년수 - 고유스킬",
        options: [],
        value: 10.0,
        duration: "2턴",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "광역",
        skillIcon: "../img/tactic-persona/시바.webp",
        skillName: "시바 - 고유스킬",
        options: [],
        value: 45.0,
        duration: "1턴",
    ...
    },
    {
        ...
        type: "페르소나",
        target: "단일",
        skillIcon: "../img/tactic-persona/스라오샤.webp",
        skillName: "스라오샤 - 고유스킬",
        options: [],
        value: 25.0,
        duration: "1턴",
    ...
    },
    {
        ...
        type: "스킬2",
        target: "광역",
        skillIcon: "../img/skill-element/주원광역.png",
        skillName: "기울어진 사냥터",
        options: ["LV10","LV10+심상5","LV13","LV13+심상5"],
        values: {
            "LV10": 25.4,
    ...
    },
    {
        ...
        type: "전용무기",
        target: "광역",
        skillIcon: "../img/character-weapon/루우나-5-01.png",
    ...
    },
    {
        ...
        type: "의식0",
        target: "광역",
        skillIcon: "../img/character-detail/ritual0.png",
    ...
    },
    {
        ...
        type: "전용무기",
        target: "단일",
        skillIcon: "../img/character-weapon/치즈코-5-01.png",
        skillName: "오버클럭 펄스",
        options: ["개조0","개조1&2","개조3&4","개조5&6"],
        values: {
            "개조0": 33.0,
    ...
    },
    {
        ...
        type: "스킬1",
        target: "단일",
        skillIcon: "../img/skill-element/핵열.png",
        skillName: "시그널 폭탄",
        options: [],
        value: 38.8,
        duration: "2턴",
    ...
    },
    {
        ...
        type: "전용무기",
        target: "단일/광역",
        skillIcon: "../img/character-weapon/슌-5-01.png",
        skillName: "선구자의 얼음도끼",
        options: ["개조0","개조1&2","개조3&4","개조5&6"],
        values: {
            "개조0": 30.0,
    ...
    },
    {
        ...
        type: "스킬2",
        target: "단일",
        skillIcon: "../img/skill-element/물리.png",
        skillName: "선봉 돌격",
    ...
    },
    {
        ...
        type: "총기",
        target: "단일/광역",
        skillIcon: "../img/skill-element/총격.png",
        skillName: "총격",
        options: [],
        value: 35.0,
        duration: "3턴",
