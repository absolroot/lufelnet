...
window.ritualData["이치고"] = {
  "name": "시카노 이치고",
  "r0": "중독된 사랑",
  "r0_detail": "시카노 이치고가 처음으로 『진홍빛 나비』 시전 시 『집착』 1중첩을 획득한다. 자신이 HIGHLIGHT 시전할 때마다 『집착』을 1중첩 획득한다. 『집착』은 최대 3중첩을 획득할 수 있고, 『집착』 중첩에 따라 다음 강화 효과를 획득한다.\n1중첩: 『원념』 중첩마다 적이 받는 대미지가 4% 증가한다.\n2중첩: 크리티컬 확률이 15% 증가하고, 자신이 페르소나 스킬로 입히는 모든 피해가 지속 대미지 효과로 간주된다.\n3중첩: 지속 대미지 효과가 25% 증가한다.",
  "r1": "부서진다면",
