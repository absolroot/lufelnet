...
window.ReleaseScheduleData = {
    ...
    manualReleases: [
        ...
        { version: "1.0", date: "2025-06-25", characters: ["렌"], note: "PALACE 1/2" },
        ...
        { version: "2.0", date: "2025-09-04", characters: ["아야카", "리코"], note: "PALACE 3-1" },
        { version: "2.1", date: "2025-09-22", characters: ["모토하·여름"] },
        { version: "2.2", date: "2025-10-09", characters: ["토모코·여름"] },
        { version: "2.3", date: "2025-10-23", characters: ["키라"], note: "PALACE 3-2" },
        ...
        // ===== 2026년 =====
        { version: "3.0", date: "2026-01-08", characters: ["몽타뉴·백조"], note: "PALACE 4-1" },
    ],
    ...
    autoGenerateCharacters: [
        ...
        { version: "3.3", characters: ["리코·매화"], note: "PALACE 4-2" },
        ...
        { version: "4.0", characters: ["마나카", "쇼키"], note: "PALACE 5-1", isThreeWeekStart: true },
        { version: "4.1", characters: ["유키 마코토"], note: "P3R Collaboration" },
        { version: "4.2", characters: ["유카리"] },
        { version: "4.3", characters: ["사나다"] },
        { version: "4.4", characters: ["이치고"], note: "PALACE 5-2" },
        { version: "4.5", characters: ["미나미·여름"] },
        { version: "4.6", characters: ["미유·여름"] },
        { version: "4.7", characters: ["카타야마"] },
        { version: "4.8", characters: ["YUI·스텔라"], note: "PALACE 5-3" },
        { version: "4.9", characters: ["미츠루"] },
        { version: "4.10", characters: ["후카"] },
        { version: "4.11", characters: ["쇼키·암야"], note: "PALACE 5-4" },
        { version: "4.12", characters: ["슌·프론티어"] },
        { version: "4.13", characters: ["준페이"] },
        { version: "4.14", characters: ["나루루"] },
