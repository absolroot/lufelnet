...
window.ritualData["카타야마"] = {
  "name": "카타야마 쿠미",
  "r0": "효율적인 지도",
  "r0_detail": "카타야마 쿠미가 스킬 『회전 칼날』을 사용하면 『오의·섬광 다리』를 해제하고 발동할 수 있다. 스킬 『오의·섬광 다리』를 발동하면 적합성을 무시해 적의 다운 수치를 크게 약화시키며, 자신이 추가한 『중상』의 방어력 감소 효과 10% 증가+카타야마 쿠미가 속도를 10포인트 보유할 때마다 2.22% 증가한다(상한 40%). 효과는 2턴 동안 지속된다.",
  "r1": "악행 불허",
  "r1_detail": "자신이 적을 다운시키면 목표의 다운 수치 상한이 영구적으로 1포인트 감소한다.\n『격파』 시 목표의 받는 크리티컬 효과가 30% 추가 증가한다.\n자신이 전격 속성 대미지를 줄 때, 100%의 기본 확률로 목표를 감전 상태에 빠뜨린다.",
  "r2": "정의의 인도",
  "r2_detail": "자신의 스킬로 다운시킨 후, 1턴 동안 목표의 다운 허약이 추가로 10% 증가한다. 또한 모든 아군 동료의 공격력이 영구적으로 10% 증가한다(3회 중첩 가능).",
  "r3": "열혈 교사",
  "r3_detail": "『회전 칼날』, 『선생님의 심판』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r4": "빛나는 섬광",
  "r4_detail": "HIGHLIGHT 효과 증가: HIGHLIGHT 시전 후 자신이 다음에 적을 다운시키면, 적의 받는 대미지가 영구적으로 20% 증가한다(해당 효과 중첩 불가).",
  "r5": "무쌍의 교사",
...
window.cnCharacterRitualData["카타야마"] = {
  "name": "片山久未",
  "r0": "高效指导",
  "r0_detail": "片山久未使用技能『激情回旋刃』可以解锁并使用技能『奥义·闪光腿』。使用技能『奥义·闪光腿』能够无视适应性大幅削弱敌人的倒地值，并使自身添加的『重创』防御力降低效果提升10%+片山久未每有10点速度提升2.22%，上限40%，持续2回合。",
  "r1": "恶行不容",
  "r1_detail": "自身击倒敌人时，使目标的倒地值上限永久降低1点；\n『击破』额外使目标受到暴击效果提升30%；\n自身造成电击属性伤害时，有100%基础概率使目标陷入触电状态。",
  "r2": "正义引导",
  "r2_detail": "自身技能造成击倒后，额外使目标倒地易伤提升10%，持续1回合；并使所有友方同伴攻击力永久提升10%，上限3层。",
  "r3": "热血教师",
  "r3_detail": "『激情回旋刃』、『裁决雷击』的技能等级提升3级，至多提升至15级。",
  "r4": "闪光辉耀",
  "r4_detail": "HIGHLIGHT效果提升：释放HIGHLIGHT后，自身下次击倒敌人时，额外使敌人受到伤害永久提升20%，该效果不可叠加。",
  "r5": "无双教师",
  "r5_detail": "『奥义·闪光腿』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "不灭教师魂",
