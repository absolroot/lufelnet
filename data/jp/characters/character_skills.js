const jpCharacterSkillsData = {
    ...
    "마사키": {
        "name": "芦谷 真咲",
        "skill1": {"name":"フロストヴァイン","element":"빙결","type":"単体ダメージ","sp":24,"cool":0,"description":"選択した対象に防御力149.2%/164.5%/158.4%/173.7%分の氷結属性ダメージを与え、それ以外の敵に防御力44.8%/49.4%/47.6%/52.1%分の氷結属性ダメージを与える。\n選択した対象を97.6%/97.6%/103.6%/103.6%の確率で凍結状態にし、同時に『英勇』を２つ獲得する。\nさらに『花園に誓う友情』状態ならば、２ターンの間、選択した対象の被ダメージを自身の防御力６００ごとに２%上昇させる（最大19.5%/21.5%/20.7%/22.7%まで）。ただし『英勇』の獲得量は１つになる。"},
        "skill2": {"name":"誓いの雪花","element":"버프","type":"シールド","sp":26,"cool":0,"description":"味方単体に防御力22.8%/22.8%/24.2%/24.2%＋650/790/799/939のシールド『騎士の守り』を１つ付与する。さらに、２ターンの間、その味方の防御力を芦谷の防御力の２０%分（最大1220/1345/1295/1420まで）上昇させる。この効果を付与された対象のＨＰが６０%より多い場合、敵から攻撃を受ける確率が５０%上昇する。\n自身の次のターン開始時、同じ対象に再度『騎士の守り』を１つ付与する。『花園に誓う友情』状態ならば、２ターンの間、付与する『騎士の守り』のシールド量が２５%上昇する。"},
        "skill3": {"name":"決意の氷壁","element":"버프광역","type":"シールド","sp":30,"cool":1,"description":"味方全体に、防御力の１２%＋１２０／２４０／３６０(自身のレベルが１/５０/７０以上の時)のシールド『騎士の守り』を１つと、さらに防御力49.2%/49.2%/52.2%/52.2%+1400/1702/1721/2024のシールド『騎士の決意』を付与する。\n同時に、味方全体のダウン値を１増加させ、さらに２ターンの間、与ダメージを芦谷の防御力３００ごとに２.９%(最大56.6%/62.4%/60.1%/65.9%まで）上昇させる。"},
        "skill_highlight": {"element":"버프광역","type":"シールド","description":"２ターンの間、味方全体に防御力59.0%/59.0%/62.7%/62.7%＋1681/2044/2066/2429のシールド『騎士の決意』を付与し、さらに味方全体の被ダメージを31.9%/35.2%/33.9%/37.1%低下させる。","cool":4},
        "passive1": {"name":"花の騎士の庇護","element":"패시브","description":"芦谷のシールドが付与されている味方は、防御力が24.0%上昇、状態異常抵抗が48.0%上昇する。","cool":0},
        "passive2": {"name":"花の騎士の献身","element":"패시브","description":"芦谷が場にいる時、味方が状態異常抵抗により、呪印／属性異常／行動異常を回避した時、１／２／３つの強化効果を得る。\n強化効果は、１つごとに、２ターンの間、対象の味方の与ダメージが10.0%上昇し、最大３つまで累積できる。３つになると、さらに２ターンの間、クリティカルダメージが20.0%上昇する。","cool":0}
    },
    "마코토": {
        "name": "新島 真",
        "skill1": {
    ...
    "키라": {
        "name": "北里 基良",
        "skill1": {"name":"月下のメス／闇夜処置","element":"물리","sp":21,"cool":0,"description":"『ドクター』状態：敵単体に４回、攻撃力47.3%/52.2%/50.2%/55.1%の物理属性ダメージを与え、さらに『出血』を１つ付与する。『バスター』状態：敵単体に攻撃力251.7%/277.5%/267.2%/292.9%の物理属性ダメージを与え、その後に対象の『出血』を２つ取り除く（『烈痛』効果を発動できる）。"},
        "skill2": {"name":"深紅のオペ／病理特定","element":"물리","sp":21,"cool":0,"description":"『ドクター』状態：敵単体に２回、攻撃力84.2%/92.9%/89.4%/98.0%の物理属性ダメージを与える。同時に１回、『出血』ダメージを発生させ、対象の『出血』の持続ターンをリセットする。\n『バスター』状態：敵単体に攻撃力251.7%/277.5%/267.2%/292.9%の物理属性ダメージを与える。対象に付与されている『出血』が１つごとに、このスキルとそれによって発動する『烈痛』のダメージが２%ずつ上昇する。その後、対象の『出血』を全て取り除く（『烈痛』効果を発動できる）。"},
        "skill3": {"name":"ジキルハイド","type":"버프","sp":15,"cool":0,"description":"自身の状態を『バスター』に切り替え、他のスキルの性質を変化させる（いずれかの敵に付与されている『出血』が７つ以上の時に使用可能）。\nさらに、この状態でスキルを使用した時、対象の『出血』が３つごとに、追加で１回『烈痛』（攻撃力66.7%/73.5%/70.8%/77.6%の物理属性ダメージ）を与える。\nこのスキルを使用した後に他のスキルを使用することができ、ターン終了時に『ドクター』状態に戻る。","element":"버프"},
        "skill_highlight": {"element":"물리","cool":4,"description":"『ドクター』状態に切り替え、即座に敵単体に『出血』を５つ付与する。\n直後に『バスター』状態に切り替え、対象に攻撃力492.8%/543.3%/523.1%/573.6%の物理属性ダメージを与える（『烈痛』効果を発動可能）。"},
        "passive1": {"name":"異形のマスク","element":"패시브","cool":0,"description":"自身の状態異常命中が３０%ごとに、『出血』の物理属性の与ダメージが自身の攻撃力の４%分上昇する（最大で状態異常命中90%分まで）。"},
        "passive2": {"name":"抜き身の刃","element":"패시브","cool":0,"description":"『ドクター』状態の時、状態異常命中が36%上昇する。\n『バスター』状態の時、貫通力が21%上昇する。"}
    },
    "토모코·여름": {
        "name": "朋子・ピーチサマー",
        "skill1": {
    ...
    "하루": {
        "name": "奥村 春",
        "skill1": {"name":"マインドエイム","element":"염동광역","type":"광역피해","sp":26,"cool":0,"description":"敵全体に攻撃力75.8%/83.6%/80.5%/88.3%の念動属性ダメージを２回与え、選択した対象に97.6%/97.6%/103.6%/103.6%の確率で『標的層』を１つ付与し、それ以外の敵に53.7%/53.7%/57.0%/57.0%の確率で『標的層』を１つ付与する。その後、敵の『標的層』を自身の『標的層』に変換し、『標的層』は３ターンの間持続する。また自身は『フォーカス弾』を１つ獲得する。\n『フォーカス弾』：遠隔攻撃時、『標的層』を獲得している時、スキルダメージが29.3%/32.3%/31.1%/34.1%上昇し、遠隔攻撃後に自身が獲得している全ての『標的層』を解除する。"},
        "skill2": {"name":"精密斉射","element":"총격","type":"단일피해","hp":12,"cool":0,"description":"敵単体に攻撃力151.6%/167.1%/160.9%/176.4%の銃撃属性ダメージを与える。自身が『標的層』を獲得している時、このスキルの貫通力が19.5%/19.5%/20.7%/20.7%上昇する。さらに自身は『ペインポイント弾』を１つ獲得する。\n『ペインポイント弾』：遠隔攻撃時、選択した対象に攻撃力39.0%/43.0%/41.4%/45.4%の念動属性ダメージを追加で与え、『フォーカス弾』のスキルダメージ上昇効果を得ることができる。"},
        "skill3": {"name":"マインドフルリリース","element":"염동광역","type":"광역피해","sp":26,"cool":0,"description":"敵全体に攻撃力142.1%/156.7%/150.8%/165.4%の念動属性ダメージを与え、自身が『標的層』を獲得している時、このスキルのクリティカル率が19.5%/19.5%/20.7%/20.7%上昇する。さらに自身は『スピルオーバー弾』を１つ獲得する。\n『スピルオーバー弾』：遠隔攻撃時、敵全体に攻撃力29.3%/32.3%/31.1%/34.1%の念動属性ダメージを追加で与え、『フォーカス弾』のスキルダメージ上昇効果を得ることができる。"},
        "skill_highlight": {"element":"염동광역","type":"광역피해","description":"敵全体に攻撃力206.9%/228.1%/219.6%/240.8%の念動属性ダメージを与える。『想いの弾丸』が最大数未満で『オーバーロード弾』も獲得していない場合、『オーバーロード弾』を１つ獲得する。\n『オーバーロード弾』：遠隔攻撃時、クリティカル率が14.6%/14.6%/15.5%/15.5%上昇する。\n『オーバーロード弾』を獲得しなかった場合、このスキルダメージが14.6%/16.1%/15.5%/17.0%上昇する。","cool":4},
        "passive1": {"name":"令嬢の采配","element":"패시브","description":"戦闘中、状態異常命中が１.４５%ごとに攻撃力が１%上昇し、最大で攻撃力165.0%まで上昇する。さらに状態異常命中が５０%ごとに、追加でクリティカルダメージが２０%上昇し、最大で3つまで累積する。","cool":0},
        "passive2": {"name":"みんなの役に立ちたい","element":"패시브","description":"『想いの弾丸』を１種獲得するごとに、『改善点』を永続的に１つ獲得する。『改善点』の累積数に応じて、以下の効果を獲得する。\n「１：状態異常命中が18.0%上昇し、状態異常抵抗が18.0%上昇する。」\n「２：攻撃力が18.0%上昇し、防御力が18.0%上昇する。」\n「３：クリティカルダメージが18.0%上昇する。」","cool":0}
    },
    "후타바": {
        "name": "佐倉 双葉",
        "skill1": {"name":"セキュリティバイバイ","element":"버프광역","type":"디버프","cool":0,"description":"３ターンの間、敵全体の防御力を６%低下させ、さらに双葉の攻撃力１００ごとに追加で防御力を０.５３%低下させる（最大で攻撃力4600/5060/5980/6440分まで）。この防御力低下効果中の敵が弱点ダメージを受ける時、効果が２倍になる。\nまた双葉の『解析進捗』が１００%の場合、２ターンの間、味方全体に『データ掌握』を付与する。"},
        "skill2": {"name":"脆弱性みーっけ！","element":"버프","type":"디버프","cool":0,"description":"３ターンの間、敵単体の被ダメージを６%上昇させ、さらに双葉の攻撃力１００ごとに追加で被ダメージを０.５７%上昇させる（最大で攻撃力4600/5060/5980/6440分まで）。\nこの効果中の敵に、味方がスキル／意識奏功／ハイライトでダメージを与えた時、『解析進捗』を２０%獲得する。\nまた双葉の『解析進捗』が１００%の場合、２ターンの間、味方全体に『データ掌握』を付与する。"},
        "skill3": {"name":"データリンク開始！","element":"버프","type":"버프","cool":0,"unlock":"味方が『ハッキング完了』を保有。","description":"味方が『データ掌握』状態の時に使用可能となり、２ターンの間、味方単体の攻撃力を270/297/302/329上昇させる。さらに双葉の攻撃力１００ごとに追加で攻撃力を２１.７上昇させる（最大で攻撃力4600/5060/5980/6440分まで）。\nまた１ターンの間、選択した味方の属性に応じた『ウイルス』を敵全体に付与する。\n『ウイルス』：付与された敵の属性相性が変化する。無効・反射・吸収は耐性。耐性は通常。通常は弱点。弱点は弱点ダメージ＋２５%となる。"},
        "skill_highlight": {
            "name": "ステータス強化",
            "element": "패시브",
            "description": "佐倉のステータスの20%分、味方全体のステータスを上昇させる。"
        },
        "passive1": {"name":"天才プログラマーの好奇心","element":"패시브","description":"戦闘開始時、双葉は『解析進捗』を100%獲得する。","cool":0},
        "passive2": {"name":"ルートキット","element":"패시브","description":"『データ掌握』状態の時、３ターンの間、味方全体に双葉の攻撃力30.0%分のシールドを付与する。","cool":0}
    },
