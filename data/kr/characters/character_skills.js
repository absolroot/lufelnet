const characterSkillsData = {
    ...
    "유카리": {
        ...
        "skill1": {
            ...
            "sp": 23,
            "cool": 0,
            "description": "단일 적에게 유카리의 공격력의 200.1%/220.6%/212.4%/232.9%만큼 질풍 속성 피해를 입히고, 100%의 기본 확률로 『풍습』 상태에 빠뜨리며, 『풍식』을 부여합니다 (2턴 지속).\n『풍식』은 전장에 1개만 존재할 수 있습니다.\n\n패시브 효과 : 아군이 스킬을 사용할 때, 대상이 『풍식』 상태일 경우 해당 스킬의 공격력이 8.8%/9.7%/9.3%/10.2% + 유카리의 공격력의 100당 0.72%만큼 증가합니다. (최대 29.3%/32.3%/31.1%/34.1%)"
        },
        "skill2": {
            "name": "바람을 쫓는 숨결(의역)",
            "element": "버프광역",
