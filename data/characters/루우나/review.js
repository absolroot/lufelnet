(function () {
    ...
    window.characterReview["루우나"] = { name_en: "Runa Dogenzaka", name_jp: "道玄坂 琉七", codename: "HOWLER",
        review: `화염 속성 또는 추가 효과 대미지를 강화시켜주는 **디버퍼**다.
...
`,
        review_cn: `是一名能够强化火焰属性或追加效果伤害的**减益手**。

她的机制是先通过技能1去辅助群体火焰输出，或者通过技能2去辅助单体追加效果输出，之后再解锁技能3。
...
如果想把她技能里的**防御力降低效果**吃满，最好还是把**效果命中堆到推荐区间**。`,
        ...
        cons_cn: ["伤害加成主要局限在火焰属性与追加效果体系内。", "没过多久就出现了更上位的减益手。"],
    };
})();
