...
window.cnCharacterRitualData["렌"] = {
  "name": "雨宫莲",
  "r0": "拉开帷幕",
  "r0_detail": "自己的回合结束时，场上每有1个当前生命值低于60%的敌人，就获得1个『煞气』，上限5层。回合结束时若『煞气』大于等于3层，且JOKER不处于自身额外回合，则获得1个额外回合（进入额外回合时，角色身上的持续型效果不会扣除持续回合数），自身额外回合结束后清除3层『煞气』。每个敌人在每场战斗中只能给予JOKER1个『煞气』。",
  "r1": "飞舞的手牌",
  "r1_detail": "主动技能对技能主目标造成的技能伤害提升30%，对非主目标的敌人造成技能伤害提升10%。",
  "r2": "秘密障眼法",
  "r2_detail": "『厄运追击』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r3": "神秘莫测",
  "r3_detail": "处于额外回合时，技能消耗的精力值减少80%。若精力值不小于60%，则攻击力提升50%。",
  "r4": "美梦编织",
  "r4_detail": "『无畏压制』、『不祥的预兆』的技能等级提升3级，至多提升至15级。",
  "r5": "无中生有",
  "r5_detail": "HIGHLIGHT效果提升：获得3个『煞气』。",
  "r6": "奇妙秀终章",
