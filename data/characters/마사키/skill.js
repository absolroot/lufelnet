...
window.characterSkillsData["마사키"] = {
  ...
  "skill3": {
    ...
    "sp": 30,
    "cool": 1,
    "description": "즉시 모든 동료에게 방어력 12%+120/240/360(1/50/70레벨)의 대미지를 막을 수 있는 『정직의 성인』 1중첩과 방어력 49.2%/49.2%/52.2%/52.2%+1400/1702/1721/2024의 대미지를 막을 수 있는 『성결의 가호』 1중첩을 추가한다. 동시에 모든 동료가 다운 수치 1포인트와 주는 대미지 증가 효과(아시야 마사키가 방어력 300포인트를 보유할 때마다 주는 대미지 2.9% 증가, 최대 56.6%/62.4%/60.1%/65.9% 증가)를 획득하며 2턴 동안 지속된다."
  },
  "skill_highlight": {
    "element": "버프광역",
    "type": "실드",
  ...
  "passive1": {
    "name": "희생",
    "element": "패시브",
    "description": "아시야 마사키의 실드 보호를 받는 동료의 방어력이 24.0% 증가한다. 아시야 마사키의 실드 보호를 받는 동료의 효과 저항이 48.0% 증가한다.",
    "cool": 0
  },
  "passive2": {
    "name": "겸손",
    "element": "패시브",
    "description": "아시야 마사키가 필드에 있을 때, 임의의 동료가 저주/원소 이상/정신 이상 상태를 성공적으로 저항할 때마다 각각 1/2/3중첩의 버프를 획득한다. 매 중첩마다 동료의 주는 대미지가 10.0% 증가하고 2턴 동안 지속되며, 최대 3중첩까지 누적된다. 3중첩에 도달하면 추가로 크리티컬 효과가 20.0% 증가하고 2턴 동안 지속된다.",
    "cool": 0
  }
};
