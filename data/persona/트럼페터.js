...
window.personaFiles["트럼페터"] = {
  ...
  "passive_skill": [
    {
      "name": "붕괴의 나팔",
      "name_en": "Prelude to the End",
      "name_jp": "btltbc-0804-黙示の前奏曲",
      ...
      "desc_en": "Increase ailment accuracy by 34.9%.\nAfter using a skill on a foe that has 15 or more debuff stacks, increase target's damage taken by 4.5% and increase user's ailment accuracy by 30% for 2 turns. After inflicting a spiritual ailment, decrease all foes' Defense by 8% for 2 turns.",
      "desc_jp": "btltbc-0804-状態異常命中が３４.９%上昇する。\n自身が敵にスキルを使用した時、対象の弱体効果数が１５個以上の場合、２ターンの間、自身の状態異常命中が３０%上昇し、対象の被ダメージが４.５%上昇する。自身が行動異常を付与した時、２ターンの間、敵全体の防御力が８%低下する。",
      "name_cn": "崩坏的号角",
      "desc_cn": "效果命中提升34.9%。自身对敌方使用人格面具技能时，若技能目标的异常效果数量≥15个，则使自身效果命中提升30%，并使敌人受到伤害提升4.5%，持续2回合。自身成功添加精神异常效果后，额外使所有敌人防御力降低8%，持续2回合。"
    },
    {
      "name": "붕괴의 나팔Ⅰ",
      "name_en": "Prelude to the End I",
      "name_jp": "btltbc-0804-黙示の前奏曲Ⅰ",
      ...
      "desc_en": "Increase ailment accuracy by 34.9%.\nAfter using a skill on a foe that has 15 or more debuff stacks, increase target's damage taken by 4.5% and increase user's ailment accuracy by 50% for 2 turns. After inflicting a spiritual ailment, decrease all foes' Defense by 8% for 2 turns.",
      "desc_jp": "btltbc-0804-状態異常命中が３４.９%上昇する。\n自身が敵にスキルを使用した時、対象の弱体効果数が１５個以上の場合、２ターンの間、自身の状態異常命中が５０%上昇し、対象の被ダメージが４.５%上昇する。自身が行動異常を付与した時、２ターンの間、敵全体の防御力が８%低下する。",
      "name_cn": "崩坏的号角Ⅰ",
      "desc_cn": "效果命中提升34.9%。自身对敌方使用人格面具技能时，若技能目标的异常效果数量≥15个，则使自身效果命中提升50%，并使敌人受到伤害提升4.5%，持续2回合。自身成功添加精神异常效果后，额外使所有敌人防御力降低8%，持续2回合。"
    },
    {
      "name": "붕괴의 나팔Ⅱ",
      "name_en": "Prelude to the End II",
      "name_jp": "btltbc-0804-黙示の前奏曲Ⅱ",
      ...
      "desc_en": "Increase ailment accuracy by 34.9%.\nAfter using a skill on a foe that has 15 or more debuff stacks, increase target's damage taken by 6.5% and increase user's ailment accuracy by 50% for 2 turns. After inflicting a spiritual ailment, decrease all foes' Defense by 8% for 2 turns.",
      "desc_jp": "btltbc-0804-状態異常命中が３４.９%上昇する。\n自身が敵にスキルを使用した時、対象の弱体効果数が１５個以上の場合、２ターンの間、自身の状態異常命中が５０%上昇し、対象の被ダメージが６.５%上昇する。自身が行動異常を付与した時、２ターンの間、敵全体の防御力が８%低下する。",
      "name_cn": "崩坏的号角Ⅱ",
      "desc_cn": "效果命中提升34.9%。自身对敌方使用人格面具技能时，若技能目标的异常效果数量≥15个，则使自身效果命中提升50%，并使敌人受到伤害提升6.5%，持续2回合。自身成功添加精神异常效果后，额外使所有敌人防御力降低8%，持续2回合。"
    },
    {
      "name": "붕괴의 나팔Ⅲ",
      "name_en": "Prelude to the End III",
      "name_jp": "btltbc-0804-黙示の前奏曲Ⅲ",
      ...
      "desc_en": "Increase ailment accuracy by 34.9%.\nAfter using a skill on a foe that has 15 or more debuff stacks, increase target's damage taken by 6.5% and increase user's ailment accuracy by 50% for 2 turns. After inflicting a spiritual ailment, decrease all foes' Defense by 12% for 2 turns.",
      "desc_jp": "btltbc-0804-状態異常命中が３４.９%上昇する。\n自身が敵にスキルを使用した時、対象の弱体効果数が１５個以上の場合、２ターンの間、自身の状態異常命中が５０%上昇し、対象の被ダメージが６.５%上昇する。自身が行動異常を付与した時、２ターンの間、敵全体の防御力が１２%低下する。",
      "name_cn": "崩坏的号角Ⅲ",
  ...
  "uniqueSkill": {
    "name": "나락의 파동",
    "name_en": "Abysmal Surge",
    "name_jp": "奈落の波動",
    "desc": "12.6%/13.3%/13.9%의 기본 확률로 적 전체를 3턴 동안 절망 상태에 빠뜨린다.",
    "desc_en": "12.6/13.3/13.9% chance to inflict Despair on all foes for 3 turns.",
    "desc_jp": "12.6/13.3/13.9%の確率で敵全体を３ターンの間、絶望状態にする。",
    "priority": 1,
    "icon": "디버프광역",
    "icon_gl": "",
    "name_cn": "深渊的波动",
  ...
  "highlight": {
    ...
    "desc_en": "Deal Almighty damage to all foes equal to 45.0%/48.2%/51.3% of Attack. Increase damage taken by 19.6%/21.0%/22.3% for 2 turns.",
    "desc_jp": "敵全体に攻撃力45.0%/48.2%/51.3%の万能属性ダメージを与える。さらに２ターンの間、被ダメージが19.6%/21.0%/22.3%上昇する。",
    "priority": 1,
    "name_cn": "HIGHLIGHT",
  ...
  "innate_skill": [
    {
      ...
      "desc_en": "Deal Nuclear damage to all foes equal to 66.9/69.9/72.9% of Attack. Deal a Technical and increase damage by 20% for foes with an elemental ailment.",
      "desc_jp": "敵全体に攻撃力66.9/69.9/72.9%の核熱属性ダメージを与える。属性異常の敵に対してテクニカルが発生しダメージが２０%上昇する。",
      "cost": "SP 21",
      "level": "6/7/8",
      "learn_level": "10",
      "name_cn": "玛哈芙雷达因",
