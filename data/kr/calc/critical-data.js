...
const criticalBuffData = {
    ...
    "원더": [
              { id: "wonder1", type: "스킬", type_en: "Skill", type_jp: "スキル", target: "단일", target_en: "Single", target_jp: "単体", skillIcon: "/assets/img/skill-element/버프.png", skillName: "리벨리온", skillName_en: "Rebellion", skillName_jp: "リベリオン", options: [], value: 15.7, duration: "3턴", note: "원더 크리티컬 확률 40% 이상", note_en: "Wonder critical rate 40% or above", note_jp: "ワンダーCRT発生率40%以上" },
              { id: "wonder2", type: "스킬", type_en: "Skill", type_jp: "スキル", target: "광역", target_en: "Multi", target_jp: "複数対象", skillIcon: "/assets/img/skill-element/버프광역.png", skillName: "레볼루션", skillName_en: "Revolution", skillName_jp: "レボリューション", options: [], value: 10.9, duration: "3턴", note: "원더 크리티컬 확률 40% 이상", note_en: "Wonder critical rate 40% or above", note_jp: "ワンダーCRT発生率40%以上" },
              ...
              { id: "wonder8", type: "페르소나", type_en: "Persona", type_jp: "ペルソナ", target: "광역", target_en: "Multi", target_jp: "複数対象", skillIcon: "/assets/img/tactic-persona/마카브르.webp", skillName: "마카브르 - 고유 스킬", skillName_en: "Macabre - Unique Skill", skillName_jp: "マカーブル - 特殊スキル", options: [], value: 10, duration: "3턴", note: "지배", note_en: "Sweeper", note_jp: "支配" }
