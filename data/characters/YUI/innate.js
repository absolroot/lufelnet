    ...
    "innate_awake_skill": [
        {
            ...
            "cooldown": 0,
            "cost": "",
            "desc": "YUI가 추격을 발동하는 고정 확률이 45.0% 증가하고, 추격 발동 시 크리티컬 효과가 15.0% 증가한다.\n『초희귀 보상』이 제공하는 강화 추격 횟수가 3회로 증가한다.",
            "desc_en": "The fixed probability of YUI's Follow-up increases by 45.0%. When the Follow-up is triggered, the CRIT Mult increases by 15.0%. The number of Follow-up times increased by 3 times by the 'Sparky Surprise'.",
            "desc_jp": "YUIの追撃発生確率が45.0%上昇し、追撃発生時にCRT倍率が15.0%上昇します。\n『サプライズプレゼント』により追撃回数が3回増加します。",
            "desc_cn": "YUI发动追击的固定概率提升45.0%，触发追击时，暴击效果提升15.0%。\n『超稀有奖励』提供的强化追击次数提升为3次。",
            "level": "3",
            "name": "스포트라이트",
            "name_en": "Spotlight",
            "name_jp": "追光",
        ...
        },
        {
            ...
            "cooldown": 0,
            "cost": "",
            "desc": "자신의 추가 효과 증폭이 자신의 의식 레벨*3%만큼 증가한다. YUI가 필드에 있을 때, 모든 다른 동료는 해당 효과의 25% 버프를 획득한다. 강화 추격의 스킬 대미지가 1.0%+자신의 의식 레벨*6%만큼 추가로 증가한다.",
