...
window.characterSkillsData["YUI·스텔라"] = {
  "name": "YUI·스텔라",
  "skill1": {
    "name": "우주 대난투",
    "element": "핵열",
    ...
    "sp": 22,
    "cool": 0,
    "description": "1명의 적에게 공격력 100.7%/111.0%/106.9%/117.2%의 핵열 속성 대미지를 주고, 자신이 『원동력』을 3포인트 획득하며, 『대난투』 상태에 진입한다. 효과는 2턴 동안 지속된다.\n『대난투』: 자신의 턴 종료 시 추가 효과 『베지나이츠·출격』을 발동해 모든 베지나이츠를 소집하고, 임의의 적 1명에게 공격력 93.5%/103.1%/99.2%/108.8%의 핵열 속성 대미지를 준다. 또한 현재 색깔 상태에 따라 아래 효과를 추가로 발동한다.\n『<span style='color:rgb(184, 33, 214);'>보라 가지</span>』 상태일 경우 『원동력』을 1포인트 획득한다.\n『<span style='color:#C7BE5A;'>노란 감자</span>』 상태일 경우 자신이 『줄기의 힘』을 획득해 3턴 동안 총공격 대미지가 14.6%/16.1%/15.5%/17.0% 증가한다.\n『<span style='color:rgb(254, 149, 244);'>분홍 버섯</span>』 상태일 경우 스킬 목표가 『버섯 포자』를 획득해 2턴 동안 받는 대미지가 19.5%/21.5%/20.7%/22.7% 증가한다.\n『<span style='color:rgb(11, 190, 11);'>초록 아스파라거스</span>』 상태일 경우 생명이 가장 낮은 동료의 생명을 976/1076/1036/1136포인트 회복한다.\n해당 스킬 시전 후 자신이 감자 나이트를 보유한 경우, 턴 종료 시 자동으로 『<span style='color:#C7BE5A;'>노란 감자</span>』 상태가 된다."
  },
  "skill2": {
    "name": "베지나이츠·집합",
    "element": "버프",
    ...
    "sp": 0,
    "cool": 1,
    "description": "2턴 동안 자신의 공격력이 19.5%/21.5%/20.7%/22.7% 증가하고, 크리티컬 확률이 11.7%/12.9%/12.4%/13.6% 증가한다. 또한 특정 순서에 따라 베지나이츠를 1개 소환한다. 이 스킬 사용 후 해당 턴에서 다른 스킬을 사용할 수 있으며, 해당 스킬은 페르소나 스킬로 간주하지 않는다.\n패시브: 자신의 턴 시작 시, 특정 순서에 따라 자동으로 베지나이츠를 1개 소환한다.\n가지 나이트, 버섯 나이트, 아스파라거스 나이트는 최대 1개, 감자 나이트는 최대 4개까지 보유할 수 있다."
  },
  "skill3": {
    "name": "베지나이츠·총동원",
    "element": "핵열",
    ...
    "sp": 23,
    "cool": 0,
    "description": "1명의 적에게 공격력 104.3%/115.0%/110.7%/121.4%의 핵열 속성 대미지를 준다. 보유한 베지나이츠 1개마다 추가로 공격력 29.3%/32.3%/31.1%/34.1%의 핵열 속성 대미지를 1회 준다. 감자 나이트를 2개 이상 보유 시, 초과된 감자 나이트를 소모하며, 소모된 감자 나이트 1개마다 추가로 공격력 24.4%/26.9%/25.9%/28.4%의 핵열 속성 대미지를 1회 준다. 해당 스킬 대미지는 총공격 대미지로 간주한다. 액티브로 해당 스킬 시전 시 자신은 『원동력』을 2포인트 획득한다.\n패시브: 『원동력』이 7포인트에 도달하면 모든 『원동력』을 소모하여 적에게 『베지나이츠·총동원』의 대미지 효과를 준다. 해당 대미지는 적 전체가 분담하며, 페르소나 스킬 대미지로 간주하지 않는다.\n해당 스킬 시전 후 자신이 가지 나이트를 보유한 경우, 턴 종료 시 자동으로 『<span style='color:rgb(184, 33, 214);'>보라 가지</span>』 상태가 된다.\n\n<table border='1' cellspacing='0' cellpadding='5'><thead><tr><th>베지 나이츠</th><th>1기</th><th>2기</th><th>3기</th><th>4기</th></tr></thead><tbody><tr><td>스킬 계수</td><td>133.6%/147.3%/141.8%/155.5%</td><td>162.9%/179.6%/172.9%/189.6%</td><td>192.2%/211.9%/204.0%/223.7%</td><td>221.5%/244.2%/235.1%/257.8%</td></tr></tbody><thead><tr><th>베지 나이츠</th><th>5기</th><th>6기</th><th>7기</th><th>8기</th></tr></thead><tbody><tr><td>스킬 계수</td><td>275.2%/303.4%/292.1%/320.3%</td><td>328.9%/362.6%/349.1%/382.8%</td><td>382.6%/421.8%/406.1%/445.3%</td><td>436.3%/481.0%/463.1%/507.8%</td></tr></tbody></table>"
  },
  "skill_highlight": {
    "element": "핵열",
    "type": "단일피해",
    "description": "1명의 적에게 공격력 439.2%/484.2%/466.2%/511.2%의 핵열 속성 대미지를 주고, 즉시 특정 규칙에 따라 해당 적에게 『베지나이츠·출격』을 발동한다.",
    "cool": 4
  },
  "passive1": {
    "name": "쌍성",
    "element": "패시브",
    "description": "전투 중 베지나이츠를 1개 보유할 때마다 YUI·스텔라의 주는 대미지가 8.1% 증가하고, 최대 4개의 베지나이츠까지 적용된다.",
    "cool": 0
  },
  "passive2": {
    "name": "찬란",
    "element": "패시브",
    "description": "총공격 대미지가 15.0% 증가한다.\n총공격 참여 시, 해당 회차 총공격 대미지는 YUI·스텔라가 보유한 베지나이츠 총 수량에 기반하여 추가로 증가한다.",
    "cool": 0
  }
};
...
window.cnCharacterSkillsData["YUI·스텔라"] = {
  ...
  "skill1": {
    ...
    "sp": 22,
    "cool": 0,
    "description": "对1名敌人造成100.7%/111.0%/106.9%/117.2%攻击力的核热属性伤害，自身获得3点『源动力』，并进入『大乱斗』状态，持续2回合。\n『大乱斗』：自身回合结束时，发动追加效果『蔬菜骑士·出击』，号召所有蔬菜骑士对随机1名敌人造成93.5%/103.1%/99.2%/108.8%攻击力的核热属性伤害，并根据当前的色彩状态，额外发动下述效果：\n处于『茄之紫』状态，获得1点『源动力』；\n处于『薯之黄』状态，使自身获得『块茎之力』，『总攻击伤害』提升14.6%/16.1%/15.5%/17.0%，持续3回合；\n处于『菇之粉』状态，使技能目标获得『蘑菇孢子』，受到伤害提升19.5%/21.5%/20.7%/22.7%，持续2回合；\n处于『笋之绿』状态，使生命值最低的同伴恢复976/1076/1036/1136点生命值。\n释放该技能后，若自身拥有土豆骑士，回合结束时自动变幻为『薯之黄』状态。"
  },
  "skill2": {
    "name": "蔬菜骑士·集合",
    "element": "버프",
    ...
    "sp": 0,
    "cool": 1,
    "description": "使自身攻击力提升19.5%/21.5%/20.7%/22.7%、暴击率提升11.7%/12.9%/12.4%/13.6%，持续2回合，并按照特定顺序召唤一个蔬菜骑士。使用该技能后本回合仍可使用其他技能，该技能不视为人格面具技能。\n被动：自身回合开始时，自动按照特定顺序召唤一个蔬菜骑士。\n茄子骑士、蘑菇骑士、芦笋骑士最多拥有1个，土豆骑士最多拥有4个。"
  },
  "skill3": {
    "name": "蔬菜骑士·总动员",
    "element": "핵열",
    ...
    "sp": 23,
    "cool": 0,
    "description": "对1名敌人造成104.3%/115.0%/110.7%/121.4%攻击力的核热属性伤害，每拥有1个蔬菜骑士，额外对其造成1次29.3%/32.3%/31.1%/34.1%攻击力的核热属性伤害，拥有土豆骑士≥2个时，会消耗额外的土豆骑士，每消耗1个土豆骑士额外造成1次24.4%/26.9%/25.9%/28.4%攻击力的核热属性伤害，该技能伤害视为总攻击伤害。主动释放该技能时自身获得2点『源动力』。\n被动：『源动力』达到7点时，可以消耗所有『源动力』对敌人造成『蔬菜骑士·总动员』的伤害效果，该伤害由所有敌人平均分摊，不视为人格面具技能伤害。\n释放该技能后，若自身拥有茄子骑士，回合结束时自动变幻为『茄之紫』状态。"
  },
  "skill_highlight": {
    "element": "핵열",
    "type": "单体伤害",
    "description": "对1名敌人造成439.2%/484.2%/466.2%/511.2%攻击力的核热属性伤害，并立刻按照特定规则对该敌人发动『蔬菜骑士·出击』。",
    "cool": 4,
    "name": "HIGHLIGHT"
  },
  "passive1": {
    "name": "伴星",
    "element": "패시브",
    "description": "战斗中，每拥有1个蔬菜骑士，YUI·幻彩造成伤害提升8.1%，最多计入4个蔬菜骑士。",
    "cool": 0
  },
  "passive2": {
    "name": "灿烂",
    "element": "패시브",
    "description": "『总攻击伤害』提升15.0%。\n参与总攻击时，该次总攻击伤害会基于YUI·幻彩拥有的蔬菜骑士总数量额外提高。",
    "cool": 0
  }
};
