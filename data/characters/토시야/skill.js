...
window.cnCharacterSkillsData["토시야"] = {
  "name": "须见俊也",
  "skill1": {
    "name": "哀痛悲剧",
    "element": "주원",
    "sp": 22,
    "cool": 0,
    "description": "对1名敌人造成3次58.6%/64.6%/61.0%/67.0%攻击力的诅咒伤害并且本次攻击获得3个『憎恨诗句』，\n接下来获得『诗句』时25%的固定概率转变为『憎恨诗句』，最多触发2次\n每层『憎恨诗句』使得『命运的十四行诗』以30%的基础概率附着诅咒效果。"
  },
  "skill2": {
    "name": "荒诞喜剧",
    "element": "주원",
    "sp": 20,
    "cool": 0,
    "description": "对所有敌人造成2次35.7%/39.3%/37.1%/40.8%攻击力的诅咒伤害并且本次攻击获得2个『疗愈诗句』，\n接下来获得『诗句』时25%的固定概率转变为『疗愈诗句』，最多触发2次\n每层『疗愈诗句』使得『命运的十四行诗』恢复生命值最低的同伴7.5%攻击力的生命值。"
  },
  "skill3": {
    "name": "浪漫正剧",
    "element": "주원",
    "sp": 22,
    "cool": 0,
    "description": "对1名敌人造成5次41.5%/45.7%/43.2%/47.4%攻击力的诅咒伤害并且本次攻击获得5个『热情诗句』，\n接下来获得『诗句』时25%的固定概率转变为『热情诗句』，最多触发2次\n每层『热情诗句』使得『命运的十四行诗』附加7%攻击力的万能伤害。"
  },
  "passive1": {
    "name": "丧钟",
    "element": "패시브",
    "cool": 0,
    "description": "『命运的十四行诗』对诅咒异常状态下敌人伤害提升50.0%。"
  },
  "passive2": {
    "name": "咒言",
    "element": "패시브",
    "cool": 0,
    "description": "『命运的十四行诗』中每有一个特殊『诗句』，增加本次伤害10.0%。"
  },
  "skill_highlight": {
    "element": "주원",
    "cool": 4,
    "description": "对1名敌人造成3次96.8%/106.7%/100.8%/110.7%攻击力的诅咒伤害，使得接下来2次『命运的十四行诗』额外造成50.6%/55.7%/52.6%/57.8%攻击力的伤害。"
  }
};
