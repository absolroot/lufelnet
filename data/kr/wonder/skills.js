...
const personaSkillList = {
    ...
    "지온가": {
        ...
        description_jp: "敵単体に攻撃力114.0%の電撃属性ダメージを与える。63.3%の確率で敵を2ターンの間、感電状態にする。",
    ...
    "마하지오다인": {
        ...
        description_jp: "敵全体に攻撃力60.8%の電撃属性ダメージを与える。33.8%の確率で敵を2ターンの間、감電状態にする。",
    ...
    "갈": {
        ...
        description_en: "Deals 106.2% ATK Wind dmg to 1 foe and has a 59.0% chance of inflicting Windswept for 2 turns.",
        type: "공격",
        target: "단일",
        icon : "질풍",
        effects: [
    ...
    "갈라": {
        ...
        description_jp: "敵単体に攻撃力114.0%の疾風属性ダメージを与える。63.3%の確率で敵を2ターンの間、風襲状態にする。",
        description_en: "Deals 114.0% ATK Wind dmg to 1 foe and has a 63.3% chance of inflicting Windswept for 2 turns.",
        type: "공격",
        target: "단일",
        icon : "질풍",
        effects: [
    ...
    "갈다인": {
        ...
        description_en: "Deals 121.7% ATK Wind dmg to 1 foe and has a 67.6% chance of inflicting Windswept for 2 turns.",
        type: "공격",
        target: "단일",
        icon : "질풍",
        effects: [
    ...
    "마하갈라": {
        ...
        description_en: "Deals 57.0% ATK Wind dmg to all foes and has a 31.7% chance of inflicting Windswept for 2 turns.",
        type: "공격",
        target: "전체",
        icon : "질풍광역",
        effects: [
    ...
    "마하갈다인": {
        ...
        description_jp: "敵全体に攻撃力60.8%の疾風属性ダメージを与える。33.8%の確率で敵を2ターンの間、風襲状態にする。",
        description_en: "Deals 60.8% ATK Wind dmg to all foes and has a 33.8% chance of inflicting Windswept for 2 turns.",
        type: "공격",
        target: "전체",
        icon : "질풍광역",
        effects: [
    ...
    "하마온": {
        ...
        description_jp: "敵単体に攻撃力90.6%の祝福属性ダメージを与える。HP 50%以下の敵に低確率で祝福属性の即死効果を与える。敵のHPが低いほど確率が上がる。",
        type: "공격",
        target: "단일",
        icon : "축복",
        effects: [
    ...
    "마한마": {
        ...
        description_jp: "敵全体に攻撃力39.9%の祝福属性ダメージを与える。HP 50%以下の敵に低確率で祝福属性の即死効果を与える。敵のHPが低いほど確率が上がる。",
        type: "공격",
        target: "전체",
        icon : "축복광역",
        effects: [
    ...
    "마하무드": {
        ...
        description_jp: "敵全体に攻撃力39.9%の呪怨属性ダメージを与える。HP 50%以下の敵に低確率で呪怨属性の即死効果を与える。敵のHPが低いほど確率が上がる。",
        type: "공격",
        target: "전체",
        icon : "주원광역",
        effects: [
    ...
    "스쿠카쟈": {
        ...
        description_jp: "3ターンの間、味方単体の命中・回避が9.3%上昇する。自身の状態異常命中25%ごとに、味方の命中・回避がさらに1.6%上昇する（最大6.4%まで）。",
        type: "지원",
        target: "단일",
        icon : "버프",
        effects: [
    ...
    "마하스쿠카쟈": {
        ...
        description_jp: "3ターンの間、味方全体の命中・回避が6.5%上昇する。自身の状態異常命中25%ごとに、味方の命中・回避がさらに1.1%上昇する（最大4.4%まで）。",
        type: "지원",
        target: "전체",
        icon : "버프광역",
        effects: [
