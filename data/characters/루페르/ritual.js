...
window.ritualData["루페르"] = {
  "name": "루페르",
  "r0": "뒤바뀐 밤낮",
  "r0_detail": "치료 스킬을 사용하면 목표 동료가 『별의 불꽃』 효과를 획득하며 모든 동료는 『별의 불꽃』 관련 효과를 최대 1개 보유할 수 있다.\n『별의 불꽃I』: 1턴 동안 공격력이 루페르 공격력의 4%(최대 160 공격력)만큼 증가하며 효과 종료 후 『별의 불꽃II』로 승급한다.\n『별의 불꽃II』: 1턴 동안 공격력이 루페르 공격력의 8%(최대 320 공격력)만큼 증가한다.",
  "r1": "270° 회전",
  ...
  "r3": "사냥감 출현",
  "r3_detail": "『별의 불꽃II』이 추가 효과를 획득한다. 해당 상태의 동료가 받는 치료 효과가 10% 증가한다.",
  "r4": "소리 없는 기습",
  "r4_detail": "『천사의 연민』, 『전투 기술』 스킬 레벨이 2레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r5": "발톱의 돌격",
...
window.jpCharacterRitualData["루페르"] = {
  "name": "ルフェル",
  "r0": "赤毛の英雄",
  "r0_detail": "回復スキル使用時に選択した味方を１ターンの間、『星火Ⅰ』状態にする。さらに『星火Ⅰ』状態が終了した時、１ターンの間『星火Ⅱ』状態にする。\n『星火Ⅰ』：攻撃力がルフェルの攻撃力４%分上昇する（最大１６０まで）。\n『星火Ⅱ』：攻撃力がルフェルの攻撃力８%分上昇する（最大３２０まで）。\n※『星火』は累積せず、１つのみ付与される。",
  "r1": "フクロウの視界",
...
window.cnCharacterRitualData["루페르"] = {
  "name": "路菲尔",
  "r0": "昼夜颠倒",
  "r0_detail": "使用治疗技能时，使目标同伴获得『星之火』效果，每个同伴至多拥有一个『星之火』相关效果。\n『星之火I』：攻击力提升，相当于路菲尔攻击力的4%（最多提升160攻击力），效果持续1回合，效果结束时升级为『星之火II』。\n『星之火II』：攻击力提升，相当于路菲尔攻击力的8%（最多提升320攻击力），效果持续1回合。",
  "r1": "270°旋转",
  "r1_detail": "战斗开始时有100%基础概率使生命值最高的敌人陷入燃烧状态。\n处于任意『星之火』状态下的同伴，造成元素异常时，效果命中提升33%。",
  "r2": "耳羽轻颤",
  "r2_detail": "『雀跃火枭』、『希望光束』的技能等级提升2级，至多提升至15级。",
  "r3": "猎物现身",
  "r3_detail": "『星之火II』获得额外效果，处于该状态下的同伴受到治疗效果提升10%。",
  "r4": "无声偷袭",
  "r4_detail": "『天使的怜悯』、『战斗技巧』的技能等级提升2级，至多提升至15级。",
  "r5": "利爪突击",
  "r5_detail": "HIGHLIGHT效果提升：使所有同伴造成的火焰属性伤害提升32%，效果持续1回合",
  "r6": "满载而归",
