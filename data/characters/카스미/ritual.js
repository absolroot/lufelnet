...
window.ritualData["카스미"] = {
  ...
  "r6": "모든 틈과 모든 문",
  "r6_detail": "자신이 HIGHLIGHT를 시전한 후 『가면무도회』 상태 종료 전까지 HIGHLIGHT를 1회 추가로 시전할 수 있으며, 대미지는 고유 HIGHLIGHT의 70%다. 해당 효과는 매회 『가면무도회』 상태 지속 기간 동안 1회만 발동된다."
};
