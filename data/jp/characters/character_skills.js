const jpCharacterSkillsData = {
    ...
    "리코·매화": {
        ...
        "skill1": {
            ...
            "type":"単体ダメージ",
            "cool": 0,
            "description": "敵1体に183.0%/201.7%/194.3%/213.0%の疾風属性ダメージを与え、100%の基礎確率で2ターンの間、風溢状態にする。さらに目標を『落花』状態にし、疾風属性ダメージを受ける際、100%を超える理子・生命欲の暴走のCRT倍率の18.3%分（最大388.0%/418.0%/418.0%/448.0%CRT倍率）が追加され、2ターン持続する。\n理子・生命欲の暴走はSPを16回復する。"
        },
        "skill2": {
            "name": "傘下の梅",
            "element": "버프광역",
            "type":"バフ",
            "cool": 0,
            "description": "2ターンの間、全味方の攻撃力が100%を超える理子・生命欲の暴走のCRT倍率の12.8%分（最大388.0%/418.0%/418.0%/448.0%CRT倍率）上昇し、SPを4回復する。\n期間中、任意の味方がペルソナスキル／追加効果／HIGHLIGHTダメージを与えると、理子・生命欲の暴走はSPを12回復する（1回限定）。"
        },
        "skill3": {
            "name": "梅香の残響",
            "element": "버프",
        ...
        "skill_highlight": {
            "element": "버프",
            "type":"バフ",
            "description": "2ターンの間、自分以外の味方1人の攻撃力を上昇させ（100%を超える理子・生命欲の暴走のCRT倍率1%ごとに攻撃力+2.5、最大388.0%/418.0%/418.0%/448.0%CRT倍率を適用）、CRT倍率を24.4%/26.9%/25.9%/28.4%上昇させる。\nさらに、自分以外の全味方のSPを20回復する。"
        },
        "passive1": {
            "name": "満開",
            "element": "패시브",
            "description": "『梅香の残響』使用後、スキルメイン対象は2ターンの間『蕾』状態を獲得する。\nスキルダメージを与えるごとに『開花』を1スタック獲得し、攻撃力+30、3ターン持続（最大10スタック）。\n『開花』が5スタックに達すると、100%を超える理子・生命欲の暴走のCRT倍率の8.0%分攻撃力が上昇し、さらに5.0%分CRT倍率が上昇する。\n『開花』が10スタックに達すると、さらに5.0%分CRT倍率が上昇する。"
        },
        "passive2": {
            "name": "活力",
            "element": "패시브",
