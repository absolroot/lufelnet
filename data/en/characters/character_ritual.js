const enCharacterRitualData = {
    ...
    "YUI·스텔라": {
        "name": "YUI·Chromatic",
        "r0": "Boom Bang Sprouting Army!",
        "r0_detail": "BUI - Chromatic is able to summon Eggplants, Potatoes, Mushrooms, and Asparagus-typed [Veggie Knights] and stack up [Originium Force]. When [Originium Force] is sufficient, BUI - Chromatic can call upon the [Veggie Knights] and cast [Veggie Knights, Full Out!] to foes. The skill DMG is considered as All-Out Attack DMG.\nWhen BUI - Chromatic has a [Veggie Knights], she can accordingly turn her Phantom Idol Outfit to match the said Knight’s color at the start of her turn, and can gain the following effect boost based on the colors:\n\n- [<span style='color:rgb(184, 33, 214);'>Earthy Eggplants</span>]: After casting a Persona Skill, additionally gain 1 [Originium Force].\n- [<span style='color:#C7BE5A;'>Primrose Potatoes</span>]: Increase All-Out Attack DMG by 15%.\n- [<span style='color:rgb(254, 100, 238);'>Magenta Mushrooms</span>]: When dealing DMG with Persona Skills or All-Out Attacks, there is a 4.5% base chance to inflict the foes hit with Brainwash for 1 turn.\n- [<span style='color:rgb(11, 190, 11);'>Aquamarine Asparagus</span>]: When dealing DMG with Persona Skills or All-Out Attacks, recover 1% of the DMG Dealt as HP, up to 1000 HP Recovered for each attack.",
        "r1": "Cosmic Defense Warfare",
        "r1_detail": "BUI - Chromatic will summon 4 distinct typed [Veggie Knights] and gain maximum stacks of [Originium Power] at the start of the battle.\nIncrease CRIT DMG by 8% for each [Veggie Knight] held, up to 5 [Veggie Knight]s.\nAt the start of the battle, BUI - Chromatic will be at [<span style='color:#C7BE5A;'>Primrose Potatoes</span>] form. After her first turn begins, she will automatically change to [<span style='color:rgb(184, 33, 214);'>Earthy Eggplants</span>] form.",
        "r2": "The Last Potato",
        "r2_detail": "BUI - Chromatic will additionally hold a non-depleting [<span style='color:#C7BE5A;'>Potato Knight</span>]. \nAdditionally increase the All-Out Attack DMG from [Spud Power] gained from casting [Veggie Knights, Attack!] by 10%, and gain [Spud Power] at the start of the battle for 2 turns.",
        "r3": "Dark Farmland Theory",
        "r3_detail": "[Veggie Knights, Assemble!] Lv. +3, up to a maximum of Lv. 15.\n[Veggie Knights, Full Out!] Lv. +3, up to a maximum of Lv. 15.",
        "r4": "The Hitchhiker's Guide to the Galaxy",
        "r4_detail": "HIGHLIGHT Effect Boost: Increase ATK by 35% for 4 turns.",
        "r5": "Time-Transcending Armada",
        "r5_detail": "[Cosmic Clash!] Lv. +3, up to a maximum of Lv. 15.\n[Thief Tactics] Lv. +3, up to a maximum of Lv. 15.",
        "r6": "Celebrate, the Extraterrestrial Parade!",
                // gradient (#9A0BB5)(#C7BE5A)(#FF00E4)(#4ECC4F)
        "r6_detail": "Unlocks the [<span style='background:linear-gradient(to right,rgb(184, 33, 214), #C7BE5A,rgb(254, 100, 238),rgb(11, 190, 11)); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; color:transparent;'>Prismatic Plume</span>] form, which has the effects of [<span style='color:rgb(184, 33, 214);'>Earthy Eggplants</span>], [<span style='color:#C7BE5A;'>Primrose Potatoes</span>], [<span style='color:rgb(254, 100, 238);'>Magenta Mushrooms</span>], and [<span style='color:rgb(11, 190, 11);'>Aquamarine Asparagus</span>].\nEnter [Chaotic Clash!] permanently at the start of the battle. \n[Chaotic Clash!] Effect Modification: Cast the Follow-Up Action [Veggie Knights, Attack!] after every ally’s action.\nWhen casting [Veggie Knights, Assemble!] manually, additionally summon 1 [Potato Knight]."
    },    
    "카타야마": {
        "name": "Kumi Katayama",
