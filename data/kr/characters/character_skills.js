const characterSkillsData = {
    ...
    "미츠루": {
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "1명의 적에게 공격력의 211.2%/232.8%/224.2%/245.8%의 빙결 속성 피해를 주고, 추가로 『서리 결속』 3중첩을 부여한다.또한 방어력을 감소시키며, 미츠루의 공격력 300pt당 방어력 감소량이 1.2% × 『서리 결속』 중첩 수로 계산된다.\n이 효과는 최대 공격력 2928/3228/3108/3408pt까지 반영되며, 지속시간은 2턴이다."
        },
        "skill2": {
            "name": "극한의 폭풍",
            "element": "빙결", 
            "type": "단일피해",
            "sp": 0, 
            "description": "1명의 적을 『여왕의 응시』 상태로 만든다. 방어력이 7.8%/8.6%/8.3%/9.1% 감소하며,미츠루의 공격력 300pt당 방어력은 추가로 3.2%, 받는 피해는 2% 증가한다.\n이 효과는 최대 공격력 2928/3228/3108/3408pt까지 반영되며, 전투 중 영구 지속된다.\n\n『여왕의 응시』는 전장에 하나만 존재한다. 새로운 적에게 사용 시, 기존 대상의 상태가 새로운 적에게 이동된다. 만약『여왕의 응시』상태의 적이 사망하면, 현재 체력이 가장 높은 적에게 자동으로 이동하며 이동 시 미츠루가 부여한 모든 이상 상태도 함께 이동한다. 이 스킬 사용 후에도 다른 스킬을 사용할 수 있으며 페르소나 스킬로 간주되지 않는다."
        },
        "skill3": {
            "name": "얼음의 무도",
            "element": "빙결",
            ...
            "sp": 24,
            "cool": 0,
            "description": "해명 괴도 각 속성의 3%만큼 출전 중인 모든 동료의 상응한 속성 수치가 2턴 동안 증가한다. 그 후 1명의 적에게 공격력의 345.1%/380.5%/366.3%/401.7%의 빙결 속성 피해를 준다. 대상에게 부여된 『서리 결속』 1중첩당 스킬 피해가 10% 상승하고『서리 결속』이 5중첩에 도달하면 크리티컬 확률이 15% 추가 상승한다."
        },
        "skill_highlight": {
            "name": "테우르기아 - 블리자드 에지",
            "element": "빙결",
            "type": "단일피해",
            "description": "발동 조건 : 테우르기아 에너지 70\n1명의 적에게 공격력의 371.2%/408.3%/415.7%/452.9%의 빙결 속성 피해를 준다. 2턴 동안 대상의 『서리 결속』을 『혹한 결속』으로 강화한다.\n아군이 페르소나 스킬로 『혹한 결속』 상태의 적을 공격하면 미츠루의 『냉혈의 칼날』이 발동되어, 『서리 결속』 중첩 수 × 20.0%/22.0%/22.4%/24.4% 공격력의 추가 피해를 1회 준다."
        },
        "skill_support": {
            "name": "지원 기술",
            "element": "디버프",
        ...
        "passive1": {
            "name": "책임",
            "element": "패시브",
            "description": "해명 괴도의 초기 준비 시간이 4턴 감소한다."
        },
        "passive2": {
            "name": "질서",
            "element": "패시브",
            "description": "미츠루가 전장에 있을 때, 모든 반항 또는 지배 타입 캐릭터가 『서리 결속』이 부여된 적을 공격하면 『서리 결속』 중첩 수 × 4.8%의 대미지 증가 효과를 얻는다."
        }
