...
window.cnCharacterRitualData["아케치"] = {
  "name": "明智吾郎",
  "r0": "行走于迷雾之中",
  "r0_detail": "战斗开始时，使攻击力最高的同伴成为『侦探伙伴』（优先选择支配或反抗怪盗，若场上无支配或反抗怪盗则选择自己），回合开始时可以重新选择『侦探伙伴』（同时只能存在1名『侦探伙伴』，重新选择后有1回合的冷却时间）。自身获得『侦探伙伴』25%的攻击力，上限500/750/1000（1/50/70级时升级）。当选择『侦探伙伴』为除自身以外同伴时，『侦探伙伴』释放群体人格面具技能/HIGHLIGHT/神通法/追加效果造成伤害时，记录其对敌方单位造成的平均伤害（若为单体技能，则记录其对主目标伤害的40%）。明智吾郎回合开始时，根据记录的总伤害获得1层『清晰之矢』并清空所记录的伤害，『清晰之矢』持续2回合；当选择『侦探伙伴』为自身时，『黄金箭雨·湮灭』的技能效果发生转变，『清晰之矢』基于『混沌之箭』的技能倍率造成额外万能伤害。",
  "r1": "嫌疑侦查",
  ...
  "r4": "真假难辨",
  "r4_detail": "HIGHLIGHT效果提升：额外使自身『混沌之箭』的伤害提高30%，持续4回合。",
  "r5": "异路同行",
