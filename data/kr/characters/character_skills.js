const characterSkillsData = {
    ...
    "카타야마":{
        ...
        "skill1": {
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 101.7%/112.1%/108.0%/118.4% 공격력의 전격 속성 대미지를 주고 대상에게 『중상』 효과를 2턴 동안 부여한다.\n『중상』: 방어력이 9.8% / 10.8% / 10.4% / 11.4% 감소하며 카타야마 쿠미의 속도 10pt마다 추가로 2.22% 감소한다(최대 39.0% / 43.0% / 41.4% / 45.4%.) 받는 대미지가 7.8%/8.6%/8.3%/9.1% 증가하며 카타야마 쿠미의 속도 10pt마다 추가로 1.78% 증가한다 (최대 31.2%/34.4%/33.2%/36.4%).\n자신이 『초극한』 상태라면 이번 스킬의 피해가 추가로 30% 증가한다.\n이 스킬 사용 후 『오의·섬광각』을 해제한다."
        },
        "skill2": {
            "name": "심판의 뇌격",
            "element": "전격광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 135.5%/149.3%/143.8%/157.7% 공격력의 전격 속성 대미지를 준다. 대미지를 입히면 약점에 상관없이 적의 다운 수치 1을 감소시키고, 대상에게 『중상』 효과를 1턴 동안 부여한다.\n『중상』: 방어력이 9.8% / 10.8% / 10.4% / 11.4% 감소하며 카타야마 쿠미의 속도 10pt마다 추가로 2.22% 감소한다(최대 39.0% / 43.0% / 41.4% / 45.4%.) 받는 대미지가 7.8%/8.6%/8.3%/9.1% 증가하며 카타야마 쿠미의 속도 10pt마다 추가로 1.78% 증가한다 (최대 31.2%/34.4%/33.2%/36.4%).\n자신이 『초극한』 상태일 경우, 대상의 다운 수치 3을 추가로 감소시키며, 추가로 『격파』 효과를 1턴 동안 부여한다.\n『격파』: 『다운 특수 공격』이 카타야마 쿠미의 속도 10pt마다 0.56% 증가한다 (최대 9.8%/10.8%/10.4%/11.4%). 받는 대미지가 카타야마 쿠미의 속도 10pt마다 1.33% 증가한다 (최대 23.4%/25.8%/24.9%/27.3%)."
        },
        "skill3": {
            "name": "오의·섬광각",
            "element": "전격광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 141.9%/156.5%/150.6%/165.2% 공격력의 전격 속성 대미지를 준다. 대미지를 입히면 약점에 상관없이 적의 다운 수치를 5 깎고, 대상에게 『격파』 효과를 1턴 동안 부여한다.\n『격파』: 『다운 특수 공격』이 카타야마 쿠미의 속도 10pt마다 0.56% 증가한다 (최대 9.8%/10.8%/10.4%/11.4%). 받는 대미지가 카타야마 쿠미의 속도 10pt마다 1.33% 증가한다 (최대 23.4%/25.8%/24.9%/27.3%).\n이 스킬이 적을 다운시키면, 자신은 『초극한』 상태를 얻으며 2턴 동안 지속된다.\n『초극한』: 다음 『격정 회전참』 및 『심판의 뇌격』의 효과가 강화된다."
        },
        "skill_highlight": {
            "name": "",
            "element": "전격광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 317.6%/350.1%/337.1%/369.7% 공격력의 전격 속성 대미지를 입히고, 50%의 기본 확률로 적을 감전 상태에 빠뜨린다 (1턴 지속).\nHIGHLIGHT 발동 후, 자신이 다음에 적을 다운시킬 경우 해당 적의 방어력을 영구적으로 29.3%/32.3%/31.1%/34.1% 감소시킨다. (이 효과는 중첩 불가)"
        },
        "passive1": {
            "name": "훈계",
            "element": "패시브",
            "description": "아군이 다운 상태의 적을 공격할 때, 공격력이 30.0% 증가한다."
        },
        "passive2": {
            "name": "열혈",
            "element": "패시브",
            "description": "전투 중, 자신의 속도가 100pt 이상일 경우 100을 초과한 매 1pt 속도마다 공격력이 24 증가한다. (최대 1920)"
        }
    },
