...
window.ritualData["하루나"] = {
  ...
  "r1": "갈림길! 선택!",
  "r1_detail": "동료가 스킬을 사용해 대미지를 줄 때 니시모리의 공격력이 20% 증가하며(3회 중첩 가능), 다음 턴에 스킬을 사용한 후 해당 효과가 사라진다. 공격력 증가 효과가 2중첩 도달 시, 1턴 동안 모든 동료의 대미지가 15% 증가한다.",
  "r2": "경험치! 획득!",
...
window.cnCharacterRitualData["하루나"] = {
  "name": "西森阳菜",
  "r0": "寻宝！出发！",
  "r0_detail": "西森释放人格面具技能时，消耗所有『童趣』，每消耗1层『童趣』使所有同伴攻击力提升8%，效果持续2回合。『童趣』上限5层。",
  "r1": "岔路！选择！",
  "r1_detail": "同伴释放技能造成伤害时，使西森攻击力提升20%，上限3层，下1回合释放技能后清除该效果。当攻击力提升效果达到2层时，所有同伴伤害提升15%，持续1回合。",
  "r2": "经验！获得！",
  "r2_detail": "『旺盛童心』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r3": "助手！升级！",
  "r3_detail": "通过『追疑』获得『童趣』的固定概率提升20%。释放『旺盛童心』技能时，若『童趣』为满层，则额外提升所有同伴24%攻击力、24%暴击效果。",
  "r4": "装备！强化！",
  "r4_detail": "『笨笨的助手』、『聪明的探险家』的技能等级提升3级，至多提升至15级。",
  "r5": "怪物！打倒！",
  "r5_detail": "HIGHLIGHT效果提升：伤害提升效果延长至2回合。",
  "r6": "谜题！解开！",
