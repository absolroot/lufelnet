...
window.ritualData["유카리"] = {
  ...
  "r1": "당겨진 활시위",
  "r1_detail": "전투 시작 시 자신이 『바람의 언어』를 최대 중첩까지 획득하고 테우르기아 에너지를 70포인트 회복한다. 첫 턴에 테우르기아 에너지 회복량이 초과한 경우 타케바 유카리는 최대 35포인트까지 초과된 회복량을 저장할 수 있다.\n아군 동료에게 스킬 시전 시 2턴 동안 스킬 메인 목표의 관통이 20% 증가한다.\n『바람을 쫓는 호흡』이 새로운 효과를 획득하여 아군 전체의 생명이 1,200 회복되고, 메인 목표는 추가로 30% 회복된다.",
  "r2": "사랑의 증표",
...
window.cnCharacterRitualData["유카리"] = {
  "name": "岳羽由加莉",
  "r0": "铭刻于心的想念",
  "r0_detail": "岳羽由加莉可以为敌人添加『风蚀』，友方其他同伴对拥有『风蚀』的敌人释放技能造成伤害时，使所有同伴恢复相当于岳羽由加莉24.5%攻击力+800/1600/2400（达到1、50、70级时变化）的生命值，并使岳羽由加莉获得一层『风语』，上限2层，岳羽由加莉每回合至下一回合开始前最多触发1次该治疗效果。",
  "r1": "扣动的扳机",
  "r1_detail": "战斗开始时，自身获得满层『风语』并回复70点神通法能量，首回合若神通法能量回复量溢出，岳羽由加莉最多缓存35点溢出的回复量。\n对友方同伴释放技能时，额外使技能主目标穿透提升20%，持续2回合。\n『追风之息』获得新的效果，使所有同伴回复1200的生命值 ，主目标额外回复30%。",
  "r2": "被爱的证据",
  "r2_detail": "释放神通法后，自身获得免疫精神异常效果，并使所有同伴暴击效果提升30%，持续2回合。",
  "r3": "桃色环绕的少女",
  "r3_detail": "『疾风爆裂』、『复苏之矢』的技能等级提升3级，至多提升至15级。",
  "r4": "治愈的极致",
  "r4_detail": "使用神通法时，额外恢复生命值最低的友方同伴相当于岳羽由加莉5%攻击力+500的生命值，并使友方同伴伤害额外提升10%。",
  "r5": "探求疑念",
  "r5_detail": "『追风之息』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "春日的邂逅",
  "r6_detail": "『复苏之矢』回复的神通法能量值翻倍。\n*回复的神通法能量溢出时会暂时缓存溢出的回复量，在目标释放神通法后返还，最多缓存相当于目标神通法能量上限的能量值，溢出的能量值最多缓存2回合。\n任意同伴使用神通法时立刻获得暴击效果提升30%，该效果持续2回合。"
};
