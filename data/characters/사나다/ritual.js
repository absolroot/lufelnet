...
window.ritualData["사나다"] = {
  "name": "사나다 아키히코",
  "r0": "전투의 이유",
  "r0_detail": "사나다 아키히코가 페르소나 스킬/테우르기아를 사용해 전격 속성 대미지를 준 후 『집념』을 1중첩 획득한다. 전투 진입 시 『집념』을 2중첩 획득한다(12회 중첩 가능). 자신의 턴 시작 시 『집념』을 6중첩 소모하여 『무적의 주먹』을 1회 시전할 수 있다. 『무적의 주먹』: 자신이 『투지』를 1중첩 획득하며, 적 전체에 공격력 55.9%의 물리 속성 대미지를 준다. 적이 다운 상태일 경우, 1턴 동안 적의 다운 허약 효과가 8% 증가한다. 해당 스킬은 추가 효과로 간주된다. 『투지』: 자신의 관통이 4% 증가한다(3회 중첩 가능).",
  "r1": "복싱부 주장",
  ...
  "r4": "훈련 성과",
  "r4_detail": "테우르기아 시전 시, 적용되는 크리티컬 효과가 추가로 50% 증가한다.\n(적용되는 크리티컬 효과 최소치가 300%로 증가하고, 최대 효과가 400%로 증가)",
  "r5": "숨겨진 진심",
...
window.cnCharacterRitualData["사나다"] = {
  "name": "真田明彦",
  "r0": "战斗的理由",
  "r0_detail": "真田明彦使用人格面具技能/神通法造成电击属性伤害后获得1层『执念』。进入战斗时获得2层『执念』，上限12层。自身回合开始时，可以消耗6层『执念』释放1次『无敌钢拳』：自身获得1层『斗志』，对所有敌人造成55.9%攻击力的物理属性伤害。若敌人处于倒地状态，则使敌人倒地易伤提升8%，持续1回合。该技能视为追加效果。『斗志』：自身穿透提升4%，上限3层。",
  "r1": "拳击部主将",
  "r1_detail": "真田明彦拥有『斗志』时暴击率提升20%。\n进入战斗时自身获得70点神通法能量。",
  "r2": "笨拙的情感",
  "r2_detail": "消耗『执念』释放『无敌钢拳』后，自身伤害提升30%，持续3回合。\n对倒地单位造成伤害时，自身『倒地特攻』提升10%。",
  "r3": "克己之心",
  "r3_detail": "『电光冲击』、『雷拳一闪』的技能等级提升3级，至多提升至15级。",
  "r4": "锻炼的成果",
  "r4_detail": "释放神通法时，计入的暴击效果额外提升50%。\n（其计入暴击效果最低值提升至300%，最高效果升至400%）",
  "r5": "秘藏的心意",
  "r5_detail": "『电光阵』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "力量的追求者",
