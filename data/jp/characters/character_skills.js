const characterSkillsData = {
    ...
    "아케치": {
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "모든 적에게 축복 속성 피해를 공격력의 56.9%만큼 가하고, 모든 아군의 HP를 1,024 회복한다. 또한, 모든 아군에게 축복 1스택을 부여한다.\n자신은 『진실』을 획득하고, 『정확』 상태에 진입하며, 2턴 동안 지속된다. 『정확』 상태일 때, 모든 아군의 피해량이 12.8% 증가한다."
        },
        "skill2": {
            "name": "기울어진 사냥터 (1레벨 기준)",
            "element": "주원광역",
            "type":"광역피해",
            "sp": 20,
            "cool": 0,
            "description": "모든 적에게 주원 속성 피해를 공격력의 71.2%만큼 가한다. 자신은 『진실』을 획득하고, 『혼돈』 상태에 진입하며, 2턴 동안 지속된다. 『혼돈』 상태일 때, 모든 적의 방어력이 16.6% 감소, 자신의 ‘혼돈의 화살’ 발동 횟수가 1회 증가, 자신의 피해량이 12.8% 증가한다."
        },
        "skill3": {
            "name": "황금 화살비·파멸 (1레벨 기준)",
            "element": "만능광역",
            "type":"광역피해",
            "sp": 20,
            "cool": 0,
            "description": "발동 조건: 자신이 『진실』 상태일 때\n모든 『명확한 화살』을 소모하여, 모든 적에게 고정값의 만능 속성 피해를 준다. 이 피해량은 『명확한 화살』의 기록 피해량의 12.8%로 계산된다. 이후, 랜덤한 적에게 ‘혼돈의 화살’을 4회 발사하며, 각 공격은 공격력의 47.3%에 해당하는 만능 속성 피해를 가한다. 가능한 한 아직 공격받지 않은 적을 우선 대상으로 지정하며, 동일한 적이 여러 번 피격될 경우, 후속 공격은 15% 피해만 적용된다."
        },
        "skill_highlight": {
            "element": "만능",
            "type":"광역피해",
            "description": "모든 적에게 공격력 67.8%의 축복 속성 피해 1회, 공격력 67.8%의 저주 속성 피해 1회를 준다."
        },
        "passive1": {
            "name": "법도",
            "element": "패시브",
            "description": "아케치 고로가 라인업에 있으면 임의 속성 욕망 소나타를 발동할 수 있으며, 전투 시작 시 욕망 소나타를 1회 발동할 때마다 자신이 주는 대미지가 15.0% 증가한다."
        },
        "passive2": {
            "name": "갈망망",
            "element": "패시브",
            "description": "만능 대미지를 줄 때, 목표의 방어력 감소 효과 1%를 기준으로 자신이 주는 대미지가 0.5% 증가한다. (최대 120.0%까지 증가)"
        }    
    },
