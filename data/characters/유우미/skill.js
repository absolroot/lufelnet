...
window.characterSkillsData["유우미"] = {
  ...
  "skill2": {
    ...
    "type": "버프",
    "cool": 4,
    "description": "2턴 동안 1명의 동료의 주는 대미지가 증가하고 (시이나 유우미의 공격력 230포인트마다 1%의 대미지 보너스 제공, 최대 공격력 4600/5060/5980/6440포인트까지 계산), 최대 생명이 13.0%/13.0%/14.6%/14.6% 증가한다.\n대미지를 줄 시 1턴 동안 해당 대미지 2%의 생명을 회복한다. 해당 스킬 시전 시 시이나 유우미가 『러프/믹스』를 1잔 소모해 『믹스・DELUXE』를 1잔 획득한다."
  },
  "skill3": {
    "name": "향기로운 와인",
    "element": "버프광역",
    ...
    "cool": 8,
    "unlock": "『칵테일』 보유 시 해제",
    "description": "발동 조건: 『칵테일』 보유 시 해제\n모든 『칵테일』을 소모해 지정 동료의 적합성 속성을 특별 제조한다.\n『믹스・DELUXE/믹스/러프』를 1잔 소모할 때마다 120%,100%,50% 강도의 아래 효과 발동:\n모든 동료의 특별 조정 속성 대미지를 증가시키고(시이나 유우미의 공격력 230포인트마다 1%의 대미지 보너스 제공, 최대 공격력 4600/5060/5980/6440포인트까지 계산), 2턴 동안 지정 동료의 특별 조제 속성 대미지가 1.2배까지 증가한다. 만약 『믹스·DELUXE/믹스』를 최소 2잔 소모하면 2턴 동안 지정 동료의 크리티컬 효과가 추가로 20.0% 증가한다."
  },
  "skill_highlight": {
    "name": "속성 증가",
    "element": "패시브",
