...
window.characterSkillsData["야오링"] = {
  ...
  "skill_highlight": {
    "element": "주원광역",
    "type": "디버프",
    "description": "모든 적에게 공격력 146.4%/161.4%/155.4%/170.4%의 주원 속성 대미지를 주고, 모든 적이 받는 다음 1회의 대미지가 48.8%/53.8%/51.8%/56.8% 증가한다. 30%의 기본 확률로 모든 적을 2턴 동안 망각 상태에 빠뜨린다."
  },
  "passive1": {
    "name": "웃음소리",
    "element": "패시브",
...
window.jpCharacterSkillsData["야오링"] = {
  ...
  "skill_highlight": {
    ...
    "sp": 0,
    "cool": 0,
    "description": "敵全体に攻撃力146.4%/161.4%/155.4%/170.4%の呪怨属性ダメージを与え、対象が次に受けるダメージが48.8%/53.8%/51.8%/56.8%上昇する。さらに敵を30%の確率で2ターンの間、忘却状態にする。"
  },
  "passive1": {
    "name": "功夫の極み",
    "element": "패시브",
