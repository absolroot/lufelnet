...
스킬1과 스킬2를 통해 스킬3를 강화하고, **해당 강화가 최대치에 달하는 턴에 폭발적인 대미지**를 줄 수 있다.

체력을 40% 이하로 유지해야 최고의 성능을 유지할 수 있다. 때문에 치유를 받을 경우 딜 사이클이 망가질 수 있어 힐이 너무 많이 들어오는 파티에서는 추천되지 않는다.
...
Through Skill 2, he can consume his own HP, and keeping his HP below 40% is essential for achieving optimal performance. Because of this, receiving healing can disrupt his damage cycle, so he is not recommended for parties that apply too much healing.
...
また、スキル2で自身のHPを消費でき、HPを40％以下に保つことで最高の性能を発揮する。そのため、回復を受けるとダメージサイクルが崩れる可能性があり、回復量が多いパーティとは相性が良くない。
...
**『서리 결정』의 중첩 수**는 **의식0/1/6**에 각각 **5/7/8**개를 유지할 수 있다.
