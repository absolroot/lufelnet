const recommendParty = {
    ...
    "후카": {
        ...
        "party": [
            {
                members: ["유카리", "루우나", "레오", "미오"],
                comment: "의식0~의식1 백업 추천 : 의식1 유카리, 의식6 루우나, 의식6 레오, 의식1 미오",
                comment_en: "A0~A1 Backup Recommendation: A1 Yukari, A6 Runa, A6 Leo, A1 Mio",
            ...
            {
                members: ["이치고", "미오", "미나미·여름", ""],
                comment: "의식6 백업 추천 : 의식6 이치고, 의식6 미오, 의식6 미나미·여름",
    ...
    "마사키": {
        ...
        "party": [
            {
                members: ["마사키", "유스케", "유키미", "유우미"],
                comment: "유스케의 방어력을 강화시키고 대미지를 증가시킨다.",
    ...
    "아야카": {
        "party": [
            {
                members: ["아야카", "마코토", "치즈코", "유우미"],
                comment: "마코토의 HIGHLIGHT를 반복적으로 사용하여 전체 대미지를 올립니다.",
                comment_en: "Repeatedly use QUEEN's Highlight to increase overall damage",
                comment_jp: "QUEENのHIGHLIGHTを繰り返し使用して全体のダメージを上げる。"
            },
            {
                members: ["아야카", "카스미", "리코·매화", "후타바"],
                comment: "HIGHLIGHT 기반의 딜러로 아야카가 필수적으로 채용됩니다.",
                comment_en: "CHORD is essential for dealers based on HIGHLIGHT.",
                comment_jp: "HIGHLIGHTベースのディーラーとしてCHORDが必須で採用される。"
            },
            {
                members: ["아야카", "이치고", "미나미·여름", "마나카"],
                comment: "HIGHLIGHT 사용을 통해 지속 대미지 스택을 모두 결산합니다.",
        ...
        "party": [
            {
                ...
                comment: "VINO를 통해 방어력 감소와 원소 이상을 부여합니다.",
                comment_en: "Reduce DEF and inflict elemental ailments through VINO.",
                comment_jp: "VINOによりDEF減少と元素異常を付与する。"
            },
            {
                members: ["마코토", "치즈코", "레오", "유우미"],
                comment: "핵열 속성을 공통적으로 사용하므로 PHOEBE와의 조합이 유리합니다.",
                comment_en: "Since both characters use the Nuclear attribute, it is advantageous to combine with PHOEBE.",
                comment_jp: "核熱属性を共通で使用するため、PHOEBEとの組み合わせが有利です。"
            },
            {
