...
window.ritualData["나루미"] = {
  "name": "나시모토 나루미",
  "r0": "첫 무대",
  "r0_detail": "나시모토 나루미는 고유 에너지 『반짝임』을 보유한다. 초기 『반짝임』은 1개이며 상한은 10개이다. 『반짝임』 중첩 수에 따라 스킬이 강화된다.\n전투 진입 시 주인공은 특수 스킬을 획득하여 나시모토 나루미에게 『나루루♪나루루♫』를 부여할 수 있다. 나시모토 나루미는 다음 턴 종료 후 추가 턴인 『스포트라이트·전개』에 진입하고 SP 15를 회복한다. 『스포트라이트·전개』 턴 종료 시 『나루루♪나루루♫』와 모든 『반짝임』을 소모한다.\n해당 스킬은 1턴의 쿨타임이 있으며 전투 시작 시 쿨타임이 적용된다. 쿨타임은 주인공의 일반 턴(추가 턴 제외) 진행을 통해 감소한다.",
  "r1": "소중한 손님",
  "r1_detail": "특수 스킬 『악수회❤와줄거지❤』를 획득한다. 사용 시 주인공이 다음 턴 종료 후 추가 턴에 진입하게 하며, 추가 턴 시작 시 SP 15를 회복시킨다.\n해당 스킬은 1턴의 쿨타임이 있으며, 나시모토 나루미의 일반 턴 진행을 통해 감소한다.\n나시모토 나루미의 모든 턴에서 『스포트라이트·전개』 턴 관련 증가 효과를 발동할 수 있다. 『스포트라이트·전개』 턴 동안 크리티컬 효과가 30% 증가한다.",
  "r2": "영원히 지켜봐줘",
  "r2_detail": "『반짝임』 상한이 16개로 증가하며, 주인공이 페르소나 스킬 시전 시 『반짝임』을 1개 추가로 획득한다.\n스킬 『사랑의 LIVE♪』 강화: 『반짝임』이 16개일 때 시전 시 각 『반짝임』이 제공하는 효과가 1.5배로 증가한다.",
  "r3": "특별한 인연",
  "r3_detail": "『케이크 BOOM!』, 『사랑의 LIVE♪』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r4": "나를 위한 응원",
  "r4_detail": "HIGHLIGHT 효과 증가: HIGHLIGHT 시전 후 추가로 주인공 크리티컬 효과의 15%만큼 자신의 크리티컬 효과가 증가한다. 최대 30%까지 증가하며 2턴 동안 지속된다.",
  "r5": "절대적 센터",
  "r5_detail": "『당도 100%❤』, 『전투 기술』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r6": "너만의 미소",
  "r6_detail": "『스포트라이트·전개』 턴 종료 시 더 이상 『나루루♪나루루♫』와 『반짝임』을 소모하지 않고, 이어서 『약속·다시 만나』 턴에 진입하며 SP 15를 회복한다.\n『약속·다시 만나』 턴은 『스포트라이트·전개』 턴으로 간주되며, 해당 턴 종료 시 『나루루♪나루루♫』와 모든 『반짝임』을 소모한다."
};
