    ...
    "황룡": {
        ...
        instinct: {
            ...
            effects: [
                ...
                "『사상의 힘』: 2턴 동안 자신의 공격력이 증가하고, 모든 아군 동료의 공격력이 증가하며, 자신의 스킬이 진화한다."
            ],
            priority: 2 
        },
        uniqueSkill: {
    ...
    "토르": {
        ...
        instinct: {
            ...
            effects: [
                ...
                "자신이 페르소나 스킬 대미지를 주었을 때, 만약 자신의 『뇌신의 위세』가 3중첩이면 2턴 동안 전체 적이 받는 전격 속성 대미지가 증가하고, 받는 전격 속성 크리티컬 효과가 증가한다."
            ],
            priority: 2
        },
        uniqueSkill: {
