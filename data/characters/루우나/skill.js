...
window.characterSkillsData["루우나"] = {
  ...
  "skill1": {
    ...
    "sp": 22,
    "cool": 0,
    "description": "적 전체에 공격력 73.2%/80.7%/77.7%/85.2%의 화염 속성 대미지를 주고, 2턴 동안 목표의 방어가 감소하며(수치는 자신의 효과 명중의 15.4%, 상한 26.4%/29.1%/28.0%/30.7%), 화염, 전격, 빙결, 질풍 속성 스킬을 받을 시 방어가 추가로 26.4%/26.4%/28.0%/28.0% 감소한다. 또한 50% 기본 확률로 목표를 화상 상태에 빠뜨린다. 자신이 『열렬한 환영』을 획득한다(방어 감소 효과와 『악당에 대한 경고』는 중첩되지 않음)."
  },
  "skill2": {
    "name": "악당에 대한 경고",
    "element": "화염",
  ...
  "skill3": {
    ...
    "sp": 26,
    "cool": 0,
    "description": "활성 조건: 자신이 『열렬한 환영』 또는 『집요한 추격』 중 하나를 보유해야 한다.\n자신이 『열렬한 환영』 또는 『집요한 추격』을 보유하고 있는지에 따라 해당 스킬은 각각 다른 효과가 발동되며, 동시에 하나의 효과만 발동할 수 있다.\n『열렬한 환영』: 적 전체에 공격력 109.8%/109.8%/116.6%/116.6%의 화염 속성 추가 효과 대미지를 주고, 2턴 동안 목표가 받는 대미지가 증가하며(수치는 자신의 효과 명중의 24%, 상한 41.0%/45.2%/43.5%/47.7%), 받는 화염, 전격, 빙결, 질풍 속성 대미지가 20.5%/22.6%/21.8%/23.9% 증가한다.\n『집요한 추격』: 1명의 적에게 공격력 219.6%/219.6%/233.1%/233.1%의 화염 속성 추가 효과 대미지를 주고, 2턴 동안 목표가 받는 대미지가 증가하며(수치는 자신의 효과 명중의 34.3%, 상한 58.6%/64.6%/62.2%/68.2%), 받는 추가 효과 대미지가 39.0%/43.0%/41.4%/45.4% 증가한다."
  },
  "skill_highlight": {
    "element": "화염광역",
    "type": "디버프",
    "description": "적 전체에 공격력 214.7%/236.7%/227.9%/249.9%의 화염 속성 대미지를 주고, 적 진영이 『대악당』 2중첩을 획득한다. 『대악당』: 적 진영의 임의의 목표가 추격 스킬 또는 화염, 전격, 빙결, 질풍 속성 스킬을 받으면 1중첩이 소모되며, 대미지가 증가한다(수치는 자신의 효과 명중의 31.4%, 상한 53.7%/59.2%/57.0%/62.5%). 『대악당』 중첩 상한은 2중첩이며, 영구 지속된다.\n『대악당』 상태가 존재할 때, 자신이 주는 대미지가 버프 효과의 영향을 받지만 『대악당』 중첩은 소모하지 않는다.",
    "cool": 4
  },
  "passive1": {
    "name": "충실",
  ...
  "passive2": {
    "name": "열정",
    "element": "패시브",
    "description": "스킬을 사용해 적에게 디버프 효과를 추가한 후 자신의 공격력이 33.0% 증가한다. 동료가 화염, 전격, 빙결, 질풍 속성 대미지 또는 추가 효과 대미지를 줄 때 1턴 동안 동일한 공격력 증가 효과를 획득한다.",
    "cool": 0
  }
};
...
window.cnCharacterSkillsData["루우나"] = {
  "name": "道玄坂琉七",
  "skill1": {
    "name": "炽热握手礼",
    "element": "화염광역",
    ...
    "sp": 22,
    "cool": 0,
    "description": "对所有敌人造成73.2%/80.7%/77.7%/85.2%攻击力的火焰属性伤害，使目标防御降低（数值相当于自身效果命中的15.4%，上限26.4%/29.1%/28.0%/30.7%），受到火焰、电击、冰冻、疾风属性技能时防御额外降低26.4%/26.4%/28.0%/28.0%，持续2回合，并有50%基础概率为目标附加燃烧状态。自身获得『热烈欢迎』。（防御降低效果和『对破坏者的威吓』无法叠加。）"
  },
  "skill2": {
    "name": "对破坏者的威吓",
    "element": "화염",
    ...
    "sp": 22,
    "cool": 0,
    "description": "对1名敌人造成170.8%/188.3%/181.3%/198.8%攻击力的火焰属性伤害，使目标防御降低14.6%/14.6%/15.5%/15.5%+（数值相当于自身效果命中的31.4%，上限53.7%/59.2%/57.0%/62.5%），持续2回合。自身获得『穷追猛打』。（防御降低效果和『炽热握手礼』无法叠加。）"
  },
  "skill3": {
    "name": "GOGO汪汪噜！",
    "element": "화염광역",
    ...
    "sp": 26,
    "cool": 0,
    "description": "开启条件：自身拥有『热烈欢迎』或『穷追猛打』\n根据自身拥有的『热烈欢迎』或『穷追猛打』时，该技能会分别产生不同的效果，同时只能触发一种效果。\n『热烈欢迎』： 对所有敌人造成109.8%/109.8%/116.6%/116.6%攻击力的火焰属性追加效果伤害，使目标受到伤害提升（数值相当于自身效果命中的24%，上限41.0%/45.2%/43.5%/47.7%），受到火焰、电击、冰冻、疾风属性伤害提升20.5%/22.6%/21.8%/23.9%，持续2回合。\n『穷追猛打』： 对1名敌人造成219.6%/219.6%/233.1%/233.1%攻击力的火焰属性追加效果伤害，使目标受到伤害提升（数值相当于自身效果命中的34.3%，上限58.6%/64.6%/62.2%/68.2%），受到追加效果伤害增加39.0%/43.0%/41.4%/45.4%，持续2回合。"
  },
  "skill_highlight": {
    "element": "화염광역",
    "type": "减益",
    "description": "限对所有敌人造成214.7%/236.7%/227.9%/249.9%攻击力的火焰属性伤害，使敌方阵营获得2层『大坏蛋』：敌方阵营任意目标受到追击技能或火焰、电击、冰冻、疾风属性技能时消耗1层，使伤害提升（数值相当于自身效果命中的31.4%，上限53.7%/59.2%/57.0%/62.5%），『大坏蛋』叠加上2层，持续时间永久。\n『大坏蛋』状态存在时，自身造成的伤害受到增益效果影响，但是不消耗『大坏蛋』层数。",
    "cool": 4,
    "name": "HIGHLIGHT"
  },
  "passive1": {
    "name": "忠诚",
    "element": "패시브",
    "description": "战斗中，自身获得等同于自身效果命中60.0%的攻击力加成。",
    "cool": 0
  },
  "passive2": {
    "name": "热情",
    "element": "패시브",
    "description": "使用技能为敌人添加负面效果后，自身攻击力提升33.0%。同伴造成火焰、电击、冰冻、疾风焰属性伤害或追加效果伤害时候获得相同的攻击力提升效果，持续1回合。",
    "cool": 0
  }
};
