...
継続的な研究を通じて、A6風花と本当にサイクルが噛み合うと評価されるようになり、実装初期の評価とは異なり、上位環境では積極的に採用されるようになった。
      `,
      review_cn: `
**一名不依赖敌人弱点，也能大幅削减DOWN值，并强化倒地敌人所受伤害的减益手**。

- 技能1：给敌人附加2回合的[防御力降低]与[受到伤害提升]，并解锁技能3。

- 技能3：**削减5点DOWN值**，并在1回合内强化**『击破』**与[受到伤害提升]，同时**强化下一次技能2**。

- 技能2：在强化状态下可以再削减4点DOWN值，并附加1回合减益。

<br>

她能够快速打出倒地，并强化**独立乘区的『击破』**。由于这个增益是单独乘算，所以无论何时都能稳定带来不错的伤害提升。

不过她也存在一些需要提前知道的限制，实战中最好一并考虑。

- 群体首领的基础DOWN值是5，因此在意识1以下时，技能2无法稳定打出倒地。单体首领的DOWN值更高，所以效率还会更差。
- 虽然片山久未自己也有不少自我强化效果（被动/技能），但敌人会在回合结束时从倒地状态起身，减益随之消失，因此她自己很难完整吃到这些收益。
- 防御力降低被绑定在HL上，容易出现**必须强行开HL**的情况。
- 4星武器需要敌人倒地后才能触发。若不到意识1，效率会明显下降，因此**3星武器**反而可能是更实际的替代方案。

<br>

随着不断研究，后来大家逐渐认可她和意识6风花的循环确实非常契合，因此和初登场时的评价不同，她在高端环境中被积极投入使用。
      `,
      ...
      pros_cn: ["不依赖敌人弱点也能制造倒地。", "能够强化倒地相关的易伤效果。"],
      ...
      cons_cn: ["如果敌人无法倒地，效率会明显下滑。", "即使有自我强化，她自身的伤害依旧偏低。"],
    };
})();
