...
window.ritualData["몽타뉴·백조"] = {
  "name": "코토네 몽타뉴·백조",
  "r0": "봄의 연못과 권태로운 백조",
  "r0_detail": "코토네 몽타뉴·백조의 2가지 형태: 『봄 형태』와 『겨울밤 형태』 전투 과정에서 『봄의 결계』/『겨울밤의 결계』 미전개 시 자유롭게 형태를 바꿀 수 있다. 형태를 바꾸면 코토네 몽타뉴·백조가 해당 속성 스킬 그룹을 획득한다. 전투 참가 시, 기본값은 『봄 형태』지만, 팀원 중 빙결 속성이 질풍 속성보다 많을 경우 기본값은 『겨울밤 형태』로 설정된다.\n2턴 동안 『아침 이슬 결정』 또는 『겨울 서리 결정』을 획득할 때마다, 공격력이 5% 영구 증가한다(7회 중첩 가능).",
  "r1": "연못에서 구슬피 울리는 노래",
  ...
  "r4": "꿈결처럼 가벼운 턴",
  "r4_detail": "『봄 형태』: HIGHLIGHT 시전 시 코토네 몽타뉴·백조가 『봄의 결계』 안에 있으면, 수량 제한을 돌파할 수 있는 『아침 이슬 결정』 1개를 추가로 획득한다. 그렇지 않을 경우 HIGHLIGHT 스킬 대미지가 35% 증가한다.\n『겨울밤 형태』: HIGHLIGHT 시전 시, 코토네 몽타뉴·백조가 『겨울밤의 결계』 내에 있으면, 수량 제한을 돌파할 수 있는 『겨울 서리 결정』 1개를 추가로 획득한다. 그렇지 않을 경우 HIGHLIGHT 스킬 대미지가 35% 증가한다.",
  "r5": "삶의 끝을 넘어",
  "r5_detail": "『폭풍의 서곡/싸늘한 바람』, 『전투 기술』의 스킬 레벨이 3레벨 증가하고, 최대 15레벨까지 증가한다.",
  "r6": "운명에 굴복하지 않는 영혼",
  "r6_detail": "『봄 형태』: 『봄의 결계』 종료 시 추가 효과가 발동하면, 『봄의 결계』는 1턴 동안 추가 지속되며 『아침 이슬 결정』 2개를 반환 및 상한을 돌파할 수 있는 『아침 이슬 결정』 2개를 반환한다. 이후 추가 효과를 다시 발동할 수 있다. 『봄의 결계』 종료 시 『아침 이슬 결정』 1개당 관통이 4% 증가하는 추가 효과를 획득한다(최대 20% 증가).\n『겨울밤 형태』: 『겨울밤의 결계』 종료 시 추가 효과가 발동하면, 『겨울밤의 결계』는 1턴 동안 추가 지속되며 『겨울 서리 결정』 2개를 반환 및 상한을 돌파할 수 있는 『겨울 서리 결정』 2개를 반환한다. 이후 추가 효과를 다시 발동할 수 있다. 『겨울밤의 결계』 종료 시 『겨울 서리 결정』 1개당 관통이 4% 증가하는 추가 효과를 획득한다(최대 20% 증가)."
};
...
window.cnCharacterRitualData["몽타뉴·백조"] = {
  ...
  "r2": "时光的诗与风的叹息",
  "r2_detail": "『仲春形态』：『仲春结界』持续时间内，所有敌人防御降低40%，所有怪盗释放人格面具技能的精力值消耗降低25%。\n『冬夜形态』：『冬夜结界』持续时间内，所有怪盗冰冻伤害提升30%，并且释放人格面具技能的精力值消耗降低25%。",
  "r3": "波光与羽翅共舞",
