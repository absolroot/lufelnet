...
`,
        review_cn: `
她是2.0版本登场的怪盗团成员，推进剧情即可获得；在角色契约中则不受解锁进度影响，可以直接入手。

她会给敌人留下标记，**当通过普通攻击或弱点攻击解除标记时，可以额外削减守卫值并触发DOWN**。

正因为**即使不是弱点攻击也能制造DOWN**，所以她能够更积极地帮助队伍活用ONEMORE与总攻击。

她的被动同样也是围绕**强化ONEMORE与总攻击**来设计，因此在攻略天鹅绒房间任务时非常有帮助。

除此之外，她还兼具技能1的减益、技能3的同伴回复与伤害增益，以及会自动触发的技能2，整体性能相当全面。
`,
        ...
        pros_cn: ["即使不是弱点攻击也能削减DOWN值。", "能够强化总攻击与ONEMORE。", "拥有很关键的防御力降低效果。"],
        ...
        cons_cn: ["由于以速度为主属性，常规属性提升类技能的收益会偏低。"],
    };
})();
