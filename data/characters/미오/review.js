...
TECHNICAL 속성별 효과가 등장한 첫 캐릭터로 빙결 속성 TECHNICAL 효과는 화상 상태인 적에게 TECHNICAL 대미지를 입히면 2턴 동안 확률적으로 목표가 받는 화염/빙결 속성 대미지가 증가하는 효과를 입힐 수 있다.

**스킬1이 화상 상태인 적을 공격할 때 TECHNICAL 효과를 강화하는 '스킬 마스터'를 획득**한다. 때문에 **화상을 1명이라도 적에게 부여하는 것이 중요**해서 화염 아이템 부적을 활용하거나 페르소나 트론을 자주 활용하게 된다.
...
해당 메커니즘에 대한 자세한 이해를 원한다면 가이드를 참조하면 좋다 : [TECHNICAL 강화 - 스킬 마스터](/kr/article/technical-master/)
...
For a detailed understanding of this mechanism, please refer to the guide: [TECHNICAL Enhancement - Technical Precision](/en/article/technical-master/)
`,
...
このメカニズムについて詳しく知りたい場合は、以下のガイドを参照してください：[TECHNICAL強化 - テクニカル精度](/jp/article/technical-master/)
`,
                review_cn: `**是专精TECHNICAL攻击与燃烧异常的群体防御力降低减益手。**

她会在自身回合开始时以及使用技能1时获得专属层数，当层数达到4层以上时，技能3会获得大幅强化。

她也是首个引入按TECHNICAL属性区分效果的角色。以冰冻TECHNICAL为例，当对处于燃烧状态的敌人打出TECHNICAL伤害时，就能赋予目标一个持续2回合的效果，使其受到的火焰/冰冻属性伤害进一步提升。

**技能1在攻击燃烧状态敌人时，会获得能够强化TECHNICAL效果的『技巧精通』。**  
正因如此，**至少先给1名敌人附上燃烧是非常重要的**，这也是为什么她经常会搭配火焰护符道具或人格面具托罗恩。

技巧精通：会影响TECHNICAL附加效果的强度，每提升100点（不足100点的部分则按比例计算）：  
- 『爆燃』的技能伤害提升效果增加10%。  
- 『凉电』的技能伤害提升效果增加10%。  
- 『冰灼』的火焰/冰冻属性易伤效果增加5%。  
- 『风灼』造成的追加伤害增加6%。  
...
如果想更详细理解这套机制，建议参考这篇指南：[TECHNICAL强化 - 技巧精通](/cn/article/technical-master/)`,
                ...
                pros_cn: ["拥有高额防御力降低效果。", "能够强化TECHNICAL效果。"],
