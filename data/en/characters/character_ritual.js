const enCharacterRitualData = {
    ...
    "리코·매화": {
        ...
        "r1_detail": "The trigger condition for the 『Falling Petals』 state of 『Dancing Plum Blossoms』 changes from 'when taking Wind damage' to 'when taking any elemental damage', and the target's Critical DMG increases by an additional 30%.\n『Plum Beneath the Umbrella』 increases the leader Phantom Thief's Attack by an additional 25%.",
        "r2": "Awakened Night",
        "r2_detail": "Riko Tanemura·Vast's SP cap is further increased by 50 points (the maximum potency of 『Scent of Plum Blossoms』 triggered by SP consumption is also increased *effect max +25%).\nAfter using 『Scent of Plum Blossoms』, she instantly recovers 50 SP.\nPotential 『Full Bloom』 effect enhanced: When 『Bloom』 reaches 5/10 stacks, the increased Critical DMG value is doubled.",
        "r3": "Serene Moonlight",
        ...
        "r4_detail": "HIGHLIGHT Effect Boost: Buff effects now apply to all allies except herself, and the skill main target's Critical DMG increases by an additional 12%. SP recovery for all allies (except herself) increases by up to 32 points.",
    ...
    "야오링·사자무": {
        ...
        "r4": "Family Laughter",
        "r4_detail": "HIGHLIGHT effect boost: Yaoling Li·Lion Dance's Critical DMG increases by an additional 15%, and all buff effects from HIGHLIGHT have their duration extended by 2 turns.",
        "r5": "Melting Icicles",
