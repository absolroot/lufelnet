  ...
  "innate_awake_skill": [
    {
      ...
      "name_jp": "風華",
      "name_cn": "风华",
      "desc": "『개화』를 보유한 캐릭터는 중첩당 크리티컬 효과가 추가로 4.0%/6.0%/8.0% 증가한다(최대 20.0%/30.0%/40.0%). 또한 공격력이 4.0%/6.0%/8.0% 증가한다(최대 20.0%/30.0%/40.0%).\n자신이 『우산 속 매화』 사용 후 2턴 동안 모든 동료의 관통이 추가로 7.5%/11.2%/15.0%, 크리티컬 확률이 7.5%/11.2%/15.0% 증가한다.",
    ...
    },
    {
      ...
      "name_jp": "春の恩恵",
      "name_cn": "春恩",
      "desc": "자신이 『매화의 잔향』을 사용하면 소모한 SP에 따라 아군 질풍 속성 캐릭터에게 버프를 부여한다. SP 100 소모당 총 대미지 증폭이 4.0%/6.0%/8.0%+의식 레벨*1.5% 증가하고, 대미지 증가가 4.0%/6.0%/8.0%+의식 레벨*1.5% 상승하며,  2턴 동안 지속된다.\n『낙화』는 적이 질풍 속성 대미지를 받을 때 크리티컬 효과를 추가로 10.0%/15.0%/20.0%+의식 레벨*2.5% 증가시킨다.",
