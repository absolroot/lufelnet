...
window.ritualData["미나미·여름"] = {
  "name": "미야시타 미나미·여름",
  "r0": "당신을 위해 붙잡은 시간",
  "r0_detail": "미야시타 미나미·여름이 무제한으로 사용 가능한 전용 버프류 약품 3종을 보유한다. 『너를 위한 꽃』 시전 시 『꿈의 꽃』 1송이를 획득하며, 최대 1송이를 보유할 수 있다. 자신의 턴에 『꿈의 꽃』 1송이를 소모하여 『추억의 처방』을 획득할 수 있다. 『추억의 처방』: 약품 사용 시 턴이 소모되지 않고, 사용한 버프류 약품의 효과 지속 시간이 1턴 연장된다. 약품은 1회 사용 후 효력을 상실한다.",
  "r1": "당시의 추억",
  "r1_detail": "『너를 위한 꽃』 시전 시 『꿈의 꽃』 1송이를 추가로 획득하며, 『꿈의 꽃』 보유 상한이 2송이로 증가한다. 자신의 약품 효과가 20% 증가한다.",
  "r2": "바람에 흔들리는 꽃",
  "r2_detail": "『여름 바구니』 시전 시 목표가 『꽃의 온기』를 추가로 획득한다. 『꽃의 온기』: 3턴 동안 방어력 25% 감소, 받는 크리티컬 효과 30% 증가",
  "r3": "따스한 햇살 아래 뜨겁게",
