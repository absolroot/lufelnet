;(function () {
  ...
  var I18N = {
    kr: {
      ...
      spOverWarn: '450.1% 를 초과해도 얻는 이득이 없습니다. 크리티컬 효과에 보다 집중하세요.'
    },
    en: {
      ...
      spOverWarn: 'No benefit beyond 450.1%. Focus on Crit Effect instead.'
    },
    jp: {
      ...
      spOverWarn: '450.1%を超えても得られる利益はありません。CRT倍率に集中してください。'
    }
  };
  ...
  function calcPassive(spTotal) {
    // SP회복 450% 도달 시 84%, 미만이면 비례 감소, 초과해도 84% 캡
  ...
  function ensureStyles() {
    ...
    s.textContent = [
      ...
      '.riko-goal-btn.active{box-shadow:0 0 0 1.5px rgba(209,31,31,.6) inset,0 0 12px rgba(209,31,31,.15);background:rgba(209,31,31,.18);border-color:rgba(209,31,31,.5);color:#fff;font-weight:600}',
      ...
      '.riko-col-header-goal{margin-left:auto;font-size:12px;font-weight:600;color:rgba(255,255,255,.55);white-space:nowrap;letter-spacing:.3px}',
  ...
  function buildCard() {
    ...
    /* goal section — buttons only, no display bar */
