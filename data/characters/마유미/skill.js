...
window.characterSkillsData["마유미"] = {
  ...
  "passive1": {
    "name": "선두",
    "element": "패시브",
    "description": "하시모토 마유미가 필드에 있을 때, 모든 동료의 추가 턴에 주는 대미지가 45.0% 증가한다.",
    "cool": 0
  },
  "passive2": {
    "name": "가압",
    "element": "패시브",
    "description": "하시모토 마유미가 필드에 있을 때, 모든 동료의 다운 상태인 목표에게 주는 대미지가 30.0% 증가한다. 하시모토가 목표를 다운시킨 경우, 해당 목표에게 공격력 60.0%의 물리 속성 대미지를 추가로 준다.",
    "cool": 0
  }
};
...
window.cnCharacterSkillsData["마유미"] = {
  ...
  "passive1": {
    "name": "领跑",
    "element": "패시브",
    "description": "桥本麻由美在场时，使所有同伴在额外回合造成的伤害提升45.0%。",
    "cool": 0
  },
  "passive2": {
    "name": "增压",
    "element": "패시브",
    "description": "桥本麻由美在场时，使所有同伴对倒地目标造成的伤害提升30.0%；桥本对目标造成击倒时额外对其造成60.0%攻击力的物理属性伤害。",
    "cool": 0
  }
};
