...
| `synergy` | 로컬 i18n 잔존 | `apps/synergy/item_from.js:21`, `apps/synergy/soulmate.js:81`, `apps/synergy/soulmate.js:143` |
...
| 서비스 | 상태 | 위치 |
| --- | --- | --- |
| `synergy` | 레거시 파일(현재 미로드 가능성 높음) | `apps/synergy/friends/synergy_translate.js:2` |
...
- 현재 기준 완전 통합 완료 서비스: `astrolabe`, `critical-calc`, `defense-calc`, `maps`.
