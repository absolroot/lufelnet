...
const criticalBuffData = {
  ...
  "원더": [
    ...
    { id: "wonder7", type: "페르소나", type_en: "Persona", type_jp: "ペルソナ", target: "광역", target_en: "Multi", target_jp: "複数対象", skillIcon: "/assets/img/tactic-persona/야노식.webp", skillName: "야노식 - 본능", skillName_en: "Janosik - Talent", skillName_jp: "ヤノシーク - 本能", options: [], value: 4.5, duration: "2턴", note: "본능4", note_en: "Unique Passive LV4", note_jp: "本能 LV4" },
...
const criticalSelfData = {
  ...
  },
  {
    ...
    target_en: "Self",
    target_jp: "自分",
    skillIcon: "/assets/img/character-weapon/모토하·청광-5-01.png",
    skillName: "원정의 선구자호",
  ...
  "나루미": [
    { id: "narumi1", type: "스킬1", target: "자신", target_en: "Self", target_jp: "自分", skillIcon: "/assets/img/character-detail/ritual0.png", skillName: "달콤 100%❤", skillName_en: "S1", skillName_jp: "スキル1", options: ["LV10", "LV10+심상5", "LV13", "LV13+심상5"], values: { "LV10": 14.6, "LV10+심상5": 16.1, "LV13": 15.5, "LV13+심상5": 17.1 }, defaultOption: "LV13+심상5", value: 17.1, duration: "2턴", note: "", note_en: "", note_jp: "" },
    { id: "narumi2", type: "전용무기", type_en: "Exclusive Weapon", type_jp: "専用武器", target: "자신", target_en: "Self", target_jp: "自分", skillIcon: "/assets/img/character-weapon/나루미-5-01.png", skillName: "슈가 앵콜", skillName_en: "Exclusive Weapon", skillName_jp: "専用武器", options: ["개조0&1", "개조2&3", "개조4&5", "개조6"], values: { "개조0&1": 18.1, "개조2&3": 23.5, "개조4&5": 28.9, "개조6": 34.3 }, defaultOption: "개조6", value: 34.3, duration: "", note: "" },
  ],
