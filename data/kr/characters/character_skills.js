const characterSkillsData = {
    ...
    "미유·여름":{
        ...
        "skill1": {
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 74.5%/82.1%/79.0%/86.7% 공격력의 빙결 속성 피해를 주고, 100%의 기본 확률로 목표를 2턴 동안 빙결 상태로 만든다.\n자신의 SP을 20 회복한다(이 효과는 SP 회복 속성의 영향을 받는다).\n이 방식으로 획득한 SP은 최대치를 초과해 획득할 수 있으며(최대 SP에 해당하는 추가 SP까지 가능)."
        },
        "skill2": {
            "name": "푸른 협주",
            "element": "빙결광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 148.8%/164.1%/158.0%/173.2% 공격력의 빙결 속성 피해를 준다.\n『바다의 영역』 상태에서는 『겹치는 파도』의 중첩마다 이 스킬 피해가 20% 증가한다.스킬 사용 후 『바다의 영역』에서 이탈하며 『겹치는 파도』이 초기화된다. 이 스킬은 추가 효과로 간주된다."
        },
        "skill3": {
            "name": "빛을 타고 푸른 파도 위로",
            "element": "버프",
