...
window.cnCharacterRitualData["쇼키"] = {
  "name": "池波星辉",
  "r0": "浮生四幕间",
  "r0_detail": "自身拥有『即兴·渗透』、『即兴·颠覆』、『即兴·共情』、『即兴·感应』4种『即兴表演』状态，回合开始时可以进行切换。自身使用人格面具技能造成伤害时，有75%的基础概率为敌方全体添加当前『即兴表演』状态对应的元素异常效果（依次为燃烧、冻结、触电、风袭效果）。",
  "r1": "再会，再会！记着我",
  "r1_detail": "对同伴使用人格面具技能后，若目标拥有祝福效果，每层祝福使其伤害提升3%，上限15%，持续2回合。",
  "r2": "忍受命运暴虐的毒箭",
  "r2_detail": "使用『间离之所』时，额外使目标受到下次技能伤害时，获得35%的最终伤害减免，持续1回合。",
  "r3": "挺身反抗无涯的苦难",
  "r3_detail": "『聚光独白』、『间离之所』的技能等级提升2级，至多提升至15级。",
  "r4": "稻秆之微，亦慷慨力争",
  "r4_detail": "HIGHLIGHT效果提升：使技能主目标攻击力提升10%，并使所有同伴额外获得2层祝福。",
  "r5": "雀子的生死由命运注定",
  "r5_detail": "『繁星共演』、『战斗技巧』的技能等级提升2级，至多提升至15级。",
  "r6": "此外，沉默之余另有星光",
