const penetrateData = {
  ...
  "코토네": [
    {
      ...
      "values": {"LV10": 14.6, "LV10+심상5": 16.1, "LV13": 15.5, "LV13+심상5": 17},
      "defaultOption": "LV13+심상5",
      "value": 17,
      "skillEffectAmpAffected": true,
      "kotoneSkillEffectAmpAffected": true,
      "duration": "3턴",
      "note": "『인연의 힘』 2중첩",
      "note_en": "2 Powerful Bond stacks",
      "note_jp": "『絆の力』2つ",
      "skillName_cn": "琴奏之调",
      "note_cn": "『羁绊之力』2层",
      "type_cn": "技能1",
      "target_cn": "单体",
      "duration_cn": "3回合",
      "options_en": ["LV10", "LV10+Mindscape5", "LV13", "LV13+Mindscape5"],
      "options_jp": ["LV10", "LV10+イメジャリー5", "LV13", "LV13+イメジャリー5"],
      "options_cn": ["LV10", "LV10+心象5", "LV13", "LV13+心象5"]
    },
    {
      "id": "kotone-sync-skill1-pierce",
      "type": "스킬1",
      "type_en": "Skill 1",
      "type_jp": "スキル1",
      "target": "단일",
      ...
      "target_jp": "単体",
      "skillIcon": "/assets/img/skill-element/버프.png",
      "skillName": "현의 선율(싱크로 심상)",
      "skillName_en": "Skill 1 (Sync Mindscape)",
      "skillName_jp": "スキル1（シンクロイメジャリー）",
      "options": ["LV10", "LV10+심상5", "LV13", "LV13+심상5"],
      "values": {"LV10": 19.5, "LV10+심상5": 21.5, "LV13": 20.7, "LV13+심상5": 22.7},
      "defaultOption": "LV13+심상5",
      "value": 22.7,
      "skillEffectAmpAffected": true,
      "kotoneSkillEffectAmpAffected": true,
    ...
    },
    {
      ...
      "skillName_jp": "パッシブ",
      "options": [], "value": 12, "skillEffectAmpAffected": false, "duration": "2턴",
      "note": "『인연의 힘』 부여 시", "note_en": "When granting Powerful Bond", "note_jp": "『絆の力』付与時",
      "skillName_cn": "联结", "note_cn": "赋予『羁绊之力』时", "type_cn": "被动", "target_cn": "单体", "duration_cn": "2回合", "options_cn": []
    },
    {
      "id": "kotone-ritual0-pierce",
      "type": "의식0", "type_en": "Awareness 0", "type_jp": "意識0", "target": "단일", "target_en": "Single", "target_jp": "単体",
      "skillIcon": "/assets/img/character-detail/ritual0.png", "skillName": "삭망월", "skillName_en": "Awareness 0", "skillName_jp": "意識0",
      "options": [], "value": 15, "skillEffectAmpAffected": false, "duration": "-", "note": "『삭망월』 5레벨", "note_en": "Lunar Bond Lv. 5", "note_jp": "ルネーション5",
      "skillName_cn": "朔望月", "note_cn": "朔望月5级", "type_cn": "意识0", "target_cn": "单体", "duration_cn": "-", "options_cn": []
    },
    {
      "id": "kotone-skill3-copy-pierce",
      ...
      "duration": "1턴", "note": "선택한 동료의 관통 버프 복제", "note_en": "Copy selected ally's pierce buffs", "note_jp": "選択した味方の貫通強化を複製",
      "skillName_cn": "焰华·绯月昂扬", "note_cn": "复制所选同伴的穿透增益", "type_cn": "技能3", "target_cn": "单体", "duration_cn": "1回合", "options_cn": []
    },
    {
      "id": "kotone-sync-skill3-copy-pierce",
      "type": "스킬3", "type_en": "Skill 3", "type_jp": "スキル3", "target": "단일", "target_en": "Single", "target_jp": "単体",
      ...
      "duration": "1턴", "note": "선택한 동료의 관통 버프 복제", "note_en": "Copy selected ally's pierce buffs", "note_jp": "選択した味方の貫通強化を複製",
      "skillName_cn": "焰华·绯月昂扬（同步心象）", "note_cn": "复制所选同伴的穿透增益", "type_cn": "技能3", "target_cn": "单体", "duration_cn": "1回合", "options_cn": []
    }
  ],
  "J&C": [
    {
  ...
  "마코토": [
    {
      "id": "makoto-mindscape-glb-pierce",
      "type": "심상",
      "target": "자신",
      "target_en": "Self",
      "target_jp": "自分",
      "skillIcon": "/assets/img/character-detail/item-mind_stat2.png",
      "skillName": "진급강화",
      "displayName": "진급강화 (GLB 전용)",
      "skillName_en": "Mindscape (GLB ONLY)",
      "skillName_jp": "イメジャリー (GLB専用)",
      "options": [],
      "value": 7.5,
      "skillEffectAmpAffected": false,
      "duration": "-",
      "note": "",
      "skillName_cn": "进阶强化 (GLB专用)",
      "note_cn": "",
      "type_cn": "心象",
      "target_cn": "自身",
      "duration_cn": "-",
