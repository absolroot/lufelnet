...
window.ReleaseScheduleData = {
    ...
    autoGenerateCharacters: [
        ...
        { version: "4.0", characters: ["마나카", "쇼키"], "main-story": "5-1", isThreeWeekStart: true, weapon: ["하이브 가드"], revelation:["희망","신중","고집"]},
        ...
        { version: "4.7.1", characters: ["쇼키·암야"], "main-story": "5-4", persona: ["마카브르"], weapon_stamp: ["크리스탈 트레저"], mindscape_core: ["미나미", "YUI", "유우미"] },
