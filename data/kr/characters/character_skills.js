const characterSkillsData = {
    ...
    "미유·여름":{
        ...
        "skill1": {
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 100.7%/111.0%/106.9%/117.2% 공격력의 빙결 속성 피해를 주고, 100%의 기본 확률로 목표를 2턴 동안 빙결 상태로 만든다.\n자신의 SP을 40 회복한다(이 효과는 SP 회복 속성의 영향을 받는다).\n이 방식으로 획득한 SP은 최대치를 초과해 획득할 수 있으며(최대 SP에 해당하는 추가 SP까지 가능)."
        },
        "skill2": {
            "name": "푸른 협주",
            "element": "빙결광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 178.7%/197.0%/189.7%/208.0% 공격력의 빙결 속성 피해를 준다.\n『바다의 영역』 상태에서는 『겹치는 파도』의 중첩마다 이 스킬 피해가 10% 증가한다.스킬 사용 후 『바다의 영역』에서 이탈하며 『겹치는 파도』이 초기화된다. 이 스킬은 추가 효과로 간주된다."
        },
        "skill3": {
            "name": "빛을 타고 푸른 파도 위로",
            "element": "버프",
            ...
            "sp": 60,
            "cool": 0,
            "description": "서핑보드에 올라 즉시 자신의 정신 이상 상태를 해제하고 『바다의 영역』을 전개한다.\n이 기간 동안 다운, 정신 이상 및 제어 효과에 면역이 되며, 근접 공격·총기 공격·아이템 사용이 불가능하다.\n아무 상태이상이나 버프를 획득하면 지속 시간이 1턴 연장된다.\n이 기간 중 아군의 턴이 종료될 때, 자신의 SP가 충분하면 자동으로 일정 SP을 소모하여 『파도와 구름』을 발동한다.\n\n『파도와 구름』: 30 SP을 소모해 모든 적에게 50.2%/55.3%/53.3%/58.4% 공격력의 빙결 속성 피해를 주고, 자신에게 『겹치는 파도』 1중첩을 부여한다.\n『겹치는 파도』 중첩마다 『파도와 구름』의 피해가 5%, SP 소모량이 30 증가하며 최대 4회까지 중첩 가능하다.\n『파도와 구름』은 추가 효과로 간주되며, 적에게 다운 수치를 줄 수 없다.\n이 스킬을 다시 사용하면 『바다의 영역』이 해제되고 『겹치는 파도』이 초기화된다. 해당 턴에는 다른 스킬을 사용할 수 있지만 『바다의 영역』을 다시 전개할 수 없다."
        },
        "skill_highlight": {
            "name": "",
            "element": "빙결광역",
            ...
            "sp": 0,
            "cool": 0,
            "description": "모든 적에게 219.6%/242.1%/233.1%/255.6% 공격력의 빙결 속성 피해를 준다.\n『바다의 영역』 상태일 경우, 추가로 146.4%/161.4%/155.4%/170.4% 공격력의 빙결 속성 피해를 준다."
        },
        "passive1": {
            "name": "교취",
            "element": "패시브",
            "description": "전투 중, 자신의 SP 회복량에 비례하여 공격력이 상승하며, 최대 280.0% SP 회복일 때 공격력이 98.0% 증가한다."
        },
        "passive2": {
            "name": "영리함",
            "element": "패시브",
            "description": "『바다의 영역』 상태에서 대미지가 30% 상승한다."
        }
    },
    "미나미·여름":{
        "name": "미야시타 미나미·여름",
