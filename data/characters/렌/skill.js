...
window.characterSkillsData["렌"] = {
  ...
  "skill3": {
    ...
    "sp": 22,
    "cool": 0,
    "description": "모든 적에게 공격력 74.2%/81.8%/78.7%/86.3%의 주원 속성 대미지를 준다. 추가 턴에서는 해당 스킬 대미지가 25% 증가한다. 목표가 임의의 디버프 효과를 가진 경우 해당 스킬 대미지가 25% 추가 증가한다."
  },
  "skill_highlight": {
    "element": "주원광역",
    "type": "광역피해",
    "description": "모든 적에게 공격력 205.0%/226.0%/217.6%/238.6%의 주원 속성 대미지를 주고, 『반역의 의지』1개를 획득한다."
  },
  "passive1": {
    "name": "복수",
    "element": "패시브",
  ...
  "passive2": {
    "name": "탐식",
    "element": "패시브",
    "description": "추가 턴에서 주는 대미지가 72.0% 증가한다."
  }
};
window.enCharacterSkillsData["렌"] = {
  "name": "Ren Amamiya",
  "skill1": {
...
window.jpCharacterSkillsData["렌"] = {
  "name": "雨宮 蓮",
  "skill1": {
    "name": "斬魔の強奪",
    "element": "주원광역",
