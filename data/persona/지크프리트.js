...
window.personaFiles["지크프리트"] = {
  ...
  "tier_desc_cn": "当 WONDER 作为物理输出活跃时，通常不会切换人格面具，因此会把它放在第 2、第 3 位。",
  ...
  "passive_skill": [
    ...
    {
      "name": "용사의 살의Ⅰ",
      "name_en": "Dragonblood Champion I",
      "name_jp": "竜血の勇者Ⅰ",
    ...
    {
      "name": "용사의 살의Ⅱ",
      "name_en": "Dragonblood Champion II",
      "name_jp": "竜血の勇者Ⅱ",
    ...
    {
      "name": "용사의 살의Ⅲ",
      "name_en": "Dragonblood Champion III",
      "name_jp": "竜血の勇者Ⅲ",
  ...
  "uniqueSkill": {
    ...
    "desc_en": "Deal Physical damage to all foes equal to 95.0%/99.8%/104.5% of Attack.\nIf user has no Dragon's Blood, gain Dragon's Blood.\nWhen gaining Dragon's Blood, reset duration, and enhance Dragon's Blood.",
    "desc_jp": "敵全体に攻撃力95.0%/99.8%/104.5%の物理属性ダメージを与える。\n『竜血』を獲得していない時、『竜血』を獲得する。\n『竜血』を獲得している時、持続ターンをリセットし、『竜血』を強化する。",
    "priority": 0,
    "icon": "물리광역",
    "icon_gl": "",
    "name_cn": "以斩龙之姿",
