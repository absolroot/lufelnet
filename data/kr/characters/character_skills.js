const characterSkillsData = {
    ...
    "이케나미": {
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "1명의 적에게 공격력 151.8%//158.0%/의 축복 속성 대미지를 주고 모든 동료가 축복 효과를 2중첩 획득한다. 또한 모든 동료의 대미지가 증가하며(이케나미 쇼키의 공격력 100포인트마다 대미지 0.8% 증가, 최대 35.1%//36.6%/) 2턴 동안 지속된다."
        },
        "skill2": {
            "name": "낯선 공간",
            "element": "버프",
            ...
            "sp": 24,
            "cool": 2,
            "description": "자신을 제외한 동료 1명의 방어력이 증가하고(이케나미 쇼키의 공격력 100포인트마다 방어력 0.83% 증가, 최대 36.6%//38.1%/), 목표가 일부 정신 이상 효과(현기증, 수면, 혼란, 망각)에 면역되며 2턴 동안 지속된다."
        },
        "skill3": {
            "name": "별들의 공연",
            "element": "버프광역",
            ...
            "sp": 24,
            "cool": 0,
            "description": "모든 동료의 공격력이 증가하며(증가 값은 자신의 공격력의 15%, 상한 569//592/) 2턴 동안 지속된다.\n자신의 현재 『즉흥 공연』 상태에 따라 스킬 메인 목표가 추가 효과를 획득한다.\n『즉흥·침투』: 2턴 동안 스킬 메인 목표의 지속 대미지 효과가 14.0%//14.5%/ 증가하고, 효과 명중이 30% 증가한다.\n『즉흥·전복』: 2턴 동안 스킬 메인 목표의 스킬 마스터가 655//682/ 증가하고, TECHNICAL을 줄 시 공격력이 20% 증가한다.\n『즉흥·공감』: 2턴 동안 스킬 메인 목표의 크리티컬 효과가 24.4%//25.4%/ 증가한다.\n『즉흥·교감』: 2턴 동안 스킬 메인 목표의 관통이 12.0%//12.5%/ 증가한다."
        },
        "skill_highlight": {
            "element": "버프광역",
            "type": "버프",
            "description": "모든 동료의 공격력이 증가하고(증가 값은 자신의 공격력의 6.5%, 상한 284//296/), 효과 저항이 82.0%//85.3%/ 증가한다. 효과는 2턴 동안 지속된다. 또한 모든 동료가 축복 효과를 1중첩 획득한다."
        },
        "passive1": {
            "name": "본색",
            "element": "패시브",
