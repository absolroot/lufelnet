...
window.ritualData["토모코·여름"] = {
  "name": "노게 토모코·여름",
  "r0": "화려한 불꽃",
  "r0_detail": "노게 토모코·여름의 스킬은 적에게 『불꽃』을 추가한다.\n임의의 동료가 스킬을 사용한 후 동시에 적의 총 『불꽃』 수가 3이 되면, 노게 토모코·여름이 추가 효과를 발동한다. 모든 적의 『불꽃』 3중첩을 제거할 때마다 모든 적에게 공격력 19.0%의 염동 속성 대미지를 주며, 적이 주는 대미지가 30% 감소한다. 효과는 1턴 동안 지속된다. 또한 모든 동료가 공격력 9.0%+300/600/900의 생명(1/50/70레벨)을 1회 회복한다. 한 번의 추가 효과에서 제거한 『불꽃』 수에 따라 대미지와 치료 효과를 최대 5회 발동한다(해당 대미지는 스킬의 『불꽃』 효과를 발동하지 못함).\n추가 효과가 주는 대미지는 필드에 있는 적의 수에 따라 달라지며, 적의 수가 1/2/>=3일 경우 추가 효과는 기존의 150%/120%/100%에 해당하는 대미지를 준다. 해당 추가 효과는 적에게 다운 수치 대미지를 줄 수 없으며, 적이 사망한 경우 해당 『불꽃』은 다른 적에게 임의로 분배된다.",
  "r1": "어김없는 빛",
  ...
  "r3_detail": "『화려한 불꽃』의 효과를 2회 발동할 때마다 랜덤으로 1명의 적이 『불꽃』 1회를 획득할 수 있다. 적에게 『불꽃』 추가 시 아군 전체의 공격력이 2% 증가한다(영구 적용, 15회 중첩 가능).",
  "r4": "불꽃놀이에서 소원 빌기",
  "r4_detail": "『한밤의 두근거림』, 『전투 기술』의 스킬 레벨이 3레벨 증가하며, 최대 15레벨까지 증가한다.",
  "r5": "오늘 밤 꿈속에 오래 남기를",
...
window.cnCharacterRitualData["토모코·여름"] = {
  "name": "野毛朋子·夏日",
  "r0": "绚烂烟火",
  "r0_detail": "野毛朋子·夏日的技能会使敌人附着『火花』。\n任意同伴使用技能后，且敌人的总『火花』数达到3，野毛朋子·夏日会触发追加效果：每清除所有敌人共3层『火花』，对所有敌人造成1次19.0%攻击力的念动属性伤害，使其造成伤害降低30%，效果持续1回合；并使所有同伴恢复1次9.0%攻击力+300/600/900的生命值（达到1、50、70级时变化），同一次追加效果内依据清除『火花』数量的不同，最多可触发5次伤害与治疗效果（该伤害无法触发技能的附着『火花』效果）。\n追加效果造成的伤害依据场上敌人的数量会发生变化，敌人数1/2/>=3时，追加效果会造成相当于原本150%/120%/100%的伤害。该追加效果不能对敌方造成倒地值伤害。敌人阵亡时，其『火花』会随机分配给其他敌人。",
  "r1": "光芒如约而至",
  "r1_detail": "敌人每受到1次『绚烂烟火』的效果时，防御力降低15%，可叠加3层，效果持续3回合。\n『请好好享用』的治疗效果改为对我方全体生效。",
  "r2": "如星河映入眼帘",
  "r2_detail": "『来点夏日冰饮吗』、『请好好享用』的技能等级提升3级，至多提升至15级。",
  "r3": "这个夏天仍未结束",
  "r3_detail": "每触发2次『绚烂烟火』的效果时，使随机1名敌人获得1层『火花』。使敌人附着『火花』时，所有同伴攻击力提升2%，永久生效，可叠加15层。",
  "r4": "于烟火中许下心愿",
  "r4_detail": "『午夜的心动回忆』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r5": "愿今夜长留梦中",
  "r5_detail": "HIGHLIGHT效果提升：额外造成2次伤害，每次伤害附着1层『火花』。",
  "r6": "将爱恋的心事连结",
