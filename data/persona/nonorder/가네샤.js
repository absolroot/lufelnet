...
window.personaFiles["가네샤"] = {
  ...
  "passive_skill": [
    {
      "name": "행복의 비호",
      "name_en": "Fortune's Protection",
      "name_jp": "福祐の加護",
      "desc": "방어력이 31.8% 증가한다. 동료를 목표로 페르소나 스킬 시전 시, 1턴 동안 받는 치료 효과가 8.1% 증가한다. 또한 자신이 받는 치료 효과가 4.8% 추가 증가한다.",
    ...
    {
      "name": "행복의 비호Ⅰ",
      "name_en": "Fortune's Protection I",
      "name_jp": "福祐の加護Ⅰ",
      "desc": "방어력이 31.8% 증가한다. 동료를 목표로 페르소나 스킬 시전 시, 1턴 동안 받는 치료 효과가 9.2% 증가한다. 또한 자신이 받는 치료 효과가 5.4% 추가 증가한다.",
    ...
    {
      "name": "행복의 비호Ⅱ",
      "name_en": "Fortune's Protection II",
      "name_jp": "福祐の加護Ⅱ",
      "desc": "방어력이 31.8% 증가한다. 동료를 목표로 페르소나 스킬 시전 시, 1턴 동안 받는 치료 효과가 10.3% 증가한다. 또한 자신이 받는 치료 효과가 6% 추가 증가한다.",
    ...
    {
      "name": "행복의 비호Ⅲ",
      "name_en": "Fortune's Protection III",
      "name_jp": "福祐の加護Ⅲ",
      "desc": "방어력이 31.8% 증가한다. 동료를 목표로 페르소나 스킬 시전 시, 1턴 동안 받는 치료 효과가 11.4% 증가한다. 또한 자신이 받는 치료 효과가 6.6% 추가 증가한다.",
  ...
  "innate_skill": [
    ...
    },
    {
      ...
      "name_jp": "レデュースブースタⅢ",
      "desc": "받는 대미지가 8.7% 감소한다.",
      "desc_en": "Decrease damage taken by 8.7%.",
  ...
  "uniqueSkill": {
    ...
    "name_en": "Rakukaja",
    "name_jp": "ラクカジャ",
    "desc": "동료 1명의 방어력이 23.3%/24.5%/25.6% 증가하고, 자신의 방어력 500마다 3.9%/4.1%/4.3% 추가 증가한다. 상한은 15.6%/16.4%/17.2%이며, 효과는 3턴 동안 지속된다.",
    "desc_en": "Increase 1 ally's Defense by 23.3%/24.5%/25.6%. For every 500 of the user's Defense, increase the target's Defense by 3.9%/4.1%/4.3% more, up to 15.6%/16.4%/17.2%. Lasts for 3 turns.",
