const jpCharacterSkillsData = {
    ...
    "마사키": {
        ...
        "skill1": {
            ...
            "sp": 24,
            "cool": 0,
            "description": "指定した敵1体に防御力の149.2%/164.2%/158.4%/173.4%の氷結属性ダメージを与え、他の敵ユニットに防御力の44.8%/50.3%/47.6%/53.1%の氷結属性ダメージを与える。さらに97.6%/97.6%/103.6%/103.6%の基礎確率でメインターゲットを凍結状態にする。同時に芦谷 真咲は『勇猛』を2ポイント回復する。『正義宣言』状態であれば、2ターンの間メインターゲットが受けるダメージが追加増加する（防御力600ポイントごとに1%、最大9.8%/10.8%/10.4%/11.4%）。ただし、『勇猛』回復量は1ポイントに減少する。"
        },
        "skill2": {
            "name": "名誉の守護",
            "element": "버프",
            ...
            "sp": 26,
            "cool": 0,
            "description": "味方1体に防御力の22.8%/22.8%/24.2%/24.2%+650/790/799/939分のダメージを防ぐ『誠実なる聖人』を1スタック付与し、芦谷 真咲の防御力の20%（最大1220/1345/1295/1420ポイント）分防御力を上昇させる。効果は2ターン持続。付与時にその味方のHPが60%以上であれば、被攻撃率が50%上昇する。次の芦谷 真咲のターン開始時に、その味方は再度『誠実なる聖人』1スタックを獲得する。『正義宣言』状態であれば、『誠実なる聖人』のシールド量が25%増加する（2ターン）。"
        },
        "skill3": {
            "name": "魂の祈り",
            "element": "버프광역",
        ...
        "passive1": {
            "name": "犠牲",
            "element": "패시브",
            "description": "芦谷 真咲のシールドで守られている味方の防御力が24.0%上昇する。"
        },
        "passive2": {
            "name": "謙遜",
            "element": "패시브",
            "description": "芦谷 真咲のシールドで守られている味方の効果耐性が48.0%上昇する。"
        }
    },
    "마코토": {
        "name": "新島 真",
