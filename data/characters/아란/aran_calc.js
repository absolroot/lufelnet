;(function () {
  ...
  CalcBase.registerSimpleTotalCalculator({
    characterName: '아란',
    cardClass: 'aran-calc-card',
    storageKey: 'aran_calc_state',
    titleIconName: '효과 명중',
    title: function () { return t('aranCalcTitle', '아란 효과명중 계산기'); },
    ...
    goals: [
      { id: 'LV12', label: function () { return t('aranCalcGoalLv12', 'LV12'); }, value: 167.6 },
      { id: 'LV12+5', label: function () { return t('aranCalcGoalLv12M', 'LV12+Mind5'); }, value: 184.1 }
    ],
    sections: [
      {
        label: function () { return t('characterCalc.sectionCharacterPage', 'Character Page'); },
        rows: [
          { type: 'fixed', key: 'baseStat', label: function () { return t('characterCalc.baseStatLv80', 'Base Stat (LV80)'); }, value: 26.1 },
          {
            type: 'select',
            key: 'mindscape',
