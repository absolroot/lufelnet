...
window.cnCharacterRitualData["YUI·스텔라"] = {
  "name": "YUI·幻彩",
  "r0": "噗通噗通萌芽军团",
  "r0_detail": "YUI·幻彩在战斗中可以召唤茄子、土豆、蘑菇、芦笋四种蔬菜骑士并积攒『源动力』，『源动力』足够时，YUI·幻彩能令蔬菜骑士们对敌人发动『蔬菜骑士·总动员』，该技能伤害视为总攻击伤害。\nYUI·幻彩在拥有不同蔬菜骑士时，回合开始可将怪盗服变幻为对应骑士的颜色，并获得相应的能力加成：\n『茄之紫』：释放人格面具技能后，额外获得1点『源动力』；\n『薯之黄』：自身总攻击伤害提升15%；\n『菇之粉』：造成人格面具技能伤害及总攻击伤害时，有4.5%基础概率使技能目标陷入洗脑状态，持续1回合；\n『笋之绿』：造成人格面具技能伤害及总攻击伤害时，自身恢复相当于该伤害1%的生命值（单次上限1000点）。",
  "r1": "深空防卫战",
  "r1_detail": "战斗开始时，YUI·幻彩立刻召唤四种不同的蔬菜骑士并获得满层『源动力』。\n每拥有1个蔬菜骑士，YUI·幻彩的暴击效果提升8%，最多计入5个蔬菜骑士。\n战斗开始时，YUI·幻彩处于『薯之黄』状态，自身首回合开始时，自动变幻为『茄之紫』状态。",
  "r2": "最后一颗土豆",
  "r2_detail": "YUI·幻彩额外拥有1个不会消耗的土豆骑士，追加效果『蔬菜骑士·出击』触发的『块茎之力』效果值额外提升10%，战斗开始时获得『块茎之力』，持续2回合。",
  "r3": "黑暗农田法则",
  "r3_detail": "『蔬菜骑士·集合』、『蔬菜骑士·总动员』的技能等级提升3级，至多提升至15级。",
  "r4": "星系漫游指南",
  "r4_detail": "HIGHLIGHT效果提升：额外使自身攻击力提升35%，持续4回合。",
  "r5": "超时空舰队",
  "r5_detail": "『宇宙大乱斗』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r6": "欢祝银河庆典",
