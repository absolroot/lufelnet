...
window.ritualData["사나다"] = {
  "name": "사나다 아키히코",
  "r0": "전투의 이유",
  "r0_detail": "사나다 아키히코가 페르소나 스킬/테우르기아를 사용해 전격 속성 대미지를 준 후 『집념』을 1중첩 획득한다. 전투 진입 시 『집념』을 2중첩 획득한다(12회 중첩 가능). 자신의 턴 시작 시 『집념』을 6중첩 소모하여 『무적의 주먹』을 1회 시전할 수 있다. 『무적의 주먹』: 자신이 『투지』를 1중첩 획득하며, 적 전체에 공격력 55.9%의 물리 속성 대미지를 준다. 해당 스킬은 추가 효과로 간주된다. 『투지』: 자신의 관통이 4% 증가한다(3회 중첩 가능).",
  "r1": "복싱부 주장",
...
window.cnCharacterRitualData["사나다"] = {
  "name": "真田明彦",
  "r0": "战斗的理由",
  "r0_detail": "真田明彦使用人格面具技能/神通法造成电击属性伤害后获得1层『执念』。进入战斗时获得2层『执念』，上限12层。自身回合开始时，可以消耗6层『执念』释放1次『无敌钢拳』：自身获得1层『斗志』，对所有敌人造成55.9%攻击力的物理属性伤害。该技能视为追加效果。『斗志』：自身穿透提升4%，上限3层。",
  "r1": "拳击部主将",
