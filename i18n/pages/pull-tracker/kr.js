window.I18N_PAGE_PULL_TRACKER_KR = {
  ...
  guide: {
    ...
    pageTitle: 'URL 가이드',
    introWindows: '현재는 Windows, iOS, Linux/Steam Deck 방법을 제공하고 있습니다.',
    s1: 'FAQ를 확인하세요.',
    ...
    linux1: 'httptap을 설치하세요. Steam Deck은 먼저 데스크톱 모드로 전환해야 합니다.',
    linux2: '터미널을 열고 아래 설치 명령어를 실행하세요.',
    ...
    linux3: 'Steam이 실행 중이면 종료한 뒤, 아래 명령어를 실행하세요.',
    linuxRunCmd: './httptap -- steam 2>/dev/null | grep "X"',
    linux4: 'grep의 "X"를 자신의 서버 도메인으로 바꾸세요. 따옴표는 유지해야 합니다.\n(KR) nsywl-krcard.wmupd.com\n(CN) nsywl-gfcard.wmupd.com\n(TW) wwwidcweb.p5x.com.tw\n(JP) web.p5xjpupd.com\n(EN) euweb.p5xjpupd.com\n(SEA) web.p5x-sea.com',
    linux5: 'Steam 실행 시 SSL certificate 경고가 표시될 수 있습니다. 무시해도 됩니다.',
    linux6: 'P5X를 실행하고 가챠 기록 화면으로 이동하세요.',
    linux7: '터미널로 돌아가면 가챠 기록 URL이 표시됩니다(보통 2번 출력). 전체 URL 하나를 복사하세요.',
    linux8: '복사된 URL을 아래 링크에서 입력해주세요.',
    linuxExplain: '명령어 설명:\n./httptap -- steam: Steam을 httptap으로 실행하여 Steam/P5X의 HTTP 요청을 터미널에 출력합니다.\n2>/dev/null: Steam 디버그 로그를 숨겨 출력을 정리합니다.\n| grep "X": 서버 도메인(X)이 포함된 줄만 필터링합니다.',
    linuxCredit: '이 안내는 Dinjoralo 님이 제공했습니다.',
    videoLabel: '영상 도움말',
