;(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.fuka-rs-table th:nth-child(1),.fuka-rs-table td:nth-child(1),.fuka-rs-table th:nth-child(2),.fuka-rs-table td:nth-child(2){width:140px}',
      ...
      '.fuka-rs-effect-title{font-size:12px;color:#ffdb70;flex:0 0 auto}',
      '.fuka-rs-effect-status{display:inline-flex;min-width:20px;height:20px;padding:0 0px;align-items:center;justify-content:center;border-radius:999px;font-size:11px;font-weight:700;line-height:1}',
      ...
      '.fuka-rs-effect-text{font-size:12px;line-height:1.6;color:rgba(255,255,255,.82);word-break:break-word;overflow-wrap:anywhere;flex:1 1 260px;min-width:0}',
      '@media (max-width:768px){',
      '  .fuka-rs-accordion-content{padding-top:0px}',
      ...
      '  .fuka-rs-table tbody tr{display:grid;width:100%;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:12px;padding:12px;border:1px solid rgba(255,255,255,.08);border-radius:14px;background:rgba(255,255,255,.03);box-sizing:border-box;overflow:hidden}',
      ...
      '  .fuka-rs-cell::before{display:none}',
      '  .fuka-rs-revelation{min-width:0; padding:8px 0 8px 0;}',
      '  .fuka-rs-revelation-name{padding-top:0px;word-break:keep-all;overflow-wrap:break-word}',
      ...
      '  .fuka-rs-effect-block:not(.is-note) .fuka-rs-effect-text{padding-left:26px;box-sizing:border-box}',
      '  .fuka-rs-effect-line{gap:4px;}',
      '}'
    ].join('\n');
