...
window.ritualData["이치고"] = {
  ...
  "r4": "사랑한다면",
  "r4_detail": "HIGHLIGHT를 시전한 후마다 캐릭터의 공격력이 6% 영구 증가한다(5회 중첩 가능).",
  "r5": "위험하다면",
...
window.cnCharacterRitualData["이치고"] = {
  "name": "鹿野莓",
  "r0": "如果摄入爱的毒药",
  "r0_detail": "鹿野莓首次释放『红蝶断颈』时可获得1层『贪恋』。自身每次释放HIGHLIGHT时可获得1层『贪恋』。『贪恋』最多可获得3层，根据『贪恋』层数获得如下强化效果：\n1层：每层『怨念』使敌人受到的伤害提升2.5%；\n2层：暴击率提升15%，自身释放人格面具技能造成的伤害均视为持续伤害效果；\n3层：持续伤害效果提升25%。",
  "r1": "如果坏掉的话",
  "r1_detail": "每层『怨念』使敌人防御降低3%；每次使用人格面具技能时，额外为目标添加1层『怨念』。",
  "r2": "如果任由妄念丛生",
  "r2_detail": "进入战斗时，获得1层『贪恋』。『贪恋』叠加上限提升至5层。根据『贪恋』层数额外获得如下强化效果：\n4层：暴击效果提升36%；\n5层：自身首次受到致命伤害时，进入濒死状态并获得4层『疯狂妄想』，濒死状态期间生命值不会低于1点，友方每个回合结束时消耗1层『疯狂妄想』，『疯狂妄想』耗尽后死亡。",
  "r3": "如果求饶有用",
  "r3_detail": "『嘘！行刑时间到』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r4": "如果爱意不断累积",
  "r4_detail": "每次释放HIGHLIGHT后，角色的攻击力永久提升6%，可叠加5层。",
  "r5": "如果危险逼近",
  "r5_detail": "『红蝶断颈』、『血蔷薇之吻』的技能等级提升3级，至多提升至15级。",
  "r6": "如果你发现了另一个我",
