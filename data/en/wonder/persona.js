const personaData = {
    ...
    "체르노보그": {
        ...
        instinct: {
            ...
            effects: [
                "효과 명중이 34.9% 증가한다.",
                "『악몽』은 2턴 동안 효과 저항이 15%, 방어력이 10% 감소한다.『악몽』 상태일 때 적이 받는 물리 대미지가 5% 증가한다.",
    ...
    "야마타노오로치": {
        ...
        instinct: {
            ...
            effects: [
                "크리티컬 확률이 17.5% 중가한다.",
                "동결 상태인 적에게 주는 대미지가 45% 중가한다. 빙결 속성의 페르소나 스킬 시전 시 스킬 메인 목표의 생명이 50% 미만일 시, 공격력 42%의 추가 빙결 속성 대미지를 1회 준다."
            ],
            priority: 1
        },
        uniqueSkill: {
