...
window.recommendParty["카스미"] = {
    ...
    "friends": [
        ...
        },
        {
            ...
            "comment_en": "Kasumi’s HIGHLIGHT can land CRITs, while Riko provides a high CRIT Mult buff. However, Riko’s passive effect can be obtained by hitting 5 times or more within 2 turns, so Kasumi should equip the [Departure]+[Control] set to increase hit count in a form.",
            "comment_jp": "かすみのHIGHLIGHTはクリティカルが可能で、理子は高いCRT倍率バフを提供する。しかし理子のパッシブ効果を獲得するには2ターン内で5回以上のヒットが必要なため、かすみには[旅立]+[支配]セットを装備させてヒット数を増やす形である。",
        }
    ]
};
