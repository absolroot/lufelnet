...
window.characterSkillsData["이치고"] = {
  ...
  "skill1": {
    ...
    "sp": 20,
    "cool": 1,
    "description": "1명의 적에게 공격력 129.0%/142.2%/137.0%/150.2%의 주원 속성 대미지를 주고, 『원념』을 2중첩 추가한다. 목표의 현재 생명이 70%보다 높을 때 스킬 대미지가 200% 증가한다. 스킬로 목표 처치 시 스킬 효과가 1회 추가 발동된다(연속 발동 가능)."
  },
  "skill2": {
    "name": "붉은 장미의 키스",
    "element": "주원",
