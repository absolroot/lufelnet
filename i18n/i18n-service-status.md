...
| `pull-calc` | 완료 | `initPageI18n('pull-calc')` 이후 SEO는 `SeoEngine` + `seo-meta.json` 단일 경로로 적용하고 언어 변경 시 컨텍스트만 갱신(`apps/pull-calc/pull-calc.js:1814`, `apps/pull-calc/pull-calc.js:276`, `assets/js/seo/engine.js:1`, `i18n/pages/pull-calc/seo-meta.json:1`) |
