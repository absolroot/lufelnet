const characterSkillsData = {
    ...
    "아케치": {
        ...
        "passive1": {
            "name": "-",
            "element": "패시브",
            "description": "아케치 고로가 파티에 있을 경우, 모든 속성의 ‘욕망 소나타’가 발동 가능하다. 전투 시작 시, 발동된 ‘욕망 소나타’ 1개당 자신의 피해량이 15.0% 증가한다."
        },
        "passive2": {
            "name": "-",
            "element": "패시브",
            "description": "자신이 만능 속성 피해를 줄 때, 대상의 방어력 감소 효과 1%당 자신의 피해량이 0.5% 증가한다. (최대 120.0%까지 증가)"
        }    
    },
