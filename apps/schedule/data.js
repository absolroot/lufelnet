...
window.ReleaseScheduleData = {
    ...
    autoGenerateCharacters: [
        ...
        { version: "4.1.1", fixedDate: "2026-05-21", characters: ["유키 마코토"], persona: ["자오우곤겐"], days: 14 },
        { version: "4.1.2", fixedDate: "2026-06-04" , characters: ["유카리"], weapon: ["마그네틱 스톰"], goldTicketUnlocks: ["CHERISH"], days: 7 },
        { version: "4.1.3", fixedDate: "2026-06-11", characters: ["사나다"], revelation: ["돌파", "슬픔", "변화"], days: 14 },
        { version: "???", incomeVersion: "4.1", fixedDate: "2026-06-25", fixedDateSeaShift: false, characters: ["???"], days: 14, plannerPlaceholder: true, placeholderId: "global-first-anniversary-unit", placeholderLabelKey: "plannerPlaceholderGlobalFirstAnniversaryUnit", placeholderNoteKey: "plannerPlaceholderUnconfirmed" },
        { version: "4.2", characters: ["이치고"], "main-story": "5-2", persona: ["트럼페터", "바스키"], weapon: ["망령의 저주"], days:14 },
        { version: "4.3.1", characters: ["미나미·여름"], "summer": true, days: 14 },
