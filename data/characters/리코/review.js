...
她会给敌人留下标记，**当通过普通攻击或弱点攻击解除标记时，可以额外削减倒地值并触发倒地**。

正因为**即使不是弱点攻击也能制造倒地**，所以她能够更积极地帮助队伍活用ONE MORE与总攻击。

她的被动同样也是围绕**强化ONE MORE与总攻击**来设计，因此在攻略天鹅绒房间任务时非常有帮助。
...
`,
        ...
        pros_cn: ["即使不是弱点攻击也能削减倒地值。", "能够强化总攻击与ONE MORE。", "拥有很关键的防御力降低效果。"],
