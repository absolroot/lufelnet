...
window.characterSkillsData["야오링·사자무"] = {
  ...
  "skill2": {
    ...
    "sp": 20,
    "cool": 0,
    "description": "적 전체에 공격력 73.8%/81.3%/78.3%/85.9%의 화염 속성 대미지를 주고, 2턴 동안 90%의 기본 확률로 목표를 화상과 『세월의 불꽃』 상태에 빠뜨린다.\n『불꽃놀이 유성』이 강화되어 90% 기본 확률로 1턴 동안 목표를 『세월의 불꽃』 상태에 빠뜨린다.\n『세월의 불꽃』: 매턴마다 리 야오링·사자무 공격력 63.4%/69.9%/67.3%/73.8%의 화염 속성 대미지를 받으며 2턴 동안 지속된다(4회 중첩 가능)."
  },
  "skill3": {
    "name": "유성의 불꽃",
    "element": "버프",
  ...
  "passive2": {
    "name": "원만",
    "element": "패시브",
    "description": "전투 시작 시 자신의 공격력이 42.0% 증가하며 2턴 동안 지속된다. 자신 또는 동료가 TECHNICAL을 줄 시 해당 효과의 지속 시간을 초기화하고 해당 스킬 효과를 51.0%까지 증가시킨다.",
    "cool": 0
  }
};
...
window.jpCharacterSkillsData["야오링·사자무"] = {
  ...
  "passive2": {
    "name": "新年快楽",
    "element": "패시브",
    "description": "戦闘開始時、２ターンの間、自身の攻撃力が42.0%上昇する。自身か味方がテクニカルを発生させた時、この効果の持続ターンをリセットし、上昇効果が51.0%になる。",
    "cool": 0
  }
};
