...
window.ritualData["마나카"] = {
  ...
  "r4": "잔잔한 물결",
  "r4_detail": "임의의 괴도가 HIGHLIGHT/테우르기아 시전 및 전투 시작 시 나가오 마나카가 상한을 돌파할 수 있는 『성가』를 2중첩 획득한다(2회 중첩 가능).",
  "r5": "수호의 메아리",
...
window.jpCharacterRitualData["마나카"] = {
  ...
  "r4": "シンフォニア",
  "r4_detail": "戦闘開始時、または味方がハイライト／テウルギアを発動した時、『音符』を２つ獲得する。この効果による獲得分は上限を超えて所持することができ、最大２つまで累積できる。",
  "r5": "モルトヴィヴァーチェ",
...
window.cnCharacterRitualData["마나카"] = {
  "name": "长尾爱歌",
  "r0": "重新开始的希冀",
  "r0_detail": "每个怪盗回合开始时，长尾爱歌获得1层『圣歌』，可叠加12层。\n长尾爱歌可以在任意怪盗行动前释放『千籁重歌』，每场战斗初始仅可释放1次『千籁重歌』。使用『千籁重歌』后，经过7个WONDER的非额外回合，『千籁重歌』恢复1次使用次数，该效果每场战斗仅可触发1次。\n『千籁重歌』：为1名同伴净化1种负面状态，并使其在自身回合结束后，进入特殊的额外回合『千籁重歌』。进入『千籁重歌』时，将该同伴的状态回溯至其上回合释放技能前一刻。回溯内容包括：人格面具技能冷却时间、当前状态、当前生命值、当前精力值。",
  "r1": "初愿的序曲",
  "r1_detail": "战斗开始时，长尾爱歌获得满层『圣歌』，并使解明怪盗的初始准备时间减少4次行动。\n释放『贯穿时空的轮转』时，额外使所有同伴暴击率提高12%，效果持续2回合。",
  "r2": "憧憬的启程",
  "r2_detail": "处于『千籁重歌』的同伴，获得12%总伤害增幅。\n当同伴死亡时，立即使其复活并恢复等同于长尾爱歌20%攻击力+2000的生命值，该效果每场战斗仅可触发1次。",
  "r3": "悸动的华舞",
  "r3_detail": "『华光下的治愈诗』、『贯穿时空的轮转』的技能等级提升3级，至多提升至15级。",
  "r4": "静谧的涟漪",
  "r4_detail": "任意怪盗释放HIGHLIGHT/神通法及战斗开始时，长尾爱歌获得2层可突破上限的『圣歌』，可叠加2层。",
  "r5": "守望的余音",
  "r5_detail": "『群鸽于圣堂和鸣』的技能等级提升3级，至多提升至15级。",
  "r6": "永恒的天使之声",
