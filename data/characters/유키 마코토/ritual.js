...
window.cnCharacterRitualData["유키 마코토"] = {
  "name": "结城理",
  "r0": "伟大的指引",
  "r0_detail": "结城理拥有『华彩乐段』和『阿尔达』两个神通法技能。战斗开始时，若自身神通法能量不足35点，补充至35点神通法能量。\n自身获得友方同伴增益/治疗/护盾技能的效果时，获得1层『月相』，结城理每回合至下一回合开始前最多通过这种方式获得1层『月相』，持续2回合，上限4层。\n自身拥有『月相』效果时穿透提升4%/8%/12%（达到1、50、70级时变化）",
  "r1": "因偶然而生",
  "r1_detail": "释放『旋律之炎』时，额外造成1次伤害。\n释放『月下战曲』时，额外使所有同伴穿透提升10%，持续2回合。\n释放『红莲·豪炎吞噬』时，若『月相』达到4层，额外使自身暴击率提升16%。",
  "r2": "不会动摇的心",
  "r2_detail": "自身回合开始时，若『月相』达到4层，则自动释放1次『月下战曲』。该效果拥有1回合的冷却时间。",
  "r3": "满月之下",
  "r3_detail": "『红莲·豪炎吞噬』、『战斗技巧』的技能等级提升3级，至多提升至15级。",
  "r4": "在荆棘之路上",
  "r4_detail": "『华彩乐段』额外使所有同伴伤害提升10%，『阿尔达』额外造成2次伤害。",
  "r5": "魂之炎",
  "r5_detail": "『旋律之炎』、『月下战曲』的技能等级提升3级，至多提升至15级。",
  "r6": "约定的誓言",
  "r6_detail": "结城理释放任意一种神通法时，会同时触发另一种神通法的效果。使用『红莲·豪炎吞噬』消耗『特殊月相』造成伤害时，技能伤害提升35%。\n结城理首次受到致命伤害时，至自身下个回合结束前生命值不会低于1点，并进入濒死状态，自身下回合结束时死亡。濒死状态期间若自身生命值恢复至最大生命值的25%以上，则解除濒死状态。"
};
