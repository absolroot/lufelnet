const characterSkillsData = {
    ...
    "이케나미": {
        ...
        "skill1": {
            ...
            "sp": 20,
            "cool": 0,
            "description": "1명의 적에게 공격력 151.8%의 축복 속성 대미지를 주고 모든 동료가 축복 효과를 2중첩 획득한다. 또한 모든 동료의 대미지가 증가하며(이케나미 쇼키의 공격력 100포인트마다 대미지 0.8% 증가, 최대 35.1%) 2턴 동안 지속된다."
        },
        "skill2": {
            "name": "낯선 공간",
            "element": "버프",
            ...
            "sp": 24,
            "cool": 2,
            "description": "자신을 제외한 동료 1명의 방어력이 증가하고(이케나미 쇼키의 공격력 100포인트마다 방어력 0.83% 증가, 최대 36.6%), 목표가 일부 정신 이상 효과(현기증, 수면, 혼란, 망각)에 면역되며 2턴 동안 지속된다."
        },
        "skill3": {
            "name": "별들의 공연",
            "element": "버프광역",
            ...
            "sp": 24,
            "cool": 0,
            "description": "모든 동료의 공격력이 증가하며(증가 값은 자신의 공격력의 15%, 상한 569) 2턴 동안 지속된다.\n자신의 현재 『즉흥 공연』 상태에 따라 스킬 메인 목표가 추가 효과를 획득한다.\n『즉흥·침투』: 2턴 동안 스킬 메인 목표의 지속 대미지 효과가 14.0% 증가하고, 효과 명중이 30% 증가한다.\n『즉흥·전복』: 2턴 동안 스킬 메인 목표의 스킬 마스터가 655 증가하고, TECHNICAL을 줄 시 공격력이 20% 증가한다.\n『즉흥·공감』: 2턴 동안 스킬 메인 목표의 크리티컬 효과가 24.4% 증가한다.\n『즉흥·교감』: 2턴 동안 스킬 메인 목표의 관통이 12.0% 증가한다."
        },
        "skill_highlight": {
            "element": "버프광역",
            "type": "버프",
            "description": "모든 동료의 공격력이 증가하고(증가 값은 자신의 공격력의 6.5%, 상한 284), 효과 저항이 82.0% 증가한다. 효과는 2턴 동안 지속된다. 또한 모든 동료가 축복 효과를 1중첩 획득한다."
        },
        "passive1": {
            "name": "본색",
            "element": "패시브",
    ...
    "마나카": {
        ...
        "skill1": {
            ...
            "type": "버프",
            "cool": 4,
            "description": "모든 동료의 주는 대미지가 7.0%/7.5%/8.0%/8.5%+(나가오 마나카의 공격력 164포인트당 1%의 대미지 보너스 추가 제공, 최대 28.0%/31.0%/31.2%/34.2% 추가)증가하며 2턴 동안 지속된다. 자신이 『성가』를 4중첩 획득한다."
        },
        "skill2": {
            "name": "치유 빛의 노래",
            "element": "치료광역",
            "type": "치료",
            "cool": 8,
            "description": "모든 동료가 공격력 10.0%///11.2%+681///1124의 생명을 회복하고, 모든 동료의 디버프 상태 1종을 제거한다. 『성가』 보유 시 『성가』를 1중첩 소모하여 해당 스킬 시전 후 필요한 준비 시간을 1회 행동만큼 감소시킨다. 이러한 방식으로 준비 시간을 최대 4회 행동만큼 감소시킬 수 있다. 해당 스킬을 직접 발동 시 치료량이 50% 증가한다.\n패시브: 전투 중 나가오 마나카가 『성가』를 12중첩 획득할 때마다 해당 스킬의 치료 효과를 자동으로 1회 시전한다."
        },
        "skill3": {
            "name": "시공의 윤회",
            "element": "버프광역",
            "type": "버프",
            "cool": 4,
            "description": "모든 동료의 공격력이 나가오 마나카의 공격력 11%+128/138/146/156만큼 증가한다. 모든 『성가』를 소모하며,『성가』를 1중첩 소모할 때마다 2턴 동안 모든 동료의 관통이 증가하고(나가오 마나카의 공격력 460포인트마다 관통 0.1% 증가), 공격력이 증가한다(나가오 마나카의 공격력 460포인트마다 공격력 0.1% 증가).(해당 스킬은 최대 나가오 마나카의 공격력 4600/5060/5980/6440포인트까지 계산)"
        },
        "skill_highlight": {
            "name": "속성 증가",
            "element": "패시브",
    ...
    "카스미": {
        ...
        "skill_highlight": {
            ...
            "type":"단일피해",
            "unlock":"자신이 『가면무도회』 상태.",
            "description": "1명의 적에게 공격력 243.8%/268.8%/258.8%/283.8%의 축복 속성 대미지를 준다. 자신이 『춤사위』 보유 시 상응하는 버프 효과를 획득한다.\n『브레이브 스텝』: 중첩마다 HIGHLIGHT 스킬 대미지가 10% 증가한다.\n『스위프트 스텝』: HIGHLIGHT의 크리티컬 확률이 10% 증가하고, 크리티컬 효과가 20% 증가한다."
        },
        "passive1": {
            "name": "믿음",
            "element": "패시브",
    ...
    "후타바": {
        ...
        "skill3": {
            ...
            "description": "아군 괴도 1명의 공격력이 270/297/302/329+(사쿠라 후타바의 공격력 100포인트마다 공격력 추가 21.7 증가, 최대 4600/5060/5980/6440포인트 공격력 계산) 증가하며 2턴 동안 지속된다. 전체 적에게 해당 괴도 적합성의 『교란 바이러스』를 추가하며 1턴 동안 지속된다.\n『교란 바이러스』: 목표의 적합성 속성을 변경한다. 무효, 반사, 흡수일 경우 내성으로, 내성일 경우 일반으로, 일반일 경우 약점으로 변경된다. 약점일 경우, 목표가 받는 약점 대미지를 25% 증가한다."
        },
        "skill_highlight": {
            "name": "속성 증가",
            "element": "패시브",
