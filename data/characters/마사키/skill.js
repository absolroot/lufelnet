...
window.characterSkillsData["마사키"] = {
  ...
  "skill1": {
    ...
    "sp": 24,
    "cool": 0,
    "description": "지정된 적 1명에게 방어력 149.2%/164.5%/158.4%/173.7%의 빙결 속성 대미지를 주고, 다른 적 1명에게 방어력 44.8%/49.4%/47.6%/52.1%의 빙결 속성 대미지를 주며, 97.6%/97.6%/103.6%/103.6% 기본 확률로 메인 목표를 동결 상태에 빠뜨린다. 이와 동시에 아시야 마사키의 『용맹』을 2포인트 회복한다. 아시야 마사키가 『정의 선언』 상태가 되면, 2턴 동안 메인 목표가 받는 대미지가 증가한다(아시야 마사키가 방어 600포인트를 보유할 때마다 메인 목표가 받는 대미지 2% 증가, 최대 19.5%/21.5%/20.7%/22.7% 증가). 회복하는 『용맹』 포인트는 1포인트로 떨어진다."
  },
  "skill2": {
    "name": "명예 수호",
    "element": "버프",
  ...
  "skill3": {
    ...
    "sp": 30,
    "cool": 1,
    "description": "즉시 아군 전체에 12% 방어력+120/240/360(1, 50, 70레벨 달성 시 변화)의 대미지를 막을 수 있는 『정직 성인』 1중첩과 49.2%/49.2%/52.2%/52.2% 방어력+1400/1702/1721/2024의 대미지를 막을 수 있는 『성결의 가호』 1중첩을 추가한다. 또한, 2턴 동안 아군 전체가 1포인트의 다운 수치와 주는 대미지 증가 효과(아시야 마사키가 방어력 300포인트를 보유할 때마다 주는 대미지 2.9% 증가, 최대 56.6%/62.4%/60.1%/65.9% 증가)를 획득한다."
  },
  "skill_highlight": {
    "element": "버프광역",
    "type": "실드",
  ...
  "passive1": {
    "name": "희생",
    "element": "패시브",
    "description": "아시야 마사키의 실드 보호를 받는 동료는 24.0%의 방어력 증가 및 48.0%의 효과 저항 증가를 획득한다.",
    "cool": 0
  },
  "passive2": {
    "name": "겸손",
    "element": "패시브",
    "description": "아시야 마사키가 필드에 있을 때, 임의 동료가 주원/원소 이상/정신 이상 상태 저항에 성공할 때마다 각각 1/2/3회의 버프를 획득한다. 중첩마다 2턴 동안 동료의 대미지가 10.0% 증가한다(3회 중첩 가능). 3회 중첩 시 2턴 동안 크리티컬 효과가 추가로 20.0% 증가한다.",
    "cool": 0
  }
};
...
window.cnCharacterSkillsData["마사키"] = {
  "name": "芦谷真咲",
  "skill1": {
    "name": "怜悯祝福",
    "element": "빙결",
    ...
    "sp": 24,
    "cool": 0,
    "description": "对指定敌方单体造成149.2%/164.5%/158.4%/173.7%防御力的冰冻属性伤害并对其他敌方单位造成44.8%/49.4%/47.6%/52.1%防御力的冰冻属性伤害，有97.6%/97.6%/103.6%/103.6%的基础概率使主目标陷入冻结状态；同时为芦谷真咲回复2点『英勇』。若芦谷真咲处于『公正宣言』状态，额外使主目标受到的伤害提升（芦谷真咲每有600点防御主目标受到的伤害提升2%，最多提升19.5%/21.5%/20.7%/22.7%），效果持续2回合；但是『英勇』回复降为1点。"
  },
  "skill2": {
    "name": "荣誉守护",
    "element": "버프",
    ...
    "sp": 26,
    "cool": 0,
    "description": "使1名同伴获得1层可抵御22.8%/22.8%/24.2%/24.2%防御力+650/790/799/939伤害的『正直圣印』，并使其获得等同于芦谷真咲20%防御力（最多1220/1345/1295/1420点）的防御力提升效果，持续2回合；获得此效果时，若该同伴血量高于60%，则使其被攻击的概率提升50%；芦谷真咲下个回合开始时，会再次使该同伴获得1层『正直圣印』。若芦谷真咲处于『公正宣言』状态，则其在两回合内释放的『正直圣印』护盾量额外提升25%。"
  },
  "skill3": {
    "name": "灵魂祷告",
    "element": "버프광역",
    ...
    "sp": 30,
    "cool": 1,
    "description": "立即为所有同伴添加1层可抵御12%防御力+120/240/360（达到1、50、70级时变化）伤害的『正直圣印』和1层可抵御49.2%/49.2%/52.2%/52.2%防御力+1400/1702/1721/2024伤害的『圣洁庇佑』，同时使所有同伴获得1点倒地值及造成伤害提升效果（芦谷真咲每有300点防御力，造成伤害提升2.9%，最多提升56.6%/62.4%/60.1%/65.9%），持续2回合。"
  },
  "skill_highlight": {
    "element": "버프광역",
    "type": "护盾",
    "description": "立即为所有同伴添加1层可抵御59.0%/59.0%/62.7%/62.7%防御力+1681/2044/2066/2429伤害的『圣洁庇佑』，同时使所有同伴受到伤害降低31.9%/35.2%/33.9%/37.1%，持续2回合。",
    "cool": 4,
    "name": "HIGHLIGHT"
  },
  "passive1": {
    "name": "牺牲",
    "element": "패시브",
    "description": "处于芦谷真咲护盾保护下的同伴获得24.0%的防御力提升及48.0%的效果抵抗提升。",
    "cool": 0
  },
  "passive2": {
    "name": "谦恭",
    "element": "패시브",
    "description": "芦谷真咲在场时，任意同伴每次成功抵抗诅咒/元素异常/精神异常状态时，分别获得1/2/3层增益。每层使同伴伤害提升10.0%，持续2回合，最多可叠加3层。达到3层时，额外提升20.0%的暴击效果，持续2回合。",
    "cool": 0
  }
};
