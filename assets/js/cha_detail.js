document.addEventListener('DOMContentLoaded', () => {
    ...
    function fillSettingsInfo(character) {
        ...
        document.querySelectorAll('.skill-levels .skill-level .value').forEach((element, index) => {
            ...
            if (value.endsWith('!')) {
                ...
                markImg.src = '{{ site.baseurl }}/assets/img/character-detail/mark.png';
                markImg.alt = '추천';
        ...
        if (character.rarity) {
            ...
            for (let i = 0; i < starCount; i++) {
                ...
                star.src = `{{ site.baseurl }}/assets/img/character-detail/${starType}`;
                star.alt = '★';
    ...
    function updateSkillLevelItems() {
        ...
        if (goldenRoseCount > 0) {
            ...
            itemImg.src = '{{ site.baseurl }}/assets/img/character-detail/item-goldenrose.png';
            itemImg.alt = '욕망의 나무';
    ...
    function createItemElement(imageName, count) {
        ...
        img.src = `{{ site.baseurl }}/assets/img/character-detail/${imageName}`;
        img.alt = '아이템';
    ...
    function createRevelationValue(revelations, isMainRevelation = false) {
        ...
        revelations.forEach(revelation => {
            ...
            icon.src = `{{ site.baseurl }}/assets/img/character-detail/revel/${revelation}.webp`;
            icon.alt = revelation;
    ...
    function fillSkillsInfo(characterName) {
        ...
        skillTypes.forEach(type => {
            ...
            const iconPath = skill.element ? `{{ site.baseurl }}/assets/img/skill-element/${skill.element}.png` : '';
